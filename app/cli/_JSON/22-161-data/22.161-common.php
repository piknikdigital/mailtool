...
$p_id =  '161';
$p_subject =  '¡Última oportunidad para recibir 30% de descuento en tu primer Kit IQOS con solo una llamada!';
$p_preheader =  'No más besos de ceniza ni pestañas quemadas, ¡dile hola a IQOS!';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '15';
$p_name4folder =  'adopta-cambio';
$p_name4json =  'adopta-cambio-cupon-precios-leads';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta el Cambio';
$p_mailname4FSH =  'Adopta el cambio - cupon + precios';
