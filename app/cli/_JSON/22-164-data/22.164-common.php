...
$p_id =  '164';
$p_subject =  'Una mejor alternativa al consumo de tabaco te está esperando';
$p_preheader =  'Visita nuestros IQOS Corners en Sanborns seleccionados y encuéntrala';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '26';
$p_name4folder =  'iqos-corners';
$p_name4json =  'iqos-corners-venta';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'IQOS Corners';
$p_mailname4FSH =  'IQOS Corners - Venta';
