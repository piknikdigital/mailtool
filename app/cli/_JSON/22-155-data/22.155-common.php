...
$p_id =  '155';
$p_subject =  'Ya no le pidas a tus amigos que te acompañen afuera, mejor ¡adopta el cambio!';
$p_preheader =  'Últimos días con 20% de descuento sobre precios reducidos';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '01';
$p_name4folder =  'adopta-cambio';
$p_name4json =  'adopta-cambio-5';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta el Cambio';
$p_mailname4FSH =  'Adopta el Cambio - Correo 5';
