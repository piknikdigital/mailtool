...
$p_id =  '147';
$p_subject =  '¿Tu amigo se perdió el final de la serie por salir a fumar?';
$p_preheader =  'Regálale 30% de descuento sobre precios reducidos en su primer Kit IQOS';
$p_yy =  '22';
$p_mm =  '08';
$p_dd =  '24';
$p_name4folder =  'adopta-fumador';
$p_name4json =  'adopta-fumador-3';
$p_name4folderDCE =  'Adopta a un fumador';
$p_mailname4DCE =  'Adopta a un fumador 3';
