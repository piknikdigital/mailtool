...
$p_id =  '167';
$p_subject =  'Tu primer Kit IQOS te está esperando';
$p_preheader =  'Llévatelo a casa con un 10% de descuento, ¡no lo dejes pasar!';
$p_yy =  '22';
$p_mm =  '10';
$p_dd =  '10';
$p_name4folder =  'leads-reactivacion';
$p_name4json =  'leads-reactivacion-cdmx';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Reactivación';
$p_mailname4FSH =  'LEADS Reactivación CDMX';
