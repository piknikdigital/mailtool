...
$p_id =  '245';
$p_subject =  'Un exclusivo regalo te está esperando en la compra de tu primer Kit IQOS';
$p_preheader =  'La temporada para compartir está aquí';
$p_yy =  '21';
$p_mm =  '11';
$p_dd =  '29';
$p_name4folder =  'eoy-leads';
$p_name4json =  'eoy-leads-promo-accesorio';
$p_name4folderDCE =  'EoY Leads';
$p_mailname4DCE =  'EoY Leads Promo Accesorio';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'EoY Leads';
$p_mailname4FSH =  'EoY Leads Promo Accesorio';
