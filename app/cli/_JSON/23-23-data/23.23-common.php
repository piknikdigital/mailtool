...
$p_id =  '23';
$p_subject =  'IQOS es una mejor alternativa al consumo de tabaco pero ¿qué es?';
$p_preheader =  'Aquí te contamos todo lo que necesitas saber';
$p_yy =  '23';
$p_mm =  '02';
$p_dd =  '17';
$p_name4folder =  'iqos-vs-vape';
$p_name4json =  'iqos-vs-vape-2.4-leads';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'IQOS vs Vape';
$p_mailname4FSH =  'IQOS vs Vape 2.4 LEADS';
