...
$p_id =  '22';
$p_subject =  'Si IQOS no es un cigarro electrónico, ni un vapeador, entonces ¿qué es?';
$p_preheader =  'Da clic y conoce las diferencias';
$p_yy =  '23';
$p_mm =  '02';
$p_dd =  '17';
$p_name4folder =  'iqos-vs-vape';
$p_name4json =  'iqos-vs-vape-duo-leads';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'IQOS vs Vape';
$p_mailname4FSH =  'IQOS vs Vape - DUO LEADS';
