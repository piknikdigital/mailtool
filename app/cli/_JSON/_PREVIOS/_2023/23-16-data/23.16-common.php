...
$p_id              = '16';
$p_subject         = 'Si se te dificulta encontrar unidades de tabaco para calentar…';
$p_preheader       = 'Te damos la solución';
$p_yy              = '23';
$p_mm              = '01';
$p_dd              = '30';
$p_name4folder     = 'no-rappi';
$p_name4json       = 'hesitator-where-to-buy-heets-day-140';

$p_name4folderDCE  = 'Heets No Rappi';
$p_mailname4DCE    = 'Hesitator Where to buy HEETS - SIN ORDENAR UNIDADES - DAY 140';
