...
$p_id =  '30';
$p_subject =  '%%=ProperCase(first_name)=%%, ¿estás listo para empezar un nuevo mes?';
$p_preheader =  'La información que tu IQOS y tu esperaban está aquí';
$p_yy =  '23';
$p_mm =  '03';
$p_dd =  '13';
$p_name4folder =  'newsletter';
$p_name4json =  'newsletter-abril';
$p_name4folderDCE =  'April Newsletter';
$p_mailname4DCE =  'April Newsletter';
