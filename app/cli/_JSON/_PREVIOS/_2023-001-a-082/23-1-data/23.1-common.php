...
$p_id =  '1';
$p_subject =  '%%=ProperCase(first_name)=%%, conoce todo lo que este mes tiene preparado para ti y tu IQOS';
$p_preheader =  'Da clic y empieza febrero con el pie derecho';
$p_yy =  '23';
$p_mm =  '01';
$p_dd =  '06';
$p_name4folder =  'newsletter';
$p_name4json =  'newsletter-febrero';
$p_name4folderDCE =  'Newsletter';
$p_mailname4DCE =  'Newsletter Febrero';
