...
$p_id =  '154';
$p_subject =  'Si tu perfume ya no cubre el olor a cigarro… es hora de Adoptar el Cambio';
$p_preheader =  'Adopta el cambio y obtén 20% de descuento sobre precios reducidos';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '01';
$p_name4folder =  'adopta-cambio';
$p_name4json =  'adopta-cambio-4';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta el Cambio';
$p_mailname4FSH =  'Adopta el Cambio - Correo 4';
