...
$p_id =  '176';
$p_subject =  '%%=ProperCase(first_name)=%%, en diciembre te esperan grandes cosas ¡y a tu IQOS también!';
$p_preheader =  'Todo lo que debes saber está aquí';
$p_yy =  '22';
$p_mm =  '11';
$p_dd =  '22';
$p_name4folder =  'newsletter';
$p_name4json =  'newsletter-diciembre';
$p_name4folderDCE =  'Newsletter Diciembre';
$p_mailname4DCE =  'Newsletter Diciembre';
