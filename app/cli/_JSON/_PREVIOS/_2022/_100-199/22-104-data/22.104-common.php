...
$p_id =  '104';
$p_subject =  '%%=ProperCase(first_name)=%%, ¿quieres ganarte un IQOS 3 DUO?';
$p_preheader =  'Acompáñanos en nuestro Facebook Live y entérate cómo';
$p_yy =  '22';
$p_mm =  '06';
$p_dd =  '20';
$p_name4folder =  'facebook';
$p_name4json =  'fb-live-laus';
$p_name4folderDCE =  'Facebook Live';
$p_mailname4DCE =  'Facebook Live LAUS';
