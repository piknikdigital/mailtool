...
$p_id =  '3';
$p_subject =  'Conoce todos los servicios que tenemos disponibles para tu IQOS';
$p_preheader =  'Estamos listos para brindarte el mejor servicio';
$p_yy =  '22';
$p_mm =  '01';
$p_dd =  '27';
$p_name4folder =  'comunicado-oos';
$p_name4json =  'comunicado-oos-laus';
$p_name4folderDCE =  'Comunicado OoS';
$p_mailname4DCE =  'Comunicado OoS LAUS';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Comunicado OoS';
$p_mailname4FSH =  'Comunicado OoS LAUS';
