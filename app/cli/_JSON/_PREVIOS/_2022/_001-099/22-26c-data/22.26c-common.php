...
$p_id =  '26c';
$p_subject =  '¿Una mejor alternativa al consumo de tabaco?';
$p_preheader =  'Esto es IQOS';
$p_yy =  '22';
$p_mm =  '05';
$p_dd =  '27';
$p_name4folder =  'leads';
$p_name4json =  'leads-hnb-combustible';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Journey Leads post OOS CTA Compra';
$p_mailname4FSH =  'LEADS HnB Combustible Version C';
