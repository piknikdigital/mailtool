...
$p_id =  '28c';
$p_subject =  'Ya escuchaste hablar de IQOS pero…';
$p_preheader =  '¿Conoces las diferencias que tiene con un vaporizador? ';
$p_yy =  '22';
$p_mm =  '05';
$p_dd =  '27';
$p_name4folder =  'leads';
$p_name4json =  'leads-iqos-vs-vape';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Journey Leads post OOS CTA Compra';
$p_mailname4FSH =  'LEADS IQOS vs Vape Version C';
