...
$p_id =  '2';
$p_subject =  'Conoce nuestros IQOS Corners en Sanborns';
$p_preheader =  '¡Te esperamos!';
$p_yy =  '22';
$p_mm =  '01';
$p_dd =  '19';
$p_name4folder =  'iqos-corners';
$p_name4json =  'iqos-corners-sanborns-leads';
$p_name4folderDCE =  'IQOS Corners';
$p_mailname4DCE =  'IQOS Corners Sanborns LEADS';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'IQOS Corners';
$p_mailname4FSH =  'IQOS Corners Sanborns LEADS';
