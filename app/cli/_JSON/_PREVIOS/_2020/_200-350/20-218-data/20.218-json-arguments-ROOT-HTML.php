...
require_once("20.218-common.php");
...
--------------------------------------------------------
El día ha llegado, es momento de decidirte. 
...
Contacta a tu <span style=\"color: #e4ab68; font-weight: 700;\">Experto IQOS</span> para realizar la compra de tu dispositivo en préstamo** y conocer más sobre las opciones de pago. De lo contrario, pregúntale los pasos a seguir para devolver el dispositivo.

--------------------------------------------------------

*Código de descuento redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com). Válido únicamente en la compra de tu primer Kit IQOS en la República Mexicana. No es válido en la compra de unidades de tabaco para calentar ni en accesorios IQOS. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Vigencia del código hasta el 31 de octubre de 2020. Aplicable únicamente en compras realizadas con Asesores Comerciales IQOS, Tiendas IQOS participantes (IQOS Store, IQOS Shop) y compras realizadas en www.iqos.com. Sujeto a disponibilidad de inventario. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago. Consulta <a href=\"https://www.iqos.com/mx/es/terminos-condiciones.html\" style=\"text-decoration:underline;\"  target=\"_blank\">Términos y Condiciones.</a><br><br>**El periodo de prueba del Programa de Préstamo IQOS es de hasta 15 días naturales a partir de la entrega del dispositivo. Al cabo de dicho período, el usuario puede optar por comprar el dispositivo o devolverlo. Sujeto a disponibilidad de inventario. Programa exclusivo para para fumadores adultos en la Ciudad de México y área metropolitana. Consulta requisitos y <a href=\"https://www.probar-iqos.com/terminos-condiciones\" style=\"text-decoration:underline;\"  target=\"_blank\">Términos y Condiciones</a> del programa.<br><br>Meses sin intereses: Recibe 3 o 6 meses sin intereses al momento del pago y sobre el total de tu compra con tarjetas de crédito de bancos participantes. Bancos participantes: Afirme, Banbajio, Banca Mifel, Banco Ahorro Famsa, Banorte, IXE, Banjercito, Banregio, HSBC, Inbursa, Invex Banco, Itaucard, Santander, Liverpool, Sctotiabank, Banamex, BBVA, American Express. 
