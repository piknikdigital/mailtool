...
$p_id              = '218c';
$p_subject         = 'El momento ha llegado.';
$p_preheader       = 'IQOS EL RETO ha llegado a su fin.';

$p_yy              = '20';
$p_mm              = '09';
$p_dd              = '07';
$p_name4folder     = 'lending-el-reto';
$p_name4json       = 'lending-el-reto-buy-ver4';

$p_name4folderDCE  = 'Lending_ELRETO';
$p_mailname4DCE    = 'Lending El Reto - Day 15 - Buy';
$p_customerkey_DCE = 'custkeyDCE';

$p_name4folderFSH  = 'Lending_ELRETO';
$p_mailname4FSH    = 'Lending El Reto - Day 15 - Buy - v4 - 2020 11 27';
$p_customerkey_FSH = 'd63495f0-f3ce-4983-8cba-3475581a44c1';
$id_FSH_folder     = '80';
