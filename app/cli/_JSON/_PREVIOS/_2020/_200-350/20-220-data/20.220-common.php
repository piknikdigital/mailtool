...
$p_id              = '220';
$p_subject         = 'IQOS cada vez más cerca de ti.';
$p_preheader       = 'La alternativa para consumir tabaco llega a más estados.';

$p_yy              = '20';
$p_mm              = '09';
$p_dd              = '09';
$p_name4folder     = 'shipping';
$p_name4json       = 'shipping-reward';

$p_name4folderDCE  = 'Shipping_reward';
$p_mailname4DCE    = 'Shipping';
$p_customerkey_DCE = '68cfcdfa-712f-4b5c-80d8-471995cd3cbe';

$p_name4folderFSH  = 'Shipping_reward';
$p_mailname4FSH    = 'Shipping';
$p_customerkey_FSH = '6bc95794-cda5-4132-8314-00e5f9142f85';
$id_FSH_folder     = '00';
