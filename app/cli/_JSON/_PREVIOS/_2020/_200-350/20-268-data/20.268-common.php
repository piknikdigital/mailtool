...
$p_id              = '268';
$p_subject         = 'Continúa viviendo el cambio con un segundo IQOS.';
$p_preheader       = '¡Adquiérelo hoy y aprovecha un 55% de descuento!';

$p_yy              = '20';
$p_mm              = '11';
$p_dd              = '26';
$p_name4folder     = 'secondary-device';
$p_name4json       = 'secondary-device-laus-2';

$p_name4folderDCE  = 'NA';
$p_mailname4DCE    = 'Secondary Device LAUS 2';
$p_customerkey_DCE = 'NA';

$p_name4folderFSH  = 'NA';
$p_mailname4FSH    = 'Secondary Device LAUS 2';
