...
$p_id              = '216c';
$p_subject         = 'Estás por comenzar IQOS El Reto.';
$p_preheader       = 'IQOS está muy cerca.';

$p_yy              = '20';
$p_mm              = '09';
$p_dd              = '07';
$p_name4folder     = 'lending-el-reto';
$p_name4json       = 'lending-el-reto-confirmation-ver4';

$p_name4folderDCE  = 'Lending_ELRETO';
$p_mailname4DCE    = 'Lending El Reto - Day 01 - Confirmation';
$p_customerkey_DCE = 'custkeyDCE';

$p_name4folderFSH  = 'Lending_ELRETO';
$p_mailname4FSH    = 'Lending El Reto - Day 01 - Confirmation - v4 - 2020 11 27';
$p_customerkey_FSH = '2d213f35-856d-4e4e-96f7-efb99daaa127';
$id_FSH_folder     = '80';
