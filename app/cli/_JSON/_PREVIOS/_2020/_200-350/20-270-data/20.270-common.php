...
$p_id              = '270';
$p_subject         = 'Momentos inolvidables, libres del humo de cigarro.';
$p_preheader       = 'Con IQOS es posible. ¡Únete al cambio!';

$p_yy              = '20';
$p_mm              = '11';
$p_dd              = '30';
$p_name4folder     = 'end-of-year';
$p_name4json       = 'end-of-year-leads-2';

$p_name4folderDCE  = 'NA';
$p_mailname4DCE    = 'NA';
$p_customerkey_DCE = 'NA';

$p_name4folderFSH  = 'End Of Year';
$p_mailname4FSH    = 'End Of Year LEADS 2';
$p_customerkey_FSH = '1e0f0b34-3c74-48f3-9613-c3dcfc3315b8';
$id_FSH_folder     = '93';
