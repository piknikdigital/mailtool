...
require_once("20.234-common.php");
...
/* 
    ...
    CODIGO PARA CUPON 234234XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Miles de mexicanos ya son parte del cambio.<br>¡Esta es tu oportunidad!<br><br>Usa el siguiente código(1) y recibe 
--------------------
$500 MXN 
#d6a76f
--------------------
...
CTA1
--------------------
Conoce la experiencia de los que ya somos<br>parte del cambio y únete.
