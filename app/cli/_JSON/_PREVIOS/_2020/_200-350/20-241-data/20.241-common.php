...
$p_id              = '241';
$p_subject         = 'Conoce una mejor alternativa para consumir tabaco en nuestras Tiendas IQOS.';
$p_preheader       = '¡Te estamos esperando!';

$p_yy              = '20';
$p_mm              = '10';
$p_dd              = '19';
$p_name4folder     = 'stores-recap';
$p_name4json       = 'stores-recap';

$p_name4folderDCE  = 'Stores';
$p_mailname4DCE    = 'Stores';
$p_customerkey_DCE = '';

$p_name4folderFSH  = 'Stores';
$p_mailname4FSH    = 'Stores';
$p_customerkey_FSH = '3a78bdff-58bc-4e8f-bd9d-bd28e3c1c89a';
$id_FSH_folder     = '88';
