...
$p_id              = '273';
$p_subject         = 'Hay usuarios que tienen más de un IQOS ¿Quieres ser uno de ellos?';
$p_preheader       = '¡Aprovecha un exclusivo descuento y continúa con el cambio!';

$p_yy              = '20';
$p_mm              = '12';
$p_dd              = '02';
$p_name4folder     = 'secondary-device';
$p_name4json       = 'secondary-device-laus-1';

$p_name4folderDCE  = 'NA';
$p_mailname4DCE    = 'Secondary Device LAUS 1';
