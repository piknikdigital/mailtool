...
$p_id =  '221';
$p_subject =  'Estas a un paso de cambiarte a una mejor alternativa con IQOS';
$p_preheader =  'Esto seguro te interesa';
$p_yy =  '21';
$p_mm =  '10';
$p_dd =  '27';
$p_name4folder =  'warm-lending-vpd';
$p_name4json =  'warm-learn-find-vpd';
$p_name4folderDCE =  'WARM Lending VPD';
$p_mailname4DCE =  'WARM Learn Find VPD';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'WARM Lending VPD';
$p_mailname4FSH =  'WARM Learn Find VPD';
