...
$p_id =  '206';
$p_subject =  'IQOS es diferente a lo que conoces';
$p_preheader =  'Deja que los usuarios te hablen de su experiencia';
$p_yy =  '21';
$p_mm =  '10';
$p_dd =  '19';
$p_name4folder =  'warm-lending';
$p_name4json =  'warm-learn-consider-lending';
$p_name4folderDCE =  'WARM Lending';
$p_mailname4DCE =  'WARM Learn Consider Lending';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'WARM Lending';
$p_mailname4FSH =  'WARM Learn Consider Lending';
