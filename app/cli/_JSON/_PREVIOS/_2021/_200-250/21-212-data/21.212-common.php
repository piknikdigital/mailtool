...
$p_id =  '212';
$p_subject =  '¿Tienes dificultades con el uso de tu dispositivo IQOS?';
$p_preheader =  'Esta información puede ayudarte';
$p_yy =  '21';
$p_mm =  '10';
$p_dd =  '22';
$p_name4folder =  'dormant';
$p_name4json =  'dormant-painpoint-devices';
$p_name4folderDCE =  'Dormant';
$p_mailname4DCE =  'Dormant PainPoint Devices';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Dormant';
$p_mailname4FSH =  'Dormant PainPoint Devices';
