...
$p_id =  '211';
$p_subject =  'Queremos ayudarte a mejorar tu experiencia con las unidades de tabaco para calentar';
$p_preheader =  'Aquí encontrarás algunos consejos para hacerlo';
$p_yy =  '21';
$p_mm =  '10';
$p_dd =  '22';
$p_name4folder =  'dormant';
$p_name4json =  'dormant-painpoint-heets';
$p_name4folderDCE =  'Dormant';
$p_mailname4DCE =  'Dormant PainPoint HEETS';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Dormant';
$p_mailname4FSH =  'Dormant PainPoint HEETS';
