...
$p_id =  '210';
$p_subject =  'Nos interesa conocer tu experiencia con IQOS';
$p_preheader =  'Ayúdanos a mejorar';
$p_yy =  '21';
$p_mm =  '10';
$p_dd =  '22';
$p_name4folder =  'dormant';
$p_name4json =  'dormant-painpoints-diagnosis';
$p_name4folderDCE =  'Dormant';
$p_mailname4DCE =  'Dormant PainPoints Diagnosis';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Dormant';
$p_mailname4FSH =  'Dormant PainPoints Diagnosis';
