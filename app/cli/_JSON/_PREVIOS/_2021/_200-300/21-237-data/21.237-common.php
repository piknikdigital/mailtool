...
$p_id =  '237';
$p_subject =  '¡Tenemos 50% de descuento en accesorios IQOS 3 MULTI!';
$p_preheader =  'Estas fiestas personaliza tu dispositivo como siempre has querido';
$p_yy =  '21';
$p_mm =  '11';
$p_dd =  '30';
$p_name4folder =  'eoy-laus';
$p_name4json =  'eoy-laus-promo-accesorios';
$p_name4folderDCE =  'EOY LAUS';
$p_mailname4DCE =  'EoY LAUS Promo Accesorios';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'EOY LAUS';
$p_mailname4FSH =  'EoY LAUS Promo Accesorios';
