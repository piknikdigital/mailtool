...
$p_id =  '241';
$p_subject =  '¿Ya sabes dónde encontrar las unidades de tabaco para calentar?';
$p_preheader =  'Entonces esto es para ti';
$p_yy =  '21';
$p_mm =  '11';
$p_dd =  '26';
$p_name4folder =  'heets';
$p_name4json =  'heets-delivery-services';
$p_name4folderDCE =  'Heets Diciembre';
$p_mailname4DCE =  'Heets Delivery Services';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Heets Diciembre';
$p_mailname4FSH =  'Heets Delivery Services';
