...
$p_id =  '216';
$p_subject =  '¡No te quedes sin unidades de tabaco para calentar!';
$p_preheader =  'Aquí te decimos dónde encontrarlas';
$p_yy =  '21';
$p_mm =  '10';
$p_dd =  '22';
$p_name4folder =  'dormant';
$p_name4json =  'dormant-heets-availability';
$p_name4folderDCE =  'Dormant';
$p_mailname4DCE =  'Dormant HEETS Availability';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Dormant';
$p_mailname4FSH =  'Dormant HEETS Availability';
