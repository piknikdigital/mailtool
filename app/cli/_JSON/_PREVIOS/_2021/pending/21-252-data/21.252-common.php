...
$p_id =  '252';
$p_subject =  '¿Conoces las diferencias entre un cigarro y las alternativas libres de humo? ';
$p_preheader =  'Esta información te interesa';
$p_yy =  '21';
$p_mm =  '12';
$p_dd =  '06';
$p_name4folder =  'fsh';
$p_name4json =  'fsh-alternatives-cigarettes';
$p_name4folderDCE =  'FSH';
$p_mailname4DCE =  'FsH Alternatives Cigarettes';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'FSH';
$p_mailname4FSH =  'FsH Alternatives Cigarettes';
