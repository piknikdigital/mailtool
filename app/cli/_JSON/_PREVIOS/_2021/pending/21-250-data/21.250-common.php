...
$p_id =  '250';
$p_subject =  '¿Sabías que el verdadero problema es quemar el tabaco?';
$p_preheader =  'No se trata de prohibir, se trata de regular';
$p_yy =  '21';
$p_mm =  '12';
$p_dd =  '06';
$p_name4folder =  'fsh';
$p_name4json =  'fsh-main-problem';
$p_name4folderDCE =  'FSH';
$p_mailname4DCE =  'FsH Main Problem';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'FSH';
$p_mailname4FSH =  'FsH Main Problem';
