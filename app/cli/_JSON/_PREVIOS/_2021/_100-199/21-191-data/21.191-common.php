...
$p_id =  '191';
$p_subject =  '¿Sabías que los beneficios de IQOS se perciben desde el primer día?';
$p_preheader =  '¿Los conociste?';
$p_yy =  '21';
$p_mm =  '09';
$p_dd =  '27';
$p_name4folder =  'lending';
$p_name4json =  'lending-churn-benefits';
$p_name4folderDCE =  'Lending';
$p_mailname4DCE =  'Lending Churn Benefits';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Lending';
$p_mailname4FSH =  'Lending Churn Benefits';
