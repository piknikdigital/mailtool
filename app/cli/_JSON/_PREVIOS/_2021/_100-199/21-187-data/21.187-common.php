...
$p_id =  '187';
$p_subject =  'Tu periodo de prueba ha terminado ¿qué sigue?';
$p_preheader =  'Es momento de tomar una decisión';
$p_yy =  '21';
$p_mm =  '09';
$p_dd =  '27';
$p_name4folder =  'lending';
$p_name4json =  'lending-hypercare-journey-day-14-v1';
$p_name4folderDCE =  'Lending';
$p_mailname4DCE =  'Lending Hypercare Journey Day 14 v1';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Lending';
$p_mailname4FSH =  'Lending Hypercare Journey Day 14 v1';
