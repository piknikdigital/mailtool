...
$p_id =  '153';
$p_subject =  '¿Sabías que el problema principal con el cigarro es la combustión?';
$p_preheader =  'Conoce acerca de las  alternativas al consumo de tabaco.';
$p_yy =  '21';
$p_mm =  '08';
$p_dd =  '06';
$p_name4folder =  'fsh';
$p_name4json =  'fsh-diferencias-alternativas';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'FSH';
$p_mailname4FSH =  'FSH Comparativa';
