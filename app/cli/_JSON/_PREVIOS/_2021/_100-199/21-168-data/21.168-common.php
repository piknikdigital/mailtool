...
$p_id =  '168';
$p_subject =  'Un servicio, muchas soluciones.';
$p_preheader =  'Vamos de la mano para cuando lo necesites. ';
$p_yy =  '21';
$p_mm =  '09';
$p_dd =  '03';
$p_name4folder =  'mgm';
$p_name4json =  'mgm-adopter-day-80-icp-mgm-maintenance-from-store';
$p_name4folderDCE =  'MGM';
$p_mailname4DCE =  'MGM ADOPTER Day 80 ICP MGM Maintenance from store';
