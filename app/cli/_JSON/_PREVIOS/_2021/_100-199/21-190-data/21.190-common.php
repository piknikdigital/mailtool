...
$p_id =  '190';
$p_subject =  '¿Tuviste inconvenientes con las unidades de tabaco para calentar?';
$p_preheader =  'Esta información te interesa';
$p_yy =  '21';
$p_mm =  '09';
$p_dd =  '27';
$p_name4folder =  'lending';
$p_name4json =  'lending-churn-heets';
$p_name4folderDCE =  'Lending';
$p_mailname4DCE =  'Lending Churn Heets';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Lending';
$p_mailname4FSH =  'Lending Churn Heets';
