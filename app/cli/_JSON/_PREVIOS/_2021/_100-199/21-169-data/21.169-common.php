...
$p_id =  '169';
$p_subject =  '%%=ProperCase(first_name)=%%, ¡hoy cumples 60 días con IQOS! ';
$p_preheader =  '¿Ya notaste los cambios?';
$p_yy =  '21';
$p_mm =  '09';
$p_dd =  '03';
$p_name4folder =  'mgm';
$p_name4json =  'mgm-hesitator-day-60-hnb-category-science-milestone';
$p_name4folderDCE =  'MGM';
$p_mailname4DCE =  'MGM HESITATOR Day 60 HnB Category Science Milestone';
