...
$p_id =  '182';
$p_subject =  'Confirmado ¡Ya falta menos para empezar IQOS | El Reto! ';
$p_preheader =  'Esta información te interesa';
$p_yy =  '21';
$p_mm =  '09';
$p_dd =  '27';
$p_name4folder =  'lending';
$p_name4json =  'lending-transactional-order-confirmation-used-device';
$p_name4folderDCE =  'Lending';
$p_mailname4DCE =  'Lending Transactional Order Confirmation Used Device';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Lending';
$p_mailname4FSH =  'Lending Transactional Order Confirmation Used Device';
$p_customerkey_FSH =  'c20c4c27-1377-4dc7-a4bc-4114ac9a000b';
$id_FSH_folder =  '127';
