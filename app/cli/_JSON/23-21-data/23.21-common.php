...
$p_id =  '21';
$p_subject =  '%%=ProperCase(first_name)=%%, conoce todo lo que el mes de la primavera trajo para ti y tu IQOS';
$p_preheader =  'Lo que necesitas saber para este mes a un clic de distancia';
$p_yy =  '23';
$p_mm =  '02';
$p_dd =  '15';
$p_name4folder =  'newsletter';
$p_name4json =  'newsletter-marzo';
$p_name4folderDCE =  'Newsletter';
$p_mailname4DCE =  'Newsletter Marzo';
