...
$p_id =  '251';
$p_subject =  '¡Hay que creer en los datos y los hechos! ';
$p_preheader =  'Conoce por qué la nicotina no es el problema principal de fumar';
$p_yy =  '21';
$p_mm =  '12';
$p_dd =  '06';
$p_name4folder =  'fsh';
$p_name4json =  'fsh-whats-nicotine';
$p_name4folderDCE =  'FSH';
$p_mailname4DCE =  'FsH Whats Nicotine';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'FSH';
$p_mailname4FSH =  'FsH Whats Nicotine';
