...
$p_id =  '152';
$p_subject =  '¿Te perdiste tu canción favorita en la fiesta por salir a fumar?';
$p_preheader =  'Adopta el Cambio y obtén 20% de descuento en la compra de tu primer Kit IQOS';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '01';
$p_name4folder =  'adopta-cambio';
$p_name4json =  'adopta-cambio-2';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta el Cambio';
$p_mailname4FSH =  'Adopta el Cambio - Correo 2';
