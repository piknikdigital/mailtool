...
$p_id              = '17';
$p_subject         = 'Las unidades de tabaco para calentar están muy cerca de ti';
$p_preheader       = 'Encuentra aquí tu punto de venta más cercano';

$p_yy              = '23';
$p_mm              = '01';
$p_dd              = '30';
$p_name4folder     = 'no-rappi';
$p_name4json       = 'adopter-where-to-buy-heets-day-140';

$p_name4folderDCE  = 'Heets No Rappi';
$p_mailname4DCE    = 'Adopter Where To Buy Heets - SIN ORDENAR UNIDADES - DAY 140';
