...
$p_id =  '75';
$p_subject =  'No dejes pasar la oportunidad de llevarte tu primer Kit IQOS a un ¡súper precio!';
$p_preheader =  'Únete hoy al cambio y obtén 20% de descuento en tu compra';
$p_yy =  '23';
$p_mm =  '06';
$p_dd =  '09';
$p_name4folder =  'leads-junio';
$p_name4json =  'leads-junio-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS junio';
$p_mailname4FSH =  'LEADS junio 1';
