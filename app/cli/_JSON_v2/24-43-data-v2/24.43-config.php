...
$p_id =  '43';
$p_subject =  'Disfruta de una increíble experiencia de tabaco con IQOS🤩';
$p_preheader =  'Elige tu IQOS ORIGINALS ideal👌🏻';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '29';
$p_name4folder =  'leads-on-top-marzo';
$p_name4json =  'leads-mar-on-top-venta-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS On Top Marzo';
$p_mailname4FSH =  'LEADS_2024_MAR_DCE_ON TOP_VENTA1';
...
--------------------
--------------------
Sigue disfrutando del sabor del tabaco,<br> ahora sin ceniza, sin humo y <br> sin olor a cigarro.
--------------------
--------------------
Precio reducido<span style=\"font-size:12px;\"><sup>(1)</sup></span>:​
--------------------
Disfruta de 10% de descuento* ​
--------------------
con el código:​
--------------------
Precio final​:
...
--------------------
--------------------
(1)Precio reducido válido hasta el 17 de marzo del 2024.<br>*Promoción vigente del 1 de enero al 31 de abril del 2024. Código de 10% de descuento redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com). Válido únicamente en la compra de tu primer Kit IQOS en la República Mexicana. No es válido en la compra de unidades de tabaco para calentar ni en accesorios IQOS. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Vigencia del código del 1 de enero al 31 de abril del 2024. Aplicable en compras realizadas en www.iqos.com, Tiendas IQOS y asesores IQOS. Sujeto a disponibilidad de inventario. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago.
--------------------
--------------------
--------------------
Comprar ahora
