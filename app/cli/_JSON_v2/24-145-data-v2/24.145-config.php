...
$p_mm =  '04';
$p_dd =  '26';
$p_name4folder =  'mgm-tradein';
$p_name4json =  'laus-always-on-trade-in-mgm';
$p_name4folderDCE =  'MGM Trade In';
$p_mailname4DCE =  'LAUS_DCE_ALWAYSON_TRADEIN&MGM';
...
/* 
    ...
    CODIGO PARA CUPON 145145XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 145145XX :   %%referral_code%%
...
--------------------
--------------------
¡Renueva tu dispositivo por el<br><span style=\"color:#00d1d2;font-weight:700;\">NUEVO IQOS ILUMA!​</span>
--------------------
--------------------
Código de descuento:
--------------------
...
--------------------
--------------------
(1) Descuento válido del 7 de abril al 30 de junio de 2024, únicamente para usuarios IQOS con dispositivos IQOS ORIGINALS, IQOS 2.4 PLUS y IQOS 3 DUO registrados en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;\" target=\"_blank\">www.iqos.com</a> en la compra de su primer kit IQOS ILUMA. Aplica solo una vez por usuario registrado. Sujeto a disponibilidad de inventario. Consulta Términos y Condiciones del programa Trade In. <br>  <br> (2) Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en iqos.com y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y en <a href=\"https://www.compraiqos.com.mx\" style=\"text-decoration:underline;\" target=\"_blank\">www.compraiqos.com.mx</a> <br>  <br> (3) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.  <br>  <br> Descuento no válido en productos de tabaco. <br>  <br> (4) Cada beneficio equivale a $300 MXN en dinero electrónico, no canjeable por dinero en efectivo, válido solo en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y Call Center IQOS. No canjeable por productos de tabaco. Por cada amigo que utilice tu código, obtendrás $300 MXN en beneficios, teniendo la oportunidad de recibir hasta $3,000 MXN en beneficios. Limitado a los primeros 10 amigos referidos que compren y registren su dispositivo con tu código único. Redimible solo una vez por usuario registrado (con cuenta creada en iqos.com.)  Cada recompensa deberá ser canjeada en su totalidad en una sola exhibición. Consulta Términos y Condiciones del programa. <br>  <br> (5) Durante abril, mayo y junio de 2024 por cada amigo que utilice tu Código recibirás 100 MXN adicionales en dinero electrónico, no canjeable por dinero en efectivo. Válido  en <a href=\"https://recompensasiqos.plandereconocimientos.com/\" style=\"text-decoration:underline;\" target=\"_blank\">recompensasiqos.plandereconocimientos.com</a>. Limitada a los primeros 10 amigos referidos que compren y registren su dispositivo con tu código único. Consulta  Términos y Condiciones del programa.​



esto ya no
Cada recompensa equivale a $100 MXN en dinero electrónico, no canjeable por dinero en efectivo válido solo en <a href=\"https://recompensasiqos.plandereconocimientos.com/\" style=\"text-decoration:underline;\" target=\"_blank\">recompensasiqos.plandereconocimientos.com</a>. Por cada amigo que utilice tu código, obtendrás $100 MXN en beneficios, teniendo la oportunidad de recibir hasta $1,000 MXN en beneficios. Limitado a los primeros 10 amigos referidos que compren y registren su dispositivo con tu código único. Consulta Términos y Condiciones del programa. Vigencia hasta el 30 de junio de 2024.
