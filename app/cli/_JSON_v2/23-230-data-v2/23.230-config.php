...
$p_id =  '230';
$p_subject =  '%%=ProperCase(first_name)=%%, ¡hoy cumples 6 meses con IQOS! 🎉';
$p_preheader =  'Queremos conocer tu experiencia';
$p_yy =  '23';
$p_mm =  '09';
$p_dd =  '28';
$p_name4folder =  'nps-originals';
$p_name4json =  'nps-ecj-6-months';
$p_name4folderDCE =  'NPS Originals';
$p_mailname4DCE =  'NPS ECJ 6 months';
...
--------------------
--------------------
Hoy cumples <span style=\"color:#00d1d2;font-weight:700;\">6 meses</span> de haberle dicho <br>adiós al humo y queremos que nos <br>cuentes sobre <span style=\"color:#00d1d2;font-weight:700;\">tu experiencia</span> <br>contestando la siguiente encuesta.<br><br>Ayúdanos a mejorar.
--------------------
--------------------
--------------------
--------------------
