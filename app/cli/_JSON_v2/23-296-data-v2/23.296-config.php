...
$p_name4json =  'scan-pack-try-3-menos-olor';
$p_name4folderDCE =  'Scan Pack';
$p_mailname4DCE =  'Scan Pack - Try 3 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 296296XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 296296XX :   %%referral_code%%
