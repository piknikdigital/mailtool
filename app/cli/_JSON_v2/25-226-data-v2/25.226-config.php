...
$p_name4json =  'laus-mgm-tc-23';
$p_name4folderDCE =  'LAUS October';
$p_mailname4DCE =  'LAUS_DCE_MGM_TC_23';
...
$requiredBlocks = array(
    ...
    //Greeting
    'iqos24-columns',       // multirows 2,saludo,3

    'iqos24-columns',       // multirows 4,xxxx,5    cta compartir codigo

    "iqos24-center-img",    // 6
    "iqos24-center-img",    // 7g
    "iqos24-center-img",    // 8            cta quiero registrarme  https://together-club.com/iniciar-sesion

    // Wallet
    "iqos24-center-img",    // 9
    'iqos24-columns',       // 10,11    wallet ios, android


// Compartir código     TBD
// Quiero registrarme   https://together-club.com/iniciar-sesion
...
--------------------
--------------------
(1) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.    <br><br>    (2) Cada beneficio equivale a $150 MXN en dinero electrónico, no canjeable por dinero en efectivo. Por cada amigo que utilice tu código, obtendrás $150 MXN en beneficios, teniendo la oportunidad de recibir hasta $1,500 MXN en beneficios. Limitado a los primeros 10 amigos referidos que compren y registren su dispositivo con tu código único. Redimible solo una vez por usuario registrado (con cuenta creada en iqos.com). Cada recompensa deberá ser canjeada en su totalidad en una sola exhibición. Consulta <a href=\"https://www.iqos.com/mx/es/terminos-y-condiciones-del-programa-refiere-a-un-amigo.html\" style=\"text-decoration:underline;\" target=\"_blank\">Términos y Condiciones</a> del programa.    <br><br>    (3) Descuento del 25% vigente del 01 al 30 de septiembre de 2025. Consulta Términos y Condiciones. Válido en la compra del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse en iqos.com y hacerlo válido en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;\" target=\"_blank\">www.iqos.com</a>
--------------------
--------------------
--------------------
--------------------
