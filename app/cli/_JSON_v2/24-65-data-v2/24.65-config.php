...
$p_id =  '65';
$p_subject =  'No hemos podido realizar tu pago, ¿nos ayudas?';
$p_preheader =  'Estamos aquí para apoyarte 😉';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '06';
$p_name4folder =  'leads-new-device-lending';
$p_name4json =  'leads-pre-dunning-3-lending';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'New Device Lending';
$p_mailname4FSH =  'LEADS_2024_Abril_Pre-Dunning-3_Lending';
...
/* 
    ...
    CODIGO PARA CUPON 6565XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 6565XX :   %%referral_code%%
