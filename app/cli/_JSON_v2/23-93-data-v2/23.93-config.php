...
$p_id =  '93';
$p_subject =  '¡Te damos la bienvenida a IQOS El Reto!';
$p_preheader =  'El momento del cambio llegó.';
$p_yy =  '23';
$p_mm =  '07';
$p_dd =  '14';
$p_name4folder =  'lending-3-duo';
$p_name4json =  'lending-hypercare-day-0';
$p_name4folderDCE =  'Lending 3 DUO';
$p_mailname4DCE =  'LENDING Hypercare Day 0';
...
/* 
    ...
    CODIGO PARA CUPON 9393XX :   %%=v(@voucher_code)=%% 
...
--------------------
Además, ¡no estás solo! Un Experto IQOS te <br>acompañará durante este tiempo para resolver <br>cualquier duda.
--------------------
--------------------
--------------------
Te recomendamos que <span style=\"color:#34303d;font-weight:700;\">durante estos 14 días <br>uses solo IQOS</span> para vivir plenamente <br>sus beneficios.
--------------------
--------------------
--------------------
¿Cuáles son los principales <br>beneficios de IQOS?
--------------------
