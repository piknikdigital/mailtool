...
$p_preheader =  'Comparte el cambio con tus amigos y regálales una sorpresa🎁';
$p_yy =  '24';
$p_mm =  '11';
$p_dd =  '23';
$p_name4folder =  'laus-dic';
$p_name4json =  'laus-trade-in-aromaria-26';
$p_name4folderDCE =  'LAUS December';
$p_mailname4DCE =  'LAUS_DCE_TRADEIN_AROMARIA_#26';
...
$bgColor          = "#050505";    // Don't use "transparent"
...
/* 
    ...
    CODIGO PARA CUPON 308308XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 308308XX :   %%referral_code%%
...
--------------------
--------------------
(1) Descuento del 20% vigente hasta el 31 de diciembre de 2024.​ Únicamente para usuarios IQOS con dispositivo IQOS ORIGINALS, IQOS 3 DUO registrado en www.iqos.com, en la compra de su primer Kit IQOS ILUMA. Este descuento aplica únicamente sobre el precio del dispositivo IQOS ILsobre el total del precio del KIT o accesorios. Sujeto UMA, no aplica a disponibilidad de inventario. Hasta agotar existencias. Consulta Términos y Condiciones del Programa Trade in en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;color:white;\" target=\"_blank\">www.iqos.com</a>     <br><br>    (​2) Los Kit de Regalo Aromaria no son acumulables​. Disponible sólo en la compra de un Kit IQOS ILUMA y/o IQOS ILUMA PRIME en iqos.com y/o Tiendas IQOS. Sujeto a disponibilidad de inventario hasta agotar existencias.      <br><br>      (3) Set de Aros de regalo exclusivamente para ventas en línea en iqos.com en la compra de un Kit IQOS ILUMA y/o IQOS ILUMA PRIME. Sujeto a disponibilidad de inventario. Hasta agotar existencias.
--------------------
--------------------
--------------------
--------------------
