...
$p_mm =  '08';
$p_dd =  '05';
$p_name4folder =  'encuestas';
$p_name4json =  'laus-encuesta2';
$p_name4folderDCE =  'Survey';
$p_mailname4DCE =  'LAUS_DCE_ENCUESTA2';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Encuestas';
$p_mailname4FSH =  'LAUS_DCE_ENCUESTA2';
...
--------------------
--------------------
TÉRMINOS Y CONDICIONES DEL PROGRAMA “ADOPTION CHECK SYSTEM” (el “Programa”)
<br>
<br>1. OBJETO
<br>
<br>El presente Programa tiene como finalidad incentivar la participación en una encuesta dirigida a usuarios adultos de productos con nicotina seleccionados de forma aleatoria por Philip Morris México, S.A. de C.V. (“PMM”), mediante la entrega de una recompensa equivalente a $200 MXN, en recompensa electrónica o puntos del programa Together Club, por participación completada.
<br>
<br>
<br>2. ELEGIBILIDAD
<br>
<br>• Programa válido únicamente para usuarios mayores de edad con cuenta activa en IQOS a los que aleatoriamente se les haya enviado la encuesta dirigida y que hayan completado la misma en su totalidad.
<br>
<br>• La participación es únicamente por selección aleatoria de PMM.
<br>
<br>• Se otorgará una (1) recompensa por participación completada, por Participante.
<br>
<br>
<br>3. OPCIONES DE RECOMPENSA
<br>
<br>a) Puntos Together Club
<br>Al seleccionar esta opción de recompensa, el Participante recibirá de manera inmediata una confirmación de los 200 puntos a abonarse en su cuenta de Usuario IQOS. Los puntos serán visibles dentro de las próximas 72 horas en la cuenta de Together Club asociada. Para elegir esta opción es indispensable que el Participante también se encuentre registrado en Together Club.
<br>
<br>b) Cupón JUJU – Bonos Expréss
<br>Cupón digital equivalente a $200 MXN, canjeable en una amplia variedad de establecimientos.
<br>Válido únicamente en el sitio <a href=\"https://recompensasiqos.plandereconocimientos.com\" style=\"text-decoration:underline;\" target=\"_blank\">https://recompensasiqos.plandereconocimientos.com</a>.
<br>
<br>3.3. Términos adicionales de las opciones de recompensa
<br>
<br>Cada opción de recompensa está sujeta a los términos y condiciones específicos de la plataforma correspondiente:
<br>
<br>• Los puntos Together Club se rigen por los términos y condiciones del programa de lealtad IQOS Together Club, disponibles en: <a href=\"https://www.iqos.com/mx/es/programa-lealtad-together-club.html\" style=\"text-decoration:underline;\" target=\"_blank\">https://www.iqos.com/mx/es/programa-lealtad-together-club.html</a>
<br>
<br>• El cupón JUJU – Bonos Exprés se rige por los términos y condiciones del sitio <a href=\"https://bonosmexicovi.plandereconocimientos.com/pages/login\" style=\"text-decoration:underline;\" target=\"_blank\">https://bonosmexicovi.plandereconocimientos.com/pages/login</a>
<br>
<br>El Participante reconoce y acepta que, al seleccionar una opción de recompensa, deberá consultar y será indispensable aceptar los términos aplicables de dicha plataforma. La empresa no se hace responsable por cambios, restricciones o condiciones impuestas por terceros en relación con el uso o redención de dichas recompensas.
<br>
<br>
<br>4. CONDICIONES DE LA RECOMPENSA
<br>
<br>• Las recompensas son personales e intransferibles.
<br>
<br>• No son canjeables por dinero en efectivo ni por ningún otro bien o servicio distinto a los establecidos.
<br>
<br>• La recompensa será entregada únicamente si se valida que el Participante cumple con todos los requisitos de elegibilidad.
<br>
<br>
<br>5. VIGENCIA
<br>
<br>• Estos términos y condiciones estarán vigentes desde el momento en que el Participante reciba la invitación personalizada para participar en la encuesta por parte de PMM, misma que permanecerá activa por un periodo de 30 (treinta) días naturales, tiempo en el que el Participante deberá completarla efectivamente para finalmente redimir la recompensa correspondiente. Transcurrido el plazo antes mencionado, la encuesta caducará automáticamente y la recompensa no podrá ser redimida.
<br>
<br>PMM se reserva el derecho de modificar o cancelar este Programa en cualquier momento, notificando a los participantes a través de los canales oficiales de IQOS y ZYN.
<br>
<br>
<br>6. PRIVACIDAD Y DATOS PERSONALES
<br>
<br>El tratamiento de los datos personales se realizará conforme a nuestro Aviso de Privacidad, disponible en el siguiente enlace: <a href=\"https://www.pmiprivacy.com/mexico/es-la/consumer/\" style=\"text-decoration:underline;\" target=\"_blank\">https://www.pmiprivacy.com/mexico/es-la/consumer/</a>.
<br>
<br>
<br>
<br>7. LIMITACIÓN DE RESPONSABILIDAD
<br>
<br>• PMM no se hace responsable por fallas técnicas, errores de conexión, interrupciones del servicio o cualquier otro inconveniente que impida la participación o redención de la recompensa emitida por terceros independientes a esta empresa.
<br>
<br>• PMM se reserva el derecho de verificar la identidad y elegibilidad del Participante antes de otorgar la recompensa.
<br>
<br>
<br>8. MODIFICACIONES Y CANCELACIÓN
<br>
<br>PMM se reserva el derecho de modificar o cancelar este Programa en cualquier momento, notificando a los participantes a través de los canales oficiales de IQOS y ZYN.
<br>
<br>
<br>9. ACEPTACIÓN DE LOS TÉRMINOS
<br>
<br>La participación en este Programa implica la aceptación total de los presentes Términos y Condiciones.


--------------------
Consulta nuestro aviso de privacidad con base en el cual son tratados
