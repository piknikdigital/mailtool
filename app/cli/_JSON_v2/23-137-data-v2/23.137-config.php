...
$p_id =  '137';
$p_subject =  'Gracias por adquirir un segundo dispositivo';
$p_preheader =  'Queremos conocer tu experiencia';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '08';
$p_name4folder =  'nps-originals';
$p_name4json =  'nps-compra-2do-iqos';
$p_name4folderDCE =  'NPS Originals';
$p_mailname4DCE =  'NPS Compra 2do IQOS';
...
--------------------
--------------------
Cuéntanos sobre tu <br><span style=\"color:#00d1d2;font-weight:700;\">experiencia comprando <br>tu dispositivo adicional</span><br>contestando la siguiente encuesta.<br><br>Ayúdanos a mejorar.
--------------------
--------------------
--------------------
--------------------
