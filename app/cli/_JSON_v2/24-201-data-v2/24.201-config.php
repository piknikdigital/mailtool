...
$p_dd =  '25';
$p_name4folder =  'leads';
$p_name4json =  'leads-venta-descuento15-23-jul';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_DCE_VENTA-DESCUENTO15_23JUL';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS';
$p_mailname4FSH =  'LEADS_LOCAL_VENTA-DESCUENTO15_23JUL';
...
/* 
    ...
    CODIGO PARA CUPON 201201XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 201201XX :   %%referral_code%%
...
--------------------
--------------------
¡Ve al siguiente nivel ​<br><span style=\"color:#00d1d2;font-weight:700;\">con IQOS!​</span><br><br><b>¡Solo del 26 de julio al 6 de agosto</b><br> adquiere ​tu dispositivo con<br> descuento especial!
--------------------
--------------------
--------------------
--------------------
¡Elige el que mejor<br>vaya con tu estilo!​
--------------------
--------------------
--------------------
--------------------
