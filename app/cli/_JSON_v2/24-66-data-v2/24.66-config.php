...
$p_id =  '66';
$p_subject =  '¿Cómo fue tu experiencia con el Programa de Préstamo IQOS?';
$p_preheader =  'Queremos seguir mejorando 🙌🏼';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '06';
$p_name4folder =  'leads-new-device-lending';
$p_name4json =  'leads-churn-survey-lending';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'New Device Lending';
$p_mailname4FSH =  'LEADS_2024_Abril_Churn-Survey_Lending';
...
/* 
    ...
    CODIGO PARA CUPON 6666XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 6666XX :   %%referral_code%%
