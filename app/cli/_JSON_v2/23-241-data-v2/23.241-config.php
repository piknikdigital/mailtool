...
$p_id =  '241';
$p_subject =  'Celebra los 4 años de IQOS renovando tu dispositivo 🎉';
$p_preheader =  'Estrena un IQOS ORIGINALS a un súper precio ¡aquí!';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '03';
$p_name4folder =  'laus-octubre';
$p_name4json =  'ti-aniversario';
$p_name4folderDCE =  'LAUS Octubre';
$p_mailname4DCE =  'TI + Aniversario';
...
/* 
    ...
    CODIGO PARA CUPON 241241XX :   %%referral_code%%
...
--------------------
--------------------
Celebra los primeros <span style=\"color:#00d1d2;font-weight:700;\">4 años de IQOS en México</span> <br>de la mejor manera, <span style=\"color:#00d1d2;font-weight:700;\">renovando tu dispositivo.</span>
-------------------
Obtén
--------------------
35% de descuento<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
para renovar tu <b>IQOS 2.4 Plus</b> o <b>IQOS 3 MULTI</b> por un nuevo <b>IQOS ORIGINALS</b> en el color que más te guste.
--------------------
--------------------
--------------------
--------------------
Recuerda que desde que te cambiaste a<br>IQOS experimentas grandes beneficios como:
--------------------
--------------------
--------------------
...
--------------------
--------------------
(1) Código \"RENUEVAIQOS\" equivalente a un 35% de descuento, válido hasta el 31 de diciembre de 2023 en la compra de un Kit IQOS ORIGINALS en www.iqos.com, Tiendas IQOS, Call Center IQOS y IQOS Corners en Sanborns. Limitado a un Kit IQOS ORIGINALS por usuario registrado con un dispositivo IQOS 3 MULTI o IQOS 2.4 Plus en iqos.com. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Consulta Términos y Condiciones.
--------------------
--------------------
--------------------
--------------------
