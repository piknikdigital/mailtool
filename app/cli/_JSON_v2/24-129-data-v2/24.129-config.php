...
$p_id =  '129';
$p_subject =  'Cuéntanos sobre tu cambio de dispositivo 🙌🏼';
$p_preheader =  'Queremos conocer tu experiencia';
$p_yy =  '24';
$p_mm =  '04';
$p_dd =  '01';
$p_name4folder =  'nps2';
$p_name4json =  'laus-nps-device-replacement';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NPS_Laus_Device_Replacement';
...
/* 
    ...
    CODIGO PARA CUPON 129129XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 129129XX :   %%referral_code%%
...
--------------------
--------------------
Cuéntanos, <span style=\"color:#00d1d2;font-weight:700;\">¿cómo te fue con <br>tu cambio de dispositivo?</span> <br> <br>Ayúdanos a mejorar.
--------------------
--------------------
--------------------
--------------------
