...
$p_id =  '307';
$p_subject =  'Te presentamos los beneficios de cambiarte a IQOS';
$p_preheader =  '¿Sabías que no los beneficios también son para los que te rodean?';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '02';
$p_name4folder =  'leads-noviembre';
$p_name4json =  'educ-leads-5';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Noviembre';
$p_mailname4FSH =  'Educ LEADS 5';
...
/* 
    ...
    CODIGO PARA CUPON 307307XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 307307XX :   %%referral_code%%
...
--------------------
--------------------
¿Ya conoces los beneficios del <br>calentamiento de tabaco?
--------------------
--------------------
--------------------
...
--------------------
en la compra de tu primer <span style=\"color:#ffffff;font-weight:700;\">Kit IQOS.</span>
--------------------
--------------------
--------------------
