...
$p_name4json =  'laus-mgm-juju-21';
$p_name4folderDCE =  'LAUS JANUARY';
$p_mailname4DCE =  'LAUS_DCE_MGM_JUJU_#21';
...
/* 
    ...
    CODIGO PARA CUPON 326326XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 326326XX :   %%referral_code%%
...
Compartir ahora	https://api.whatsapp.com/send/?text=Te+regalo+20%25+de+descuento+en+la+compra+de+tu+primer+Kit+IQOS+ILUMA.+No+olvides+utilizar+mi+c%C3%B3digo+%25%25referral_code%25%25+al+comprar.&type=custom_url&app_absent=0
