...
$p_id =  '41';
$p_subject =  '¡Encuentra una mejor opción a los cigarros! 😱';
$p_preheader =  '👋 Disfruta del sabor del tabaco ahora con 95% menos sustancias químicas nocivas';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '29';
$p_name4folder =  'leads-on-top-marzo';
$p_name4json =  'leads-mar-on-top-education-2';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS On Top Marzo';
$p_mailname4FSH =  'LEADS_2024_MAR_DCE_ON TOP_EDUCATION2';
...
/* 
    ...
    CODIGO PARA CUPON 4141XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 4141XX :   %%referral_code%%
...
--------------------
--------------------
¿Sabías que IQOS no quema tabaco,<br> lo calienta?​
--------------------
¿Qué hace a IQOS único?
--------------------
--------------------
--------------------
<b>INFORMACIÓN IMPORTANTE:</b> esto no necesariamente equivale a una reducción del riesgo del 95%. IQOS no es libre de riesgo.<br>*Fuente: Reducciones promedio de los niveles de una amplia gama de químicos dañinos​ (excluyendo la nicotina) en comparación con el humo de una referencia estándar del​ cigarrillo (3R4F). No necesariamente equivale a una reducción del riesgo del 95%.
