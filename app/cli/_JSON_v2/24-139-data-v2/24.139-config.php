...
$p_id =  '139';
$p_subject =  '¡Felicidades! 🎉 Hoy cumples 3 meses con IQOS';
$p_preheader =  'Cuéntanos acerca de tu experiencia con tu dispositivo';
$p_yy =  '24';
$p_mm =  '04';
$p_dd =  '09';
$p_name4folder =  'laus-iluma-adopter';
$p_name4json =  'laus-iluma-adopter-day-90';
$p_name4folderDCE =  'Adopter';
$p_mailname4DCE =  'LAUS_2024_Abril_DAY-90_Adopter';
...
/* 
    ...
    CODIGO PARA CUPON 139139XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 139139XX :   %%referral_code%%
...
--------------------
Ya cumpliste 3 meses
00d1d2
--------------------
de unirte al cambio con IQOS.  <br> <br><b>Cuéntanos ¿cómo ha sido tu experiencia?</b>
--------------------
--------------------
--------------------
Gracias por tu respuesta. <br><b>Sigamos juntos en el camino del cambio.</b>
--------------------
--------------------
--------------------
--------------------
