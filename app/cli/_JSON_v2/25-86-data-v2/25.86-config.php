...
$p_mm =  '04';
$p_dd =  '15';
$p_name4folder =  'rates-reviews-juju';
$p_name4json =  'laus-always-on-giftcard-forever-curious';
$p_name4folderDCE =  'Rates and Reviews - Juju';
$p_mailname4DCE =  'LAUS_DCE_ALWAYS_ON_GIFTCARD_FOREVERCURIOUS';
...
$requiredBlocks = array(
    ...
    "iqos24-footer-iqos-forever-curious"    // REEMPLAZA A: "footer_bw_v1_lowercase",
...
--------------------
--------------------
*Cada recompensa equivale a dinero electrónico, no canjeable por efectivo. Válido solo en tiendas 7 Eleven. No aplica en tabaco, alcohol, prepago ni servicios electrónicos. Código de un solo uso.
--------------------
--------------------
--------------------
--------------------
