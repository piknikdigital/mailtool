...
$p_id =  '227';
$p_subject =  '%%=ProperCase(first_name)=%%, festeja con nosotros 4 años sin humo 🎂';
$p_preheader =  'Descubre aquí cómo acompañarnos a la celebración';
$p_yy =  '23';
$p_mm =  '09';
$p_dd =  '28';
$p_name4folder =  'iqos-aniversario';
$p_name4json =  'laus-originals-aniversario';
$p_name4folderDCE =  'Aniversario IQOS';
$p_mailname4DCE =  'LAUS Originals Aniversario';
...
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">Gracias por ser parte de la comunidad IQOS.</span><br>Tú y más de <b>55,000 usuarios</b> han dejado el <br>humo de cigarro atras.<br><br>Festeja con nosotros y participa para poder ganar<br>un <b>IQOS ORIGINALS</b> o una invitación exclusiva al <br>evento de celebración. <br><br>Síguenos en nuestras redes sociales para conocer <br>la dinámica.
--------------------
--------------------
--------------------
--------------------
Celebra el aniversario de IQOS estrenando un nuevo<br><span style=\"color:#00d1d2;font-weight:700;\">IQOS ORIGINALS.</span> 
--------------------
--------------------
--------------------
--------------------
