...
$p_id =  '95';
$p_subject =  'Eleva tu experiencia de tabaco al siguiente nivel. 📈';
$p_preheader =  '¡Aprovecha 50% OFF en tu próxima compra! 🔥';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '15';
...
/* 
    ...
    CODIGO PARA CUPON 9595XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 9595XX :   %%referral_code%%
...
--------------------
--------------------
<b>Evoluciona al siguiente nivel.</b><br>Cambia a IQOS ILUMA hoy y obtén un
--------------------
de descuento<span style=\"font-size:12px;\"><sup>(1)</sup></span> en la compra de tu <br>primer dipositivo <span style=\"color:#00d1d2;font-weight:700;\">IQOS ILUMA</span> en México
...
--------------------
--------------------
La experiencia de tabaco <br><span style=\"color:#00d1d2;font-weight:700;\">como nunca antes.</span>

--------------------
--------------------
(1) Descuento válido del 7 de abril al 30 de junio de 2024, únicamente para usuarios IQOS con dispositivos IQOS ORIGINALS, IQOS 2.4 PLUS y IQOS 3 DUO registrados en www.iqos.com en la compra de su primer kit IQOS ILUMA. Aplica solo una vez por usuario registrado. Sujeto a disponibilidad de inventario. Consulta Términos y Condiciones del programa Trade in.
