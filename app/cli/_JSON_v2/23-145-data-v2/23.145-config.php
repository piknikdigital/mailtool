...
$p_id =  '145';
$p_subject =  '¿Sabes en dónde encontrar las unidades de tabaco para calentar? 🤷🏻‍♀️🤷🏻‍♂️';
$p_preheader =  'Aquí te decimos dónde';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '10';
$p_name4folder =  'high-priority';
$p_name4json =  'high-conversion-day-5';
$p_name4folderDCE =  'High Priority';
$p_mailname4DCE =  'High Conversion Day 5';
...
--------------------
--------------------
¿Ya sabes dónde encontrar las unidades de tabaco para calentar?
--------------------
¡No te preocupes!<b>Las puedes encontrar en:</b>
--------------------
--------------------
...
--------------------
--------------------
El inventario y disponibilidad del producto
es responsabilidad de cada cadena.
--------------------
--------------------
--------------------
¿Tienes dudas?
  
Nuestros Expertos IQOS están listos para ayudarte, contáctanos por:
