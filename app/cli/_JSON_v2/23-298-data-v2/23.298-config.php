...
$p_name4json =  'scan-pack-try-5-menos-olor';
$p_name4folderDCE =  'Scan Pack';
$p_mailname4DCE =  'Scan Pack - Try 5 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 298298XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 298298XX :   %%referral_code%%
