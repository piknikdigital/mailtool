...
$p_id =  '309';
$p_subject =  'Esta temporada regala 30% de descuento para el primer Kit IQOS ';
$p_preheader =  'Llego el momento de ofrecer una mejor alternativa, sin humo';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '29';
$p_name4folder =  'eoy-2023';
$p_name4json =  'laus-eoy-2';
$p_name4folderDCE =  'EoY 2023';
$p_mailname4DCE =  'LAUS EOY 2';
...
/* 
    ...
    CODIGO PARA CUPON 309309XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 309309XX :   %%referral_code%%
...
--------------------
--------------------
Ayuda a tus amigos<span style=\"font-size:12px;\"><sup>(1)</sup></span> a cambiar a una mejor<br> opción que continuar fumando.
--------------------
--------------------
--------------------
Regálales un 
...
--------------------
en la compra de su primer Kit IQOS,<br>y tú obtén hasta
--------------------
e3bf85
$3,000MXN en beneficios<span style=\"font-size:18px;\"><sup>(3)</sup></span>. 
--------------------
--------------------
--------------------
