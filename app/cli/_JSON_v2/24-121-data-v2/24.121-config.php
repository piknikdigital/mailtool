...
$p_id =  '121';
$p_subject =  'Descubre más sobre IQOS 🤩';
$p_preheader =  'Obtén tu IQOS ILUMA con un 10% de descuento ';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '25';
$p_name4folder =  'leads-guided-trial';
$p_name4json =  'leads-iluma-guided-trial-price-with-discounts-taste-experience';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_2024_Jul_ILUMA_Price_With_Discounts_Taste_Experience_Guided_Trial';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Guided Trial';
$p_mailname4FSH =  'LEADS_2023_Abril_ILUMA_Price_With_Discounts_Taste_Experience_Guided_Trial';
...
/* 
    ...
    CODIGO PARA CUPON 121121XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 121121XX :   %%referral_code%%
...
--------------------
--------------------00d1d2
El momento de decirle adiós al olor a humo de cigarro, <br>de una manera práctica y sencilla, ha llegado.
...
--------------------00d1d2
--------------------
Encuentra tu dispositivo favorito en la<br> tienda Sanborns más cercana
--------------------
y descubre una nueva forma de disfrutar del<br> tabaco sin humo.
--------------------
--------------------00d1d2
...
--------------------00d1d2
Agenda una prueba en cualquiera de nuestras <br>tiendas y vive la experiencia IQOS.
--------------------
--------------------
