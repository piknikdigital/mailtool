...
$p_id =  '266';
$p_subject =  'Estrenar un nuevo IQOS ORIGINALS ONE es muy fácil 🤩';
$p_preheader =  'Obtén tu primer Kit IQOS con 10% de descuento';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '06';
$p_name4folder =  'leads-octubre';
$p_name4json =  'leads-originals-hardsale-one-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Octubre';
$p_mailname4FSH =  'LEADS Originals Hardsale ONE 1';
...
/* 
    ...
    CODIGO PARA CUPON 266266XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 266266XX :   %%referral_code%%
