...
$p_mm =  '04';
$p_dd =  '30';
$p_name4folder =  'leads-hot-sale';
$p_name4json =  'leads-hotsale-venta-cashback';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Hot Sale';
...
/* 
    ...
    CODIGO PARA CUPON 150150XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 150150XX :   %%referral_code%%
...
--------------------
--------------------
Las gift cards no son canjeables por dinero en efectivo. Promoción válida del 15 al 23 de mayo de 2024.
--------------------
--------------------
--------------------
--------------------
