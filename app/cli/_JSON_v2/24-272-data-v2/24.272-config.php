...
$p_name4json =  'laus-nuevos-precios-mgm-7';
$p_name4folderDCE =  'LAUS NOVEMBER';
$p_mailname4DCE =  'LAUS_DCE_NUEVOSPRECIOS_MGM_7';
...
/* 
    ...
    CODIGO PARA CUPON 272272XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 272272XX :   %%referral_code%%
