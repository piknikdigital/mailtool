...
$p_mm =  '06';
$p_dd =  '24';
$p_name4folder =  'laus-julio';
$p_name4json =  'laus-mgm-0-2-8-julio';
$p_name4folderDCE =  'LAUS JULY';
$p_mailname4DCE =  'LAUS_DCE_MGM_0-2_8JULIO';
...
$requiredBlocks = array(
    "iqos24-header-iqos",   // 
    'iqos24-columns',       // 1,2,3,4gif

    "iqos24-center-img",    // 5
    'iqos24-columns',       // 6 xx 7  (18%, 64% ,18%)
    "iqos24-center-img",    // 8
...
--------------------
--------------------
(1) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.    <br><br>    (2) Cada beneficio equivale a $150 MXN en dinero electrónico, no canjeable por dinero en efectivo, válido solo en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y Call Center IQOS. No canjeable por productos de tabaco. Por cada amigo que utilice tu código, obtendrás $150 MXN en beneficios, teniendo la oportunidad de recibir hasta $1,500 MXN en beneficios. Limitado a los primeros 10 amigos referidos que compren y registren su dispositivo con tu código único. Redimible solo una vez por usuario registrado (con cuenta creada en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;\" target=\"_blank\">iqos.com</a>). Cada recompensa deberá ser canjeada en su totalidad en una sola exhibición. Consulta <a href=\"https://www.iqos.com/mx/es/terminos-y-condiciones-del-programa-refiere-a-un-amigo.html\" style=\"text-decoration:underline;\" target=\"_blank\">Términos y Condiciones</a> del programa.    <br><br>    (3) Sobre las recompensas: Los primeros 10 referidos te regalan 150 MXN en recompensas electrónicas en Together Club, además puedes elegir entre:    <br><br>    (3.1) SPOTIFY* Tu segundo y tercer referido te dan la opcion de elegir 3 meses gratis de Spotify Premium, vigencia válida al 31 de Diciembre 2025.    <br><br>    (3.2) Accesorios* Sujeto a disponibilidad de inventario, cupón válido para cualquier accesorio iqos en cualquiera de nuestros puntos de venta (iqos.com, Tiendas IQOS), vigencia válida al 31 de Diciembre 2025.    <br><br>    (3.3) Puntos adicionales en Together Club; de elegir este premio, se verán reflejados automáticamente en tu cuenta Together Club en 24 horas maximo.    <br><br>    (4) Descuento del 25% vigente del 01 al 31 de julio de 2025. Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;\" target=\"_blank\">iqos.com</a> y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y en www.iqos.com
