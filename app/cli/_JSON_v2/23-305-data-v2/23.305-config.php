...
$p_id =  '305';
$p_subject =  'Conoce más acerca de IQOS y sus beneficios';
$p_preheader =  '¿Sabías que elimina el olor a humo de cigarro?';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '02';
$p_name4folder =  'leads-noviembre';
$p_name4json =  'educ-leads-3';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Noviembre';
$p_mailname4FSH =  'Educ LEADS 3';
...
--------------------
--------------------
el cambio es posible<br>con <span style=\"color:#00d1d2;font-weight:700;\">IQOS. </span>

--------------------
IQOS brinda una experiencia de sabor diferente, <br>ofreciendo una satisfacción similar a la del <br>cigarro pero con menor riesgo.*
--------------------
--------------------
*Estudio clínico de 3 meses realizado en EE. UU. y Japón con 160 fumadores adultos 
cada uno, en condiciones casi reales.
--------------------
<b>Información importante:</b> IQOS no es libre de riesgo y entrega nicotina la cual es adictiva.
--------------------
--------------------
--------------------
Únete al cambio y adquiere tu dispositivo<br>usando el siguiente código para obtener
--------------------
