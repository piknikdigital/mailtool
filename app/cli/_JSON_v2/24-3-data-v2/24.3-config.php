...
$p_id =  '3';
$p_subject =  'Un nuevo comienzo con IQOS ILUMA 🤩​';
$p_preheader =  'La experiencia de tabaco mejorada';
$p_yy =  '24';
$p_mm =  '01';
$p_dd =  '15';
$p_name4folder =  'iluma-conversion';
$p_name4json =  'password';
$p_name4folderDCE =  'Iluma Conversion';
$p_mailname4DCE =  'Password';
...
/* 
    ...
    CODIGO PARA CUPON 33XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 33XX :   %%referral_code%%
...
--------------------
--------------------
¡Gracias por registrarte en IQOS!<br><br>Para tener una mejor experiencia, se ha creado una cuenta con tu correo en iqos.com<br><br>Para usarla, debes primero establecer tu contraseña, dando clic en olvidar contraseña desde aquí.
--------------------
--------------------
--------------------
--------------------
--------------------
¿Ya compraste<br>tu dispositivo?
--------------------
Regístralo en IQOS y ten<br>todos los servicios y<br>beneficios en un solo lugar.
--------------------
--------------------
--------------------
--------------------
...
--------------------
--------------------
IQOS ILUMA&trade; cuenta con la tecnología SMARTCORE&trade; la cual funciona con unidades de tabaco calentado exclusivamente diseñadas para su uso. Para evitar dañar el dispositivo, nodeben utilizarse estas unidades de tabaco con otros dispositivos IQOS que no pertenezcan a la gama de productos ILUMA. IQOS ILUMA no es libre de riesgo ya que entrega nicotina, que es adictiva. Uso exclusivo para adultos.
--------------------
--------------------
--------------------
--------------------
