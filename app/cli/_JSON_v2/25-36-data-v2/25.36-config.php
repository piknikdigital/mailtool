...
$p_name4json =  'leads-local-tiendas-18';
$p_name4folderDCE =  'LEADS MARCH';
$p_mailname4DCE =  'LEADS_LOCAL_TIENDAS_18';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS MARZO';
$p_mailname4FSH =  'LEADS_LOCAL_TIENDAS_18';
...
/* 
    ...
    CODIGO PARA CUPON 3636XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 3636XX :   %%referral_code%%
