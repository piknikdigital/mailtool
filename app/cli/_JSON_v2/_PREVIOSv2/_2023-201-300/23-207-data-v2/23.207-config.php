...
$p_id =  '207';
$p_subject =  'El cambio tiene una nueva imagen, te presentamos IQOS ORIGINALS🤩';
$p_preheader =  'Elige tu favorito y únete al cambio ¡hoy mismo!';
$p_yy =  '23';
$p_mm =  '09';
$p_dd =  '01';
$p_name4folder =  'lanzamiento-originals';
$p_name4json =  'launch-originals';
$p_name4folderDCE =  'Lanzamiento Originals';
$p_mailname4DCE =  'Launch Originals';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Lanzamiento Originals';
$p_mailname4FSH =  'Launch Originals';
...
IQOS ORIGINALS
--------------------
y elige tu favorito para<br>continuar el camino <br>del cambio.
--------------------
--------------------
--------------------
Solo con IQOS
