...
$p_id =  '265';
$p_subject =  '¿Y si le dices adiós al olor a humo de cigarro con un nuevo IQOS ORIGINALS DUO? 🤔';
$p_preheader =  'Adquiere tu primer Kit IQOS e inicia el camino del cambio';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '06';
$p_name4folder =  'leads-octubre';
$p_name4json =  'leads-originals-hardsale-duo';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Octubre';
$p_mailname4FSH =  'LEADS Originals Hardsale DUO';
...
/* 
    ...
    CODIGO PARA CUPON 265265XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 265265XX :   %%referral_code%%
...
--------------------
--------------------
Únete al cambio con estilo y estrena un 
--------------------
IQOS ORIGINALS DUO, 
--------------------
con renovado diseño y en 3 diferentes colores.
--------------------
--------------------
--------------------
--------------------
