...
$p_id =  '216';
$p_subject =  'Dos siempre es mejor que uno, con IQOS es igual 👍🏼';
$p_preheader =  'Estrena un segundo IQOS y aprovecha un 20% de descuento';
$p_yy =  '23';
$p_mm =  '09';
$p_dd =  '08';
$p_name4folder =  'ti-sd-septiembre';
$p_name4json =  'second-device-septiembre';
$p_name4folderDCE =  'TI & SD Septiembre';
$p_mailname4DCE =  'Second Device Septiembre';
...
/* 
    ...
    CODIGO PARA CUPON 216216XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 216216XX :   %%referral_code%%
...
--------------------
--------------------
Obtén tu segundo<br>dispositivo <b>IQOS ORIGINALS</b> con
--------------------
