...
$p_id =  '239';
$p_subject =  'Referir puede llenar de estilo tu dispositivo';
$p_preheader =  'Este mes compartir te da más';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '03';
$p_name4folder =  'laus-octubre';
$p_name4json =  'mgm-laus-reward';
$p_name4folderDCE =  'LAUS Octubre';
$p_mailname4DCE =  'MGM LAUS Reward';
...
--------------------
--------------------
Festeja este aniversario con<br> nosotros con más beneficios.
--------------------
Durante el <span style=\"color:#00d1d2;font-weight:700;\">mes de octubre</span>, al referir<br>podrás ganar* uno de estos accesorios<span style=\"font-size:12px;\"><sup>(1)</sup></span>:
--------------------
--------------------
--------------------
Invita a <span style=\"color:#00d1d2;font-weight:700;\">tus amigos<span style=\"font-size:12px;\"><sup>(2)</sup></span></span> a dejar <br>el humo de cigarro atrás. 
--------------------
Te recomendamos hacerlo desde tu celular.
--------------------
--------------------
--------------------
Por cada amigo que use tu Código Único<br>y registre su Kit IQOS en iqos.com obtendrás
--------------------
$300<span style=\"font-size:18px;\"><sup>MXN</sup></span> en beneficios<span style=\"font-size:18px;\"><sup>(3)</sup></span>
--------------------
--------------------
--------------------
*Limitado a un accesorio por usuario.<br>(1) Las Fundas de Silicón IQOS, Tapas IQOS y Carcasas Laterales IQOS están sujetas a disponibilidad de inventario. <br>(2) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina<br>(3) Cada beneficio equivale a $300 MXN en dinero electrónico, no canjeable por dinero en efectivo, válido solo en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y Call Center IQOS. No canjeable por productos de tabaco. Por cada amigo que utilice tu código, obtendrás $300 MXN en beneficios, teniendo la oportunidad de recibir hasta $3,000 MXN en beneficios. Limitado a los primeros 10 amigos referidos que compren y registren su dispositivo con tu código único. Redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com) Cada recompensa deberá ser canjeada en su totalidad en una sola exhibición. Consulta Términos y Condiciones del programa.
--------------------
--------------------
--------------------
--------------------
