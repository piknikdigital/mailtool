...
$p_id =  '288';
$p_subject =  '¡Felicidades! Disfruta tu accesorio gratis por haber referido.🎁';
$p_preheader =  'Encuentra aquí tu código para canjearlo';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '24';
$p_name4folder =  'laus-noviembre';
$p_name4json =  'mgm-upgrade-noviembre';
$p_name4folderDCE =  'LAUS Noviembre';
$p_mailname4DCE =  'MGM Upgrade Noviembre';
...
/* 
    ...
    CODIGO PARA CUPON 288288XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 288288XX :   %%referral_code%%
...
--------------------
--------------------
¡Gracias por haber <br>compartido el cambio!
--------------------
--------------------
--------------------
Disfruta de un accesorio gratis<span style=\"font-size:12px;\"><sup>(2)</sup></span> para <br>personalizar tu dispositivo usando <br>el siguiente código:
--------------------
--------------------
Puedes hacer válido tu  cupón en tiendas IQOS o iqos.com <br>Válido hasta el 31 de diciembre 2023. 
--------------------
--------------------
--------------------
--------------------
...
--------------------
--------------------
(1) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.<br>(2) Las Fundas de Silicón IQOS, Tapas IQOS y Carcasas Laterales IQOS están sujetas a disponibilidad de inventario.<br>*Limitado a un accesorio por usuario.
