...
$p_id =  '286';
$p_subject =  '¿Ya conoces todas las variantes de las unidades de tabaco para calentar?';
$p_preheader =  'Encuéntralas muy cerca de ti y elige tu favorita';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '24';
$p_name4folder =  'laus-noviembre';
$p_name4json =  'heets-laus-noviembre';
$p_name4folderDCE =  'LAUS Noviembre';
$p_mailname4DCE =  'HEETS LAUS Noviembre';
...
/* 
    ...
    CODIGO PARA CUPON 286286XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 286286XX :   %%referral_code%%
...
--------------------
--------------------
NONONONO Encuentra las diferentes variantes de las <br>unidades de tabaco para calentar en tu <br><span style=\"color:#00d1d2;font-weight:700;\">Tienda IQOS</span> más cercana y recuerda <br>solicitar una prueba para encontrar la <br>variante que más se adecue a tus gustos.
--------------------
--------------------
Localiza tu <span style=\"color:#00d1d2;font-weight:700;\">Tienda IQOS</span>  más cercana.<br>No olvides solicitar una prueba, <br>para encontrar tu variante favorita.

--------------------
--------------------
--------------------
Recuerda que las unidades de tabaco para calentar<br> las puedes encontrar en:
--------------------
--------------------
--------------------
--------------------
