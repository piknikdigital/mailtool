...
$p_id =  '291';
$p_subject =  'Este Fin renueva tu IQOS con un increíble descuento sobre precios reducidos';
$p_preheader =  'Aprovecha este fin y obtén 35% de descuento sobre precios reducidos';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '24';
$p_name4folder =  'laus-noviembre';
$p_name4json =  'ti-buen-fin-laus-3';
$p_name4folderDCE =  'LAUS Noviembre';
$p_mailname4DCE =  'TI + Buen Fin LAUS 3';
...
/* 
    ...
    CODIGO PARA CUPON 291291XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 291291XX :   %%referral_code%%
...
--------------------
--------------------
Aprovecha este Fin y renueva tu <br>dispositivo a una gran precio.
--------------------
--------------------
Recibe
--------------------
...
--------------------
sobre precios rebajados<span style=\"font-size:12px;\"><sup>(2)</sup></span><br>al renovar tu dispositivo<br>usando el siguiente código*:
--------------------
--------------------
--------------------
* Limitada al uso de un cupón por usuario.<br>(1) Precio válido hasta el 22 de noviembre de 2023, en la compra de un IQOS ORIGINALS DUO, aplicando el 35% de descuento por "Renueva tu Dispositivo" sobre el precio reducido de $989, únicamente para usuarios registrados con un dispositivo IQOS 2.4 plus en iqos.com. Aplicable en compras realizadas en www.iqos.com, Tiendas IQOS y Call Center IQOS. Sujeto a disponibilidad de inventario. Consulta términos y condiciones.<br>(2) Precio reducido aplicable solo para IQOS 3 Duo y IQOS ORIGINALS Duo, válido del 09 al 21 de noviembre de 2023 en www.iqos.com, Tiendas IQOS, Call Center IQOS y Sanborns seleccionados. Sujeto a disponibilidad de inventario. Consulta Términos y Condiciones.
--------------------
--------------------
--------------------
--------------------
