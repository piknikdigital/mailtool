...
$p_id =  '82v2';
$p_subject =  'Atrévete a conocer una nueva experiencia de tabaco con IQOS 3 DUO 😉';
$p_preheader =  'Aprovecha el descuento especial que tenemos para ti';
$p_yy =  '23';
$p_mm =  '06';
$p_dd =  '22';
$p_name4folder =  'leads-julio';
$p_name4json =  'leads-8-julio';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS julio';
$p_mailname4FSH =  'LEADS 8 Julio';
...
/* 
    ...
    CODIGO PARA CUPON 8282XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Disfruta el tabaco como debe ser, <span style=\"color:#00d1d2;font-weight:700;\">entre amigos<span style=\"font-size:12px;\"><sup>(1)</sup></span>.</span><br><br><span style=\"color:#00d1d2;font-weight:700;\">IQOS</span> potencializa el sabor del tabaco al calentarlo en lugar de quemarlo, <span style=\"color:#00d1d2;font-weight:700;\">elimando la combustión y el molesto olor a cigarro.</span>
--------------------
--------------------
...
--------------------
--------------------
Únete al cambio y <br>adquiere tu primer <br>Kit IQOS con un 
--------------------
¡10% de descuento!<span style=\"font-size:12px;\"><sup>(2)</sup></span>
--------------------
usando el código:
--------------------
--------------------
