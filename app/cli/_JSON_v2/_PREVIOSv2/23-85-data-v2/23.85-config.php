...
$p_id =  '85';
$p_subject =  'Es momento de cambiar a una nueva experiencia de tabaco 🔄';
$p_preheader =  'Estrena un IQOS 3 DUO con 25% de descuento';
$p_yy =  '23';
$p_mm =  '06';
$p_dd =  '30';
$p_name4folder =  'laus-julio';
$p_name4json =  'laus-julio-ti-3';
$p_name4folderDCE =  'LAUS Julio';
$p_mailname4DCE =  'LAUS Julio TI 3';
...
/* 
    ...
    CODIGO PARA CUPON 8585XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Renueva tu dispositivo <br><b>IQOS 2.4 Plus por un IQOS 3 DUO.</b><br><span style=\"color:#00d1d2;font-weight:700;\">Sin humo de cigarro, sin molestar a los demás.</span>
--------------------
--------------------
--------------------
--------------------
Recibe
--------------------
25% de descuento<span style=\"font-size:18px;\"><sup>(2)</sup></span>
--------------------
y llévate el <b>dispositivo <br>más nuevo, fácil y rápido,</b><br>usando el siguiente código:
--------------------
--------------------
--------------------
