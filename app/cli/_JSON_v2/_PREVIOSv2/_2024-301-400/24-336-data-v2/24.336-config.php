...
$p_name4json =  'promocion-zyn';
$p_name4folderDCE =  'ZYN Multicategoria';
$p_mailname4DCE =  'LAUS_IQOS_PromocionZYN_Consideration';
...
/* 
    ...
    CODIGO PARA CUPON 336336XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 336336XX :   %%referral_code%%
