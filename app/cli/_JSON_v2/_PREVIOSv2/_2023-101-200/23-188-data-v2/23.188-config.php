...
$p_id =  '188';
$p_subject =  '¡Te extrañamos, queremos escucharte!';
$p_preheader =  'Cuéntanos tu experiencia y déjanos consentirte con una recompensa';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '16';
$p_name4folder =  'dormant-originals';
$p_name4json =  'dormant-day-100-pp-diagnosis-offer';
$p_name4folderDCE =  'Dormant Originals';
$p_mailname4DCE =  'Dormant Day 100 PP Diagnosis Offer';
...
/* 
    ...
    CODIGO PARA CUPON 188188XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
(1) Para recibir esta recompensa Gratis (Recipiente IQOS Azul Oscuro) debes contestar la pregunta de este correo, con esto recibirás un link por mensaje de texto con tu código. Al dar clic te llevará a la página de iqos.com en donde tendrás que agregar el Recipiente IQOS Azul Oscuro a tu carrito, aplicar el código y así obtener tu regalo. O si lo prefieres, con tu código podrás acudir a tiendas propias IQOS o marcar al *993 desde tu celular para canjearlo. Redimible solo una vez por usuario registrado con cuenta creada en www.iqos.com. Recompensa válida hasta el 31 de diciembre del 2023 o hasta agotar existencias (Limitado a 300 piezas). No es acumulable con otras promociones. Consulta Términos y Condiciones
...
No_tengo_problemas_estoy_contento_con_mi_IQOS
No tengo problemas, estoy contento con mi IQOS


No_encuentro_unidades_de_tabaco_cerca_de_mi
No encuentro unidades de tabaco cerca de mi


Mi_dispositivo_no_funciona_correctamente
Mi dispositivo no funciona correctamente


No_encuentro_el_sabor_de_mi_agrado
No encuentro el sabor de mi agrado
