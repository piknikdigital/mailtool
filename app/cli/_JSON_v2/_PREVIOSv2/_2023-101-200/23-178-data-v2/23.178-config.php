...
$p_name4json =  'welcome-phygital-parque-delta';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Welcome LEADS';
$p_mailname4FSH =  'Welcome PHYGITAL Parque Delta';
...
/* 
    ...
    CODIGO PARA CUPON 178178XX :   %%=v(@voucher_code)=%% 
...
en IQOS en Parque Delta!
--------------------
--------------------
¡Gracias por registrarte <br>en IQOS en <b>Parque Delta!</b><br><br><span style=\"color:#00d1d2;font-weight:700;\">Dile adiós a la combustión.</span> <br>A diferencia del cigarro, <span style=\"color:#00d1d2;font-weight:700;\">IQOS calienta<br> tabaco</span> en lugar de quemarlo.<br><br>Adquiere tu primer Kit IQOS con el <br>siguiente código y recibe un 
--------------------
