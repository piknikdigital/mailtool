...
$p_name4json =  'welcome-code-menosolor';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Welcome LEADS';
$p_mailname4FSH =  'Welcome 1 - MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 175175XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">Dile adiós a la combustión.</span><br>A diferencia del cigarro, <span style=\"color:#00d1d2;font-weight:700;\">IQOS calienta <br>tabaco,</span> no lo quema.<br><br>Adquiere tu primer Kit IQOS con el <br>siguiente código y recibe un 
--------------------
...
--------------------
--------------------
(1) Promoción vigente del 1 de enero de 2023 al 31 de diciembre de 2023. Código de 10% de descuento redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com). Válido únicamente en la compra de tu primer Kit IQOS en la República Mexicana. No es válido en la compra de unidades de tabaco para calentar ni en accesorios IQOS. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Vigencia del código hasta el 31 de diciembre de 20XX. Aplicable en compras realizadas en www.iqos.com, Tiendas IQOS y asesores IQOS. Sujeto a disponibilidad de inventario. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago.
