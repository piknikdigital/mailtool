...
$p_id =  '144';
$p_subject =  '¡Bienvenido a la Comunidad IQOS! 😉';
$p_preheader =  'Gracias por ser parte del cambio';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '10';
$p_name4folder =  'high-priority';
$p_name4json =  'high-conversion-day-1';
$p_name4folderDCE =  'High Priority';
$p_mailname4DCE =  'High Conversion Day 1';
...
--------------------
--------------------
Hoy decidiste dar un giro a tu vida, <br>decidiste decirle adiós al humo de cigarro con IQOS.
--------------------
--------------------
¿Tienes dudas acerca del <br>funcionamiento de tu dispositivo?
--------------------
--------------------
--------------------
--------------------
¿Ya conoces los beneficios que puedes experimentar con IQOS?
--------------------
No deja olor a humo de cigarro <br>en tus manos, cabello o ropa.
--------------------
