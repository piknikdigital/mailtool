...
$p_id =  '141';
$p_subject =  'Cuéntanos tu opinión sobre los beneficios que has recibido';
$p_preheader =  'Queremos conocer tu experiencia';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '08';
$p_name4folder =  'nps-originals';
$p_name4json =  'nps-trade-in';
$p_name4folderDCE =  'NPS Originals';
$p_mailname4DCE =  'NPS Trade In';
...
--------------------
Cuéntanos tu opinión del <span style=\"color:#00d1d2;font-weight:700;\">beneficio <br>que recibiste</span> para adquirir tu <br>último dispositivo.<br><br>Ayúdanos a mejorar.
--------------------
--------------------
--------------------
--------------------
