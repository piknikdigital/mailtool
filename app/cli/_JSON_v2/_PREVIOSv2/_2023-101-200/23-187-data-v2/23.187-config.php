...
$p_id =  '187';
$p_subject =  'Hoy cumples 3 meses libre de humo de cigarro, ¡felicidades! 🎉';
$p_preheader =  'Celebremos juntos el cambio';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '14';
$p_name4folder =  'adopter-originals';
$p_name4json =  'adopter-day-90';
$p_name4folderDCE =  'Adopter Originals';
$p_mailname4DCE =  'Adopter Day 90';
...
===================================================================
--------------------
¡El tiempo se pasó volando!<br>Hoy cumples <span style=\"color:#00d1d2;font-weight:700;\">3 meses</span> de haber decidido usar<br> una mejor alternativa al consumo de tabaco.

¿Cómo te has sentido durante el cambio?


Queremos saber tu experiencia, ayúdanos<br> contestando la siguiente encuesta.
--------------------
Gracias por tu respuesta.<br><span style=\"color:#00d1d2;font-weight:700;\">¡Sigamos avanzando juntos!</span>
--------------------
--------------------
Recuerda que estamos disponibles en nuestros<br> canales de comunicación para resolver tus<br> dudas.
--------------------
--------------------
--------------------
--------------------
