...
$p_id =  '152';
$p_subject =  '¿Cuántos de tus amigos ya son parte de IQOS? (emoji de abrazo)';
$p_preheader =  'Si aún no se han cambiado ¡Invítalos al programa de préstamo IQOS!';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '10';
$p_name4folder =  'high-priority';
$p_name4json =  'high-conversion-day-27';
$p_name4folderDCE =  'High Priority';
$p_mailname4DCE =  'High Conversion Day 27';
...
--------------------
--------------------
Entre amigos<span style=\"font-size:12px;\"><sup>(1)</sup></span> nos entendemos, <br>por eso entre amigos hay códigos. 
--------------------
--------------------
Invítalos a unirse a 
--------------------
...
Te invito a probar IQOS antes de usarlo, únete al Programa de Préstamo IQOS y cumple El Reto. No olvides utilizar mi código %%=v(@voucher_code)=%% para recibir 20% de descuento al comprar tu primer Kit IQOS.
--------------------
--------------------
--------------------
--------------------
