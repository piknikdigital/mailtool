...
$p_id =  '196';
$p_subject =  'Hay cosas que no deberían de quemarse… El tabaco es una de ellas 🔥';
$p_preheader =  'Da clic y conoce lo que necesitas saber sobre IQOS';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '22';
$p_name4folder =  'leads-originals-learn-more';
$p_name4json =  'learn-more-science-1-menos-olor';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Originals Learn More';
$p_mailname4FSH =  'Learn More - Science 1 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 196196XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
¿Ya sabes qué es IQOS?<br><br><span style=\"color:#00d1d2;font-weight:700;\">IQOS es un dispositivo que usa tabaco y lo calienta.</span><br><br>A diferencia de los cigarros, IQOS calienta el <br>tabaco a una temperatura controlada, evitando <br>la combustión y el molesto humo. 
--------------------
--------------------
Hay 4 cosas importantes que debes<br>saber sobre IQOS:
--------------------
--------------------
Al calentar el tabaco y no <br>quemarlo, <span style=\"font-size:22px;color:#00d1d2;font-weight:700;\">IQOS ofrece <br>una experiencia de <br>tabaco renovada.</span>
--------------------
--------------------
...
--------------------
Válido en la compra de <br>tu primer kit IQOS.
--------------------
--------------------
