...
$p_id =  '114';
$p_subject =  'Calentar es mejor que quemar, aquí te decimos por qué 🤩';
$p_preheader =  'Únete al cambio con IQOS y dile adiós al olor a cigarro';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '03';
$p_name4folder =  'leads-agosto';
$p_name4json =  'leads-agosto-2';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Agosto';
$p_mailname4FSH =  'LEADS Agosto 2';
...
/* 
    ...
    CODIGO PARA CUPON 114114XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
IQOS <span style=\"color:#00d1d2;font-weight:700;\">calienta tabaco en lugar de quemarlo</span> por una sencilla razón.
--------------------
--------------------
IQOS produce <span style=\"color:#00d1d2;font-weight:700;\">95% menos <br>sustancias tóxicas*</span> en comparación<br> con los cigarros.
--------------------
...
--------------------
<b>Información importante:</b> No necesariamente equivale a una reducción del riesgo del 95%.<br>IQOS no está libre de riesgos.
--------------------
--------------------
--------------------
--------------------
Cambiarte a IQOS ofrece los siguientes beneficios:
--------------------
--------------------
No deja olor a humo de<br>cigarro.

No produce humo <br>ni humo de segunda mano.

Disminuye las molestias <br>para los que te rodean.
--------------------
--------------------
