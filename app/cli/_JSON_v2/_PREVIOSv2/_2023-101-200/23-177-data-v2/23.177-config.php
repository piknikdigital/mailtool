...
$p_name4json =  'welcome-phygital-viaje';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Welcome LEADS';
$p_mailname4FSH =  'Welcome PHYGITAL Viaje';
...
/* 
    ...
    CODIGO PARA CUPON 177177XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
<b>¡Gracias por registrarte <br>en IQOS en tu viaje!</b><br><br><span style=\"color:#00d1d2;font-weight:700;\">Dile adiós a la combustión.</span> <br>A diferencia del cigarro, <span style=\"color:#00d1d2;font-weight:700;\">IQOS calienta<br> tabaco</span> en lugar de quemarlo.<br><br>Adquiere tu primer Kit IQOS con el <br>siguiente código y recibe un 
--------------------
...
--------------------
--------------------
Tu IQOS te está esperando 
--------------------
Visita tu <span style=\"color:#34303d;font-weight:700;\">Tienda IQOS</span> o <br><span style=\"color:#34303d;font-weight:700;\">IQOS Corner Sanborns</span> seleccionados, <br>más cercanos y únete al cambio.
--------------------
--------------------
--------------------
(1) Promoción vigente del 2 de enero al 31 de diciembre de 2023. Código de 10% de descuento redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com). Válido únicamente en la compra de tu primer Kit IQOS en la República Mexicana. No es válido en la compra de unidades de tabaco para calentar ni en accesorios IQOS. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Vigencia del código hasta el 31 de diciembre de 2023. Aplicable en compras realizadas en compraiqos.com.mx, Tiendas IQOS, IQOS Corners en Sanborns seleccionados y asesores IQOS. Sujeto a disponibilidad de inventario. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago. Aplican Términos y Condiciones.
