...
$p_id =  '116';
$p_subject =  'La oportunidad de cambiar a una nueva experiencia de tabaco está aquí 🔄';
$p_preheader =  'Aprovecha el descuento especial que tenemos para ti';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '03';
$p_name4folder =  'leads-agosto';
$p_name4json =  'leads-hardsale-agosto';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Agosto';
$p_mailname4FSH =  'LEADS HARDSALE Agosto';
...
/* 
    ...
    CODIGO PARA CUPON 116116XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
IQOS calienta tabaco en lugar de quemarlo, <br><span style=\"color:#00d1d2;font-weight:700;\">eliminando el olor a cigarro y disminuyendo <br>las molestias</span> para los que te rodean.
--------------------
--------------------
--------------------
--------------------
--------------------
Estrena tu primer Kit IQOS con 
--------------------
¡10% de <br>descuento!<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
