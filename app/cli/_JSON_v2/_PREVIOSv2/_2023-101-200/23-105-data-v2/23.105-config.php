...
$p_id =  '105';
$p_subject =  'Muy pronto algo nuevo y refrescante llegará a tu tienda más cercana';
$p_preheader =  'Aquí te diremos todo lo que necesitas saber';
$p_yy =  '23';
$p_mm =  '07';
$p_dd =  '26';
$p_name4folder =  'laus-agosto';
$p_name4json =  'teaser-heets-agosto';
$p_name4folderDCE =  'LAUS Agosto';
$p_mailname4DCE =  'Teaser HEETS Agosto';
...
/* 
    ...
    CODIGO PARA CUPON 105105XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Algo nuevo y refrescante llegará muy pronto a tu tienda más cercana.
--------------------
--------------------
--------------------
Encuentra las diferentes variantes <br>de las unidades de tabaco para <br>calentar en uno de los
--------------------
