...
$p_id =  '115';
$p_subject =  'IQOS es una mejor alternativa  que seguir fumando, conócela';
$p_preheader =  'Aprovecha el descuento especial que tenemos para ti';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '03';
$p_name4folder =  'leads-agosto';
$p_name4json =  'leads-agosto-3';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Agosto';
$p_mailname4FSH =  'LEADS Agosto 3';
...
/* 
    ...
    CODIGO PARA CUPON 115115XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
IQOS es un dispositivo de <br><span style=\"color:#00d1d2;font-weight:700;\">calentamiento de tabaco</span> que:
--------------------
--------------------
Dile adiós al humo de cigarro<br> y únete al cambio.>br>Usando el código:
--------------------
obtén tu primer Kit IQOS con
--------------------
10% de<br>descuento<span style=\"font-size:12px;\"><sup>(1)</sup></span>
--------------------
--------------------
--------------------
--------------------
