...
$p_id =  '117';
$p_subject =  '¿Tus amigos ya usan IQOS? Ellos pueden ayudarte a unirte al cambio';
$p_preheader =  'Solo debes pedirles su Código Único y ¡listo!';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '03';
$p_name4folder =  'leads-agosto';
$p_name4json =  'leads-pedir-codigo';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Agosto';
$p_mailname4FSH =  'LEADS Pedir Código';
...
/* 
    ...
    CODIGO PARA CUPON 117117XX :   %%=v(@voucher_code)=%% 
...
--------------------
Entonces ¿qué tal suena pedirle su <br>Código Único a uno de tus amigos?<br>Con el podrás obtener 
--------------------
...
--------------------
--------------------
¿Tienes un amigo que ya usa IQOS?<br>¡Pídele su Código Único!
--------------------
Al usar este Código recibirás<br><span style=\"color:#00d1d2;font-weight:700;\">20% de descuento<span style=\"font-size:12px;\"><sup>(2)</sup></span></span> al comprar tu<br>primer Kit IQOS.
--------------------
Si realizas tu compra usando el <br>Código, tu amigo recibirá<br><span style=\"color:#00d1d2;font-weight:700;\">$300 <span style=\"font-size:12px;\"><sup>MXN</sup></span> en beneficios<span style=\"font-size:12px;\"><sup>(3)</sup></span>.</span>
--------------------
--------------------
--------------------
--------------------
