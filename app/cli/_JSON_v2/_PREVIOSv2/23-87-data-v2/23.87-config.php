...
$p_id =  '87';
$p_subject =  'Un IQOS suena bien, dos suenan mucho mejor ✌🏼';
$p_preheader =  'Recibe 20% de descuento en la compra de tu segundo IQOS';
$p_yy =  '23';
$p_mm =  '06';
$p_dd =  '30';
$p_name4folder =  'laus-julio';
$p_name4json =  'laus-julio-sd-2';
$p_name4folderDCE =  'LAUS Julio';
$p_mailname4DCE =  'LAUS Julio SD 2';
...
/* 
    ...
    CODIGO PARA CUPON 8787XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Estrena un segundo<br>dispositivo IQOS 3 DUO con
--------------------
