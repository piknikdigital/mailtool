...
$p_name4json =  'leads-local-alwayson-iluma-venta-lending-2';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'On Top Mayo';
$p_mailname4FSH =  'LAUS_DCE_HOTSALE_VENTA_CASHBACK1';
...
/* 
    ...
    CODIGO PARA CUPON 161161XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 161161XX :   %%referral_code%%
