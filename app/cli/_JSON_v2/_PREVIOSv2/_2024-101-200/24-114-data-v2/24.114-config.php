...
$p_id =  '114';
$p_subject =  'Cámbiate a IQOS😉';
$p_preheader =  'Una mejor opción que continuar fumando';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '20';
$p_name4folder =  'venta-leads';
$p_name4json =  'iluma-leads-venta-2';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Venta Leads';
$p_mailname4FSH =  'LEADS_2024_ABR_DCE_VENTA2_ILUMA';
...
/* 
    ...
    CODIGO PARA CUPON 114114XX :   %%referral_code%%
...
--------------------
--------------------
Adquiere tu favorito con 
--------------------
00d1d2
15% de descuento<span style=\"font-size:20px;\"><sup>(1)</sup></span> con tu código:
--------------------
--------------------
e27d34
...
--------------------
--------------------
<b>Dile adiós a las molestias</b><br>provocadas por el humo de cigarro y
 --------------------
cámbiate a IQOS.
--------------------
--------------------
Con <b>IQOS ILUMA</b> vive la experiencia mejorada<br> del <b>tabaco calentado sin fuego,</b> sin ceniza y<br> sin humo de cigarro. 
--------------------
--------------------
--------------------
*Información importante: Esto no equivale necesariamente a una reducción del riesgo del 95%. IQOS ILUMA no está libre de riesgos.  *\"95% menos\" representa la reducción promedio de los niveles de las 9 sustancias químicas recomendadas para la reducción del humo del cigarro por la Organización Mundial de la Salud, que no incluyen la nicotina. Consulte Información Importante en iqos.com.
--------------------
--------------------
--------------------
(1) Descuento válido al 30 de junio de 2024. 
--------------------
--------------------
--------------------
--------------------
