...
$p_id =  '128';
$p_subject =  'IQOS ILUMA con un súper descuento 🤩';
$p_preheader =  'El siguiente nivel en tabaco calentado';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '25';
$p_name4folder =  'without-guided-trial';
$p_name4json =  'leads-iluma-without-guided-trial-buy-now-lending';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_2023_Abril_ILUMA_BUY_NOW_LENDING_Without_Guided_Trial';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS ILUMA without Guided Trial';
$p_mailname4FSH =  'LEADS_2023_Abril_ILUMA_BUY_NOW_LENDING_Without_Guided_Trial';
...
/* 
    ...
    CODIGO PARA CUPON 128128XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 128128XX :   %%referral_code%%
...
--------------------
10% de descuento<span style=\"font-size:20px;\"><sup>(1)</sup></span>
--------------------
