...
$p_id =  '106';
$p_subject =  '¿Qué tal suena ganar $3,000 MXN en beneficios? 💰';
$p_preheader =  'Solo debes compartir tu Código Único, da clic para saber más';
$p_yy =  '23';
$p_mm =  '07';
$p_dd =  '26';
$p_name4folder =  'laus-agosto';
$p_name4json =  'mgm-benefits-agosto';
$p_name4folderDCE =  'LAUS Agosto';
$p_mailname4DCE =  'MGM Benefits Agosto';
...
/* 
    ...
    CODIGO PARA CUPON 106106XX :   %%=v(@voucher_code)=%% 
...
Regala 
--------------------
20% de descuento<span style=\"font-size:18px;\"><sup>(3)</sup></span>
--------------------
hasta a 10 amigos<span style=\"font-size:12px;\"><sup>(2)</sup></span> para que puedan<br> adquirir su primer Kit IQOS
--------------------
--------------------
--------------------
...
--------------------
--------------------
Accesorios que puedes<br> obtener con tus beneficios.
--------------------
--------------------
--------------------
--------------------
--------------------
Ten siempre a la mano tu Código Único,<br>lleva el control de tus referidos y beneficios <br>con <span style=\"color:#ffffff;font-weight:700;\">IQOS Wallet.</span><br>Disponible para IOS y Android.
--------------------
