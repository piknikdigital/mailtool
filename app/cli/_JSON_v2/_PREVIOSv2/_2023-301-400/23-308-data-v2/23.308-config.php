...
$p_id =  '308';
$p_subject =  'IQOS no es un vapeador, es una mejor alternativa al consumo de tabaco';
$p_preheader =  'Conoce sus caracterísiticas aquí y empieza el camino del cambio';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '02';
$p_name4folder =  'leads-noviembre';
$p_name4json =  'educ-leads-6';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Noviembre';
$p_mailname4FSH =  'Educ LEADS 6';
...
--------------------
--------------------
A diferencia de los vapeadores, 
--------------------
IQOS calienta tabaco a<br>temperaturas controladas, 
--------------------
entregando una sensación similar al cigarro, <br>sin humo, sin ceniza y con menos olor.<br><br>Conoce aquí algunas de las diferencias:
--------------------
--------------------
--------------------
--------------------
