...
$p_name4json =  'leads-booster-venta-19-sept';
$p_name4folderDCE =  'LEADS September';
$p_mailname4DCE =  'LEADS_DCE_BOOSTER_VENTA_19SEPT';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Septiembre';
$p_mailname4FSH =  'LEADS_LOCAL_BOOSTER_VENTA_19SEPT';
...
/* 
    ...
    CODIGO PARA CUPON 232232XX :   %%referral_code%%
...
--------------------
--------------------
En México, cumplimos 5 años <br>dejando el humo atrás.
--------------------
¿Y tú, por qué no? Únete a la comunidad que<br> sigue creando historias en todo el mundo.
--------------------
--------------------
--------------------
--------------------
