...
$p_id =  '86';
$p_subject =  'Si un IQOS es una mejor experiencia de tabaco, ahora imagina dos 🤩';
$p_preheader =  'Estrena un segundo dispositivo con 20% de descuento';
$p_yy =  '23';
$p_mm =  '06';
$p_dd =  '30';
$p_name4folder =  'laus-julio';
$p_name4json =  'laus-julio-sd-1';
$p_name4folderDCE =  'LAUS Julio';
$p_mailname4DCE =  'LAUS Julio SD 1';
...
/* 
    ...
    CODIGO PARA CUPON 8686XX :   %%=v(@voucher_code)=%% 
