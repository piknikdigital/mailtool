...
$p_id =  '84';
$p_subject =  'Cambiar es mejor entre amigos (fumadores adultos)🤝🏼';
$p_preheader =  'Renueva tu dispositivo por un IQOS 3 DUO y recibe 25% de descuento';
$p_yy =  '23';
$p_mm =  '06';
$p_dd =  '30';
$p_name4folder =  'laus-julio';
$p_name4json =  'laus-julio-ti-2';
$p_name4folderDCE =  'LAUS Julio';
$p_mailname4DCE =  'LAUS Julio TI 2';
...
/* 
    ...
    CODIGO PARA CUPON 8484XX :   %%=v(@voucher_code)=%% 
...
--------------------
al renovar tu <b>IQOS 2.4 Plus<br>por un IQOS 3 DUO nuevo</b><br>usando el siguiente código:
--------------------
--------------------
--------------------
--------------------
Elige cambiar lo bueno por algo mejor.
--------------------
--------------------
--------------------
