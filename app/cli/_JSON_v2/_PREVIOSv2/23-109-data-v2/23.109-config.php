...
$p_id =  '109';
$p_subject =  'Tenemos una actualización disponible para tu IQOS ';
$p_preheader =  'Da clic aquí y descúbrelo 👇🏼';
$p_yy =  '23';
$p_mm =  '07';
$p_dd =  '26';
$p_name4folder =  'laus-agosto';
$p_name4json =  'firmware-agosto';
$p_name4folderDCE =  'LAUS Agosto';
$p_mailname4DCE =  'Firmware Agosto';
...
/* 
    ...
    CODIGO PARA CUPON 109109XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Como cualquier dispositivo electrónico, <br><span style=\"color:#00d1d2;font-weight:700;\">IQOS</span> también necesita actualizar su <br><b>sistema operativo (firmware)</b> para poder<br>ofrecerte la mejor experiencia posible.<br><br>Las ventajas de actualizar el <span style=\"color:#00d1d2;font-weight:700;\">firmware</span> <br>de tu dispositivo son:
--------------------
--------------------
--------------------
...
--------------------
Extienda la vida útil de tu IQOS.
--------------------
--------------------
--------------------
...
--------------------
--------------------
<b>Actualiza</b> sin necesidad <br>de salir de tu hogar.
--------------------
<b>Llámanos</b> al *993 desde <br>tu celular.
--------------------
--------------------
--------------------
--------------------
--------------------
*Este correo electrónico es de carácter informativo de servicio para usuarios con dispositivo IQOS 3 DUO.
--------------------
--------------------
--------------------
--------------------
