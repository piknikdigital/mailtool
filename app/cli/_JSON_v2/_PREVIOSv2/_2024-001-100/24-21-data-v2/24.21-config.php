...
$p_id =  '21';
$p_subject =  'Llegó la hora de compartir IQOS con tus amigos 👫🏻';
$p_preheader =  'Invítalos a vivir grandes momentos';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '08';
$p_name4folder =  'conversion-starter';
$p_name4json =  'iluma-conversion-starter-day13';
$p_name4folderDCE =  'Conversion High Priority Starter';
$p_mailname4DCE =  'IQOS_ILUMA_2024_JOURNEY_CONVERSION_STARTER_DAY13';
...
/* 
    ...
    CODIGO PARA CUPON 2121XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 2121XX :   %%referral_code%%
...
--------------------
--------------------
Comparte el cambio con tus amigos<span style=\"font-size:12px;\"><sup>(1)</sup></span>
y recibe increíbles​
--------------------
