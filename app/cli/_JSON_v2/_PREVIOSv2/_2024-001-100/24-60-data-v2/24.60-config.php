...
$p_id =  '60';
$p_subject =  '¿Qué hace diferente a IQOS?';
$p_preheader =  'Aquí te contamos lo que necesitas saber 🙌🏼';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '08';
$p_name4folder =  'leads-new-device-lending';
$p_name4json =  'leads-hypercare-day-5-lending';
$p_name4folderDCE =  'New Device Lending';
$p_mailname4DCE =  'LEADS_2024_Abril_Hypercare-Day-5_Lending';
...
/* 
    ...
    CODIGO PARA CUPON 6060XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 6060XX :   %%referral_code%%
...
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">¿Aún no encuentras la variante que se<br>adecue a tus preferencias?</span><br>Recuerda que contamos con diferentes <br>opciones con y sin mentol
--------------------
--------------------
--------------------
--------------------
