...
$p_id =  '9';
$p_subject =  'Las mejores experiencias se viven con IQOS 🤩';
$p_preheader =  '👉🏻¡Comparte tu código único ahora!';
$p_yy =  '24';
$p_mm =  '01';
$p_dd =  '26';
$p_name4folder =  'valentines';
$p_name4json =  'valentines-mgm-goodfathers';
$p_name4folderDCE =  'Valentines';
$p_mailname4DCE =  'Valentine\'s - MGM Goodfathers';
...
/* 
    ...
    CODIGO PARA CUPON 99XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 99XX :   %%referral_code%%
...
--------------------
--------------------
Invita a tus amigos a decirle adiós<br> al humo de cigarro.

Regálales 20% de descuento.<span style=\"font-size:18px;\"><sup>(2)</sup></span>
...
--------------------
--------------------
Sigue acumulando y disfruta 
--------------------
de las más de 40 opciones<br> para canjear tus beneficios.​
--------------------
--------------------
--------------------
--------------------
Recuerda que <span style=\"color:#00d1d2;font-weight:700;\">tienes hasta<br>el 15 de febrero</span> para <br>redimir tus beneficios. 
--------------------
--------------------
Si no lograste canjearlos antes del 15 de <br>febrero, ​llámanos y descubre la nueva <br>forma de redimir ​tus nuevos beneficios.
--------------------
--------------------
--------------------
--------------------
