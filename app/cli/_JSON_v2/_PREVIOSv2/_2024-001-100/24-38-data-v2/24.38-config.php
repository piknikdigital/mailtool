...
$p_id =  '38';
$p_subject =  '🤝Comparte la experiencia IQOS';
$p_preheader =  '20% a tus amigos y $300 MXN para ti🥳';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '23';
$p_name4folder =  'on-top-marzo';
$p_name4json =  'laus-mar-on-top-mgm-2';
$p_name4folderDCE =  'LAUS On Top Marzo';
$p_mailname4DCE =  'LAUS_2024_MAR_DCE_ON TOP_MGM2';
...
/* 
    ...
    CODIGO PARA CUPON 3838XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 3838XX :   %%referral_code%%
...
--------------------
--------------------
¡Comparte con tus amigos<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
la experiencia IQOS y disfruta de <b>NUEVOS<br>beneficios electrónicos!</b>
--------------------
--------------------
¿Cómo funciona?​
--------------------
