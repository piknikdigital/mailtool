...
$p_name4json =  'laus-iluma-launch-waiting-list-nacional';
$p_name4folderDCE =  'LAUS Iluma Launch';
$p_mailname4DCE =  'LAUS_2024_MAR_ILUMA_LAUNCH_WAITINGLISTNACIONAL';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LAUS Iluma Launch';
$p_mailname4FSH =  'LAUS_2024_MAR_ILUMA_LAUNCH_WAITINGLISTNACIONAL';
...
/* 
    ...
    CODIGO PARA CUPON 8585XX :   %%referral_code%%
...
--------------------
--------------------
¿Listo para un <br><span style=\"color:#00d1d2;\">nuevo comienzo?​</span>
--------------------
--------------------
¡El siguiente nivel 
en tabaco calentado ya está aquí!
--------------------
--------------------
--------------------
--------------------
(1) Descuento válido hasta el 30 de junio de 2024, únicamente para usuarios IQOS con dispositivos IQOS ORIGINALS, IQOS 2.4 PLUS y IQOS 3 DUO registrados en iqos.com en la compra de su primer kit IQOS ILUMA. Aplica solo una vez por usuario registrado. Sujeto a disponibilidad de inventario. Consulta Términos y Condiciones del programa Trade in.
--------------------
--------------------
--------------------
--------------------
