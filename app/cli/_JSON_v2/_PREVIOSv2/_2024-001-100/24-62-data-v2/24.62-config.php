...
$p_id =  '62';
$p_subject =  '¡Lo lograste! El Programa de Préstamo IQOS ha terminado🎉';
$p_preheader =  'Es hora de tomar una decisión';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '08';
$p_name4folder =  'leads-new-device-lending';
$p_name4json =  'leads-hypercare-day-15-lending';
$p_name4folderDCE =  'New Device Lending';
$p_mailname4DCE =  'LEADS_2024_Abril_Hypercare-Day-15_Lending';
...
/* 
    ...
    CODIGO PARA CUPON 6262XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 6262XX :   %%referral_code%%
...
--------------------
--------------------
El Programa de Préstamo IQOS
--------------------
ha llegado a su fin, pero este es el comienzo de<br><b>una vida libre de olor a humo de cigarro. </b>
--------------------
--------------------
<b>Adquiere tu primer dispositivo a un precio especial</b><br> por haber cumplido exitosamente
--------------------
00d1d2
Programa de Préstamo IQOS
--------------------
Inicia sesión en iqos.com y compra tu dispositivo. 
--------------------
--------------------
--------------------
Si cuentas con un código de referido, también<br> podrás utilizarlo.* 
--------------------
