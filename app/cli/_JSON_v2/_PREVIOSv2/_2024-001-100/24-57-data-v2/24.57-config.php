...
$p_id =  '57';
$p_subject =  'Prueba IQOS durante 14 días 🤩';
$p_preheader =  'Vive la experiencia IQOS, te contamos cómo';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '08';
$p_name4folder =  'leads-new-device-lending';
$p_name4json =  'leads-program-awareness-1-lending';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'New Device Lending';
$p_mailname4FSH =  'LEADS_2024_Feb_Program-Awareness_Lending';
...
/* 
    ...
    CODIGO PARA CUPON 5757XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 5757XX :   %%referral_code%%
...
Prueba IQOS ILUMA
--------------------
desde tu casa durante 14 días por solo
--------------------
¡$1.00 MXN!
--------------------
Vive la experiencia del tabaco calentado y <br> conoce la diferencia entre quemar y calentar.
--------------------
--------------------
--------------------
Devuelve o compra IQOS <br>con un descuento especial.
--------------------
--------------------
--------------------
...
Contáctanos en nuestros canales <br>de comunicación.
--------------------
--------------------
--------------------
--------------------
