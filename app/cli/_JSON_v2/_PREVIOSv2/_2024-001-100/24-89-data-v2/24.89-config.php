...
$p_id =  '89';
$p_subject =  'Regístrate y disfruta de beneficios exclusivos😎';
$p_preheader =  'Conoce el siguiente nivel⬆️ en tabaco calentado';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '19';
$p_name4folder =  'laus-90-dias';
$p_name4json =  'laus-90-dias-mgm-2-iluma';
$p_name4folderDCE =  '90 Dias';
$p_mailname4DCE =  'LAUS_2024_ABR_DCE_-90DIAS_MGM2_ILUMA';
...
/* 
    ...
    CODIGO PARA CUPON 8989XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 8989XX :   %%referral_code%%
...
--------------------
--------------------
¡Comparte tu código y 
--------------------
00d1d2
obtén beneficios exclusivos! 
--------------------
--------------------
Regala 20% de descuento(1) 
a tus amigos(2) y acumula en tu monedero $300MXN(3)  por cada amigo que use tu código único y registre su  Kit IQOS en iqos.com  
--------------------
--------------------
--------------------
--------------------
