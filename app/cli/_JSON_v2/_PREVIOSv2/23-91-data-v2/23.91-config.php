...
$p_id =  '91';
$p_subject =  '¡Prueba IQOS hoy! 14 días de prueba solo para ti';
$p_preheader =  'Probar IQOS antes de comprarlo, es posible.';
$p_yy =  '23';
$p_mm =  '07';
$p_dd =  '14';
$p_name4folder =  'lending-3-duo';
$p_name4json =  'lending-awareness-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Lending 3 DUO';
$p_mailname4FSH =  'LENDING Awareness 1';
...
--------------------
--------------------
¡Vive la experiencia por solo <b>$204 <span style=\"font-size:12px;\"><sup>MXN</sup></span>!</b><br>Prueba <b>IQOS 3 DUO</b> por 14 días y descubre la<br> diferencia entre quemar y calentar el tabaco.
--------------------
--------------------
¡Quiero probarlo! ¿Qué tengo que hacer?
--------------------
--------------------
Da clic en el botón para <b>registrarte.</b>
--------------------
Para completar el registro, <b>recibirás una<br> llamada del Call Center IQOS.</b>
--------------------
¡Listo! <b>Comienza a vivir la experiencia.</b>
--------------------
--------------------
--------------------
Además recibe...
--------------------
Acompañamiento personalizado de <br>un <span style=\"color:#00d1d2;font-weight:700;\">Experto IQOS</span> durante la prueba. <br>Al final, podrás decidir si comprarlo o <br>devolverlo sin ningún compromiso.
--------------------
--------------------
¿Sabías que IQOS no es un vapeador? 
--------------------
A diferencia de los vapeadores,<br> <span style=\"color:#00d1d2;font-weight:700;\">IQOS calienta tabaco</span> (no líquido con nicotina) <br>entregando el sabor del tabaco, sin humo.
--------------------
--------------------
¿Tienes dudas? 
--------------------
...
--------------------
--------------------
*El Programa de Préstamo IQOS Demo está disponible en Tiendas IQOS Antara, Perisur, Santa Fe y IQOS Corners en Sanborns seleccionados: Masaryk, Interlomas, Galerías Insurgentes, Parque Delta, Universidad, Pedregal, Galerías Coapa, Atizapán, Reforma 222 y Satélite. El listado de tiendas podrá cambiar sin previo aviso.<br><br>El Programa de Préstamo IQOS Nuevo está disponible únicamente en Call Center IQOS llamando al 800 1 476769 o al *993 desde tu celular.<br><br>Programa exclusivo para fumadores adultos en la Ciudad de México y área metropolitana. El periodo de prueba del Programa de Préstamo IQOS es de hasta 14 días naturales a partir de la entrega del dispositivo. Al cabo de dicho período, el usuario puede optar por comprar el dispositivo o devolverlo. Sujeto a disponibilidad de inventario. Consulta requisitos y Términos y Condiciones del Programa. Color sujeto a disponibilidad de inventario en tienda y Call Center IQOS.
--------------------
--------------------
--------------------
--------------------
