...
$p_mm              = '07';
$p_dd              = '31';
$p_name4folder     = 'test-html';
$p_name4json       = '1';

$p_name4folderDCE  = 'NA';
$p_mailname4DCE    = 'Test DCE HTML';
$p_customerkey_DCE = 'NA';

$p_name4folderFSH  = 'NA';
$p_mailname4FSH    = 'Test FSH HTML';
...
/* 
    ...
    CODIGO PARA CUPON tst1tst1XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON tst1tst1XX :   %%referral_code%%
