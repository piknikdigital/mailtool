...
$p_id =  '108';
$p_subject =  'Una nueva experiencia de sabor ha llegado';
$p_preheader =  'Encuéntrala en tu punto de venta más cercana';
$p_yy =  '23';
$p_mm =  '07';
$p_dd =  '26';
$p_name4folder =  'laus-agosto';
$p_name4json =  'heets-agosto';
$p_name4folderDCE =  'LAUS Agosto';
$p_mailname4DCE =  'HEETS Agosto';
...
--------------------
--------------------
Algo nuevo y refrescante ha llegado a tu tienda más cercana.<br><br>Visítanos y descúbrela
--------------------
--------------------
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">Visita tu Tienda IQOS</span> y solicita una<br>prueba para conocer la variante<br>que más se adecue a tus gustos.
--------------------
--------------------
--------------------
--------------------
