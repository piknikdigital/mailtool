...
$p_preheader =  '¡Dile adiós al humo!';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '20';
$p_name4folder =  'welcome-iluma';
$p_name4json =  'leads-welcome-1-iluma';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Welcome Iluma';
$p_mailname4FSH =  'LEADS_2024_ENE_WELCOME1_ILUMA';
...
/* 
    ...
    CODIGO PARA CUPON 101101XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 101101XX :   %%referral_code%%
...
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">Dile adiós a la combustión. </span><br>A diferencia del cigarro, <span style=\"color:#00d1d2;font-weight:700;\">IQOS calienta <br>tabaco,</span> no lo quema. <br><br>Adquiere tu primer Kit IQOS con el siguiente<br> código y recibe un
--------------------
¡10% de descuento!<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
--------------------
¿Cuentas con algún código de referidos<span style=\"font-size:12px;\"><sup>(2)</sup></span>?<br><b>¡Utilízalo! Respetaremos tu descuento original.</b>
--------------------
--------------------
--------------------
Solo con IQOS ILUMA
...
--------------------
--------------------
(1) Promoción vigente del 8 de abril al 31 de diciembre de 2024. Código de 10% de descuento redimible solo una vez por usuario registrado (con cuenta creada en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;\" target=\"_blank\">www.iqos.com</a>). Válido únicamente en la compra de tu primer Kit IQOS en la República Mexicana. No es válido en la compra de unidades de tabaco para calentar ni en accesorios IQOS. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Vigencia del código hasta el 31 de diciembre de 2024. Aplicable en compras realizadas en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;\" target=\"_blank\">www.iqos.com</a>, Tiendas IQOS y asesores IQOS. Sujeto a disponibilidad de inventario. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago.​ <br><br>(2) Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en iqos.com, y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y iqos.com. Descuento no válido en productos de tabaco. Vigencia hasta el 31 de diciembre de 2024.​
--------------------
--------------------
--------------------
--------------------
