...
$p_name4json =  'leads-welcome-5-iluma';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Welcome Iluma';
$p_mailname4FSH =  'LEADS_2024_ENE_WELCOME5_ILUMA';
...
/* 
    ...
    CODIGO PARA CUPON 100100XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 100100XX :   %%referral_code%%
...
--------------------
--------------------
¡Gracias por registrarte  en IQOS en <b>Parque Delta! </b> <br>  <br> <span style=\"color:#00d1d2;font-weight:700;\"> Dile adiós a la combustión. </span> <br> A diferencia del cigarro, <span style=\"color:#00d1d2;font-weight:700;\">IQOS calienta tabaco </span> <br> en lugar de quemarlo.  <br>  <br> Adquiere tu primer Kit IQOS con el siguiente código y recibe un
--------------------
¡10% de descuento!<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
¿Cuéntas con algún código de referidos?<br>¡Utilízalo! Respetaremos tu descuento original.
--------------------
--------------------
--------------------
--------------------
¡Corre por tu nuevo IQOS ILUMA!
--------------------
Visita tu tienda IQOS ó IQOS Corner Sanborns 
--------------------
seleccionados, más cercanos y únete al cambio.
--------------------
--------------------
--------------------
--------------------
