...
$p_id =  '200';
$p_subject =  'Estás a un solo paso de cambiar a una mejor alternativa';
$p_preheader =  'Llegó la hora de decirle hola a IQOS';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '22';
$p_name4folder =  'leads-originals-learn-more';
$p_name4json =  'learn-more-try-5-menos-olor';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Originals Learn More';
$p_mailname4FSH =  'Learn More - Try 5 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 200200XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
El momento de decirle adiós al humo<br>y la ceniza de cigarro ha llegado. 
--------------------
¡No lo pienses más y dile hola a un <br>futuro libre de humo!
--------------------
--------------------
--------------------
Recuerda que cuentas con un código de
--------------------
¡10% de descuento!<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
aplicable en la compra de tu primer Kit IQOS.
--------------------
--------------------
--------------------
--------------------
...
--------------------
Visita nuestras Tiendas IQOS<br> físicas o en línea y únete<br>al cambio.
--------------------
Solo con IQOS
--------------------
--------------------
