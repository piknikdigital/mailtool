...
$p_id =  '290';
$p_subject =  'Obtén grandes descuentos este Fin sobre precios reducidos para tus referidos';
$p_preheader =  'Regálales hasta 30% de descuento sobre precios reducidos para su primer Kit IQOS';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '24';
$p_name4folder =  'laus-noviembre';
$p_name4json =  'buen-fin-laus-2';
$p_name4folderDCE =  'LAUS Noviembre';
$p_mailname4DCE =  'Buen Fin LAUS 2';
...
/* 
    ...
    CODIGO PARA CUPON 290290XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 290290XX :   %%referral_code%%
...
--------------------
--------------------
Continúa compartiendo momentos <br>sin humo de cigarro, este Fin renueva tu <br>dispositivo y aprovecha nuestros
--------------------
precios reducidos
--------------------
en Kit IQOS ORIGINALS DUO. 
--------------------
--------------------
--------------------
Invita a <span style=\"color:#00d1d2;font-weight:700;\">tus amigos<span style=\"font-size:12px;\"><sup>(1)</sup></span></span> a <br>dejar el cigarro atrás y regálales
--------------------
30% de descuento<span style=\"font-size:18px;\"><sup>(2)</sup></span><br>sobre precios reducidos<span style=\"font-size:18px;\"><sup>(3)</sup></span>
--------------------
