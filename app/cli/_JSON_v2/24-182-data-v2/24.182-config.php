...
$p_name4json =  'leads-venta-descuento20-iluma-one-dia-18';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_LOCAL_VENTA_DESCUENTO20_ILUMA_ONE_DIA18';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Venta Iluma One';
$p_mailname4FSH =  'LEADS_LOCAL_VENTA_DESCUENTO20_ILUMA_ONE_DIA18';
...
/* 
    ...
    CODIGO PARA CUPON 182182XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 182182XX :   %%referral_code%%
...
--------------------
--------------------
¡Adquiere tu nuevo IQOS ILUMA a un precio especial!​
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">¿Cómo ir al siguiente nivel?​</span><br>Sigue los pasos para un nuevo comienzo:
--------------------
--------------------
--------------------
--------------------
--------------------
​Información importante: Esto no equivale necesariamente a una reducción del riesgo del 95%.
IQOS ILUMA no está libre de riesgos. <br> *“95% menos” representa la reducción promedio de los niveles de las 9 sustancias químicas recomendadas para la reducción del humo del cigarro por la Organización Mundial de la Salud, que no incluyen la nicotina.
