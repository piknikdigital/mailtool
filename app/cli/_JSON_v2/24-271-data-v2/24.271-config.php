...
$p_name4json =  'laus-anuncio-nuevos-precios-5';
$p_name4folderDCE =  'LAUS NOVEMBER';
$p_mailname4DCE =  'LAUS_DCE_ANUNCIO_NUEVOSPRECIOS_5';
...
/* 
    ...
    CODIGO PARA CUPON 271271XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 271271XX :   %%referral_code%%
...
--------------------
--------------------
(1) Los nuevos precios de dispositivos, códigos promocionales y descuentos no aplican en la edición especial de aniversario: IQOS x Steve Aoki.
