...
$p_name4json =  'leads-zyn-monterrey-awareness';
$p_name4folderDCE =  'ZYN LEADS LAUS';
$p_mailname4DCE =  'Leads_ZYN_Monterrey_Awareness';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'ZYN LEADS LAUS';
$p_mailname4FSH =  'Leads_ZYN_Monterrey_Awareness';
...
/* 
    ...
    CODIGO PARA CUPON z13z13XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON z13z13XX :   %%referral_code%%
...
--------------------
--------------------
Localiza Tienda        https://conoce-zyn.com/wp-content/localizador-tiendas.html
