...
$p_id =  '306';
$p_subject =  'IQOS y Aromaria: Una colaboración muy especial✨';
$p_preheader =  '¡Tenemos un regalo para ti!🎁';
$p_yy =  '24';
$p_mm =  '11';
$p_dd =  '23';
$p_name4folder =  'laus-dic';
$p_name4json =  'laus-aromaria-19';
$p_name4folderDCE =  'LAUS December';
$p_mailname4DCE =  'LAUS_DCE_AROMARIA_#19';
...
$bgColor          = "#060d11";    // Don't use "transparent"
...
/* 
    ...
    CODIGO PARA CUPON 306306XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 306306XX :   %%referral_code%%
...
Comprar ahora 	https://www.iqos.com/mx/es/shop/set-de-aros-iqos-iluma.html
Siguenos en instagram	https://www.instagram.com/iqos_mx/
--------------------
--------------------
--------------------
--------------------
(1) Los Kit de Regalo Aromaria no son acumulables​. Disponible sólo en la compra de un Kit IQOS ILUMA y/o IQOS ILUMA PRIME en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;color:white;\" target=\"_blank\">iqos.com</a> y/o Tiendas IQOS. Sujeto a disponibilidad de inventario hasta agotar existencias.<br><br>(2) Set de Aros de regalo exclusivamente para ventas en línea en iqos.com en la compra de un Kit IQOS ILUMA y/o IQOS ILUMA PRIME. Sujeto a disponibilidad de inventario. Hasta agotar existencias.<br><br>(3) Disponible únicamente en Tiendas IQOS en Ciudad de México y área metropolitana para usuarios IQOS registrados. Sujeto a disponibilidad de inventario. Hasta agotar existencias.
--------------------
--------------------
--------------------
--------------------
