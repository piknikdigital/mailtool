...
$p_id =  '305';
$p_subject =  'Es momento de inspirar al cambio.🫰';
$p_preheader =  'Regala un 20% de descuento a tus amigos.🤝';
$p_yy =  '24';
$p_mm =  '11';
$p_dd =  '23';
$p_name4folder =  'laus-dic';
$p_name4json =  'laus-trade-in-mgm-17';
$p_name4folderDCE =  'LAUS December';
$p_mailname4DCE =  'LAUS_DCE_TRADEIN_MGM_#17';
...
/* 
    ...
    CODIGO PARA CUPON 305305XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 305305XX :   %%referral_code%%
