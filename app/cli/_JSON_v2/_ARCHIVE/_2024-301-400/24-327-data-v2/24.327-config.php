...
$p_name4json =  'laus-trade-in-mgm-28';
$p_name4folderDCE =  'LAUS JANUARY';
$p_mailname4DCE =  'LAUS_DCE_TRADEIN_MGM_#28';
...
/* 
    ...
    CODIGO PARA CUPON 327327XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 327327XX :   %%referral_code%%
...
Comparte tu código	https://api.whatsapp.com/send/?text=Te+regalo+20%25+de+descuento+en+la+compra+de+tu+primer+Kit+IQOS+ILUMA.+No+olvides+utilizar+mi+c%C3%B3digo+%25%25referral_code%25%25+al+comprar.&type=custom_url&app_absent=0
Ver más	https://www.recompensasiqos.plandereconocimientos.com/?utm_source=organic&utm_medium=iqos_refiere_un_amigo&utm_campaign=MGM_regards&_gl=1*1qytpmm*_gcl_au*MTk3NDEwMTAwNi4xNzMxMDE3OTI3*_ga*MTMxMDE2ODI3Ni4xNzMxMDE3OTMw*_ga_807WM9RT1H*MTczMzMzMDg3My40OC4xLjE3MzMzMzIzNDYuMC4wLjA.
