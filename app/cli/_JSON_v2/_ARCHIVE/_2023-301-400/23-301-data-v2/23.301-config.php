...
$p_id =  '301';
$p_subject =  'No dejes pasar la oportunidad de ser ORIGINAL';
$p_preheader =  'Estrena un IQOS ORIGINALS con descuentos sobre precios reducidos';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '02';
$p_name4folder =  'leads-noviembre';
$p_name4json =  'buen-fin-leads-3';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Noviembre';
$p_mailname4FSH =  'Buen Fin LEADS 3';
...
/* 
    ...
    CODIGO PARA CUPON 301301XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 301301XX :   %%referral_code%%
...
--------------------
--------------------
Este Fin elige una mejor <br>alternativa que continuar <br>fumando y aprovecha el
--------------------
10% de descuento<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
sobre precios reducidos en la <br>compra de tu primer Kit IQOS <br>usando el siguiente código.
--------------------
--------------------
--------------------
--------------------
