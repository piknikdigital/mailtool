...
$p_id =  '306';
$p_subject =  'IQOS ofrece grandes beneficios, ¿ya sabes cuáles son?';
$p_preheader =  'Descúbrelos aquí';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '02';
$p_name4folder =  'leads-noviembre';
$p_name4json =  'educ-leads-4';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Noviembre';
$p_mailname4FSH =  'Educ LEADS 4';
...
--------------------
--------------------
*Reducciones en niveles de una variedad de sustancias químicas nocivas (excluyendo la nicotina) en comparación con el humo de un cigarrillo de referencia (3R4F).
--------------------
...
--------------------
--------------------
¡Dile adiós al olor a humo de cigarro hoy!<br>Aprovecha el siguiente código y obtén
--------------------
10% de descuento<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
en la compra de tu primer <span style=\"color:#00d1d2;font-weight:700;\">Kit IQOS.</span>
--------------------
--------------------
--------------------
