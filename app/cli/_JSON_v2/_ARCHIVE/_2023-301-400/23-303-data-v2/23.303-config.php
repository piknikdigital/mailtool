...
$p_id =  '303';
$p_subject =  '¿Qué tanto conoces sobre IQOS?';
$p_preheader =  'Todo lo que necesitas saber está aquí';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '02';
$p_name4folder =  'leads-noviembre';
$p_name4json =  'educ-leads-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Noviembre';
$p_mailname4FSH =  'Educ LEADS 1';
...
/* 
    ...
    CODIGO PARA CUPON 303303XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 303303XX :   %%referral_code%%
...
--------------------
--------------------
IQOS es un dispositivo<br>de calentamiento de tabaco.
--------------------
--------------------
--------------------
*Reducciones promedio en niveles de una variedad de sustancias químicas nocivas <br>(excluyendo la nicotina) en comparación con el humo de un cigarrillo de referencia (3R4F).
--------------------
<b>Información importante:</b> No necesariamente equivale a una <br>reducción del riesgo del 95%. IQOS no está libre de riesgos.
--------------------
--------------------
--------------------
--------------------
--------------------
¿Estás listo para unirte al<br><span style=\"color:#00d1d2;font-weight:700;\">cambio con IQOS?</span>
--------------------
Recibe un
--------------------
