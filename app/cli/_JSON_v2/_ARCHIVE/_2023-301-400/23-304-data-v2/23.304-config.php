...
$p_id =  '304';
$p_subject =  'IQOS es un dispositivo de calentamiento de tabaco pero ¿qué beneficios ofrece?';
$p_preheader =  'Conócelos aquí';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '02';
$p_name4folder =  'leads-noviembre';
$p_name4json =  'educ-leads-2';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Noviembre';
$p_mailname4FSH =  'Educ LEADS 2';
...
/* 
    ...
    CODIGO PARA CUPON 304304XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 304304XX :   %%referral_code%%
...
--------------------
--------------------
IQOS <span style=\"color:#00d1d2;font-weight:700;\">calienta tabaco,</span><br>entregando el sabor del tabaco <span style=\"color:#00d1d2;font-weight:700;\">sin humo.</span>
--------------------
--------------------
...
--------------------
Sin  ceniza
IQOS elimina la ceniza <br>manteniendo tus espacios más limpios.
--------------------
--------------------
No afecta la calidad del aire
IQOS no produce humo de segunda <br>mano, disminuyendo las molestias <br>para los que te rodean.
--------------------
--------------------
--------------------
Recibe
...
--------------------
usando el siguiente código al adquirir <br>tu primer <span style=\"color:#00d1d2;font-weight:700;\">Kit IQOS.</span>
--------------------
--------------------
--------------------
--------------------
