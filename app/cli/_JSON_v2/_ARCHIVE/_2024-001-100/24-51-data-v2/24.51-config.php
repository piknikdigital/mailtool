...
$p_id =  '51';
$p_subject =  'Obtén 50% en tu nuevo IQOS ILUMA🙌🏻';
$p_preheader =  '¡Sé el primero en probarlo!🤩';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '28';
$p_name4folder =  'laus-iluma-launch';
$p_name4json =  'laus-iluma-launch-waitinglist-cdmx';
$p_name4folderDCE =  'LAUS Iluma Launch';
$p_mailname4DCE =  'LAUS_2024_MAR_ILUMA_LAUNCH_WAITINGLIST_CDMX';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LAUS Iluma Launch';
$p_mailname4FSH =  'LAUS_2024_MAR_ILUMA_LAUNCH_WAITINGLIST_CDMX';
...
/* 
    ...
    CODIGO PARA CUPON 5151XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 5151XX :   %%referral_code%%
...
--------------------
--------------------
Ven, déjate consentir en:
--------------------
--------------------
--------------------
y <b>vive una experiencia</b> al siguiente nivel,<br><b>solo para ti.</b>
--------------------
--------------------
--------------------
--------------------
