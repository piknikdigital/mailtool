...
$p_id =  '40';
$p_subject =  '¿Tabaco calentado? 🤔';
$p_preheader =  'Prueba la experiencia IQOS😉';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '29';
$p_name4folder =  'leads-on-top-marzo';
$p_name4json =  'leads-mar-on-top-education-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS On Top Marzo';
$p_mailname4FSH =  'LEADS_2024_MAR_DCE_ON TOP_EDUCATION1';
...
/* 
    ...
    CODIGO PARA CUPON 4040XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 4040XX :   %%referral_code%%
...
--------------------
--------------------
¿Sabías qué IQOS calienta tabaco,<br>no lo quema?​
--------------------
Con IQOS disfrutas del<br>sabor del tabaco: ​
--------------------
--------------------
--------------------
--------------------
