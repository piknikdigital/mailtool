...
$p_id =  '6';
$p_subject =  'Comparte tu código y obtén increíbles beneficios 😎';
$p_preheader =  '¡Con IQOS, todos ganan!';
$p_yy =  '24';
$p_mm =  '01';
$p_dd =  '26';
$p_name4folder =  'valentines';
$p_name4json =  'valentines-mgm-20pc-off';
$p_name4folderDCE =  'Valentines';
$p_mailname4DCE =  'Valentine\'s - MGM 20% descuento';
...
/* 
    ...
    CODIGO PARA CUPON 66XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 66XX :   %%referral_code%%
...
--------------------
--------------------
Comparte tu<br>código único y regala
--------------------
20% <span style=\"font-size:18px;\">de</span>
--------------------
descuento<span style=\"font-size:20px;\"><sup>(1)</sup></span>
--------------------
a tus amigos fumadores<br>adultos<span style=\"font-size:12px;\"><sup>(2)</sup></span> en la compra <br>de su primer <b>Kit IQOS.</b>​ ​
--------------------
--------------------
--------------------
