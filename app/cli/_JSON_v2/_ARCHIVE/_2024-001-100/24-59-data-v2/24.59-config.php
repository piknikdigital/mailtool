...
$p_id =  '59';
$p_subject =  '¡Bienvenido al Programa de Préstamo IQOS! 🤩';
$p_preheader =  'Dile hola a una vida libre de humo de cigarro';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '08';
$p_name4folder =  'leads-new-device-lending';
$p_name4json =  'leads-hypercare-day-0-lending';
$p_name4folderDCE =  'New Device Lending';
$p_mailname4DCE =  'LEADS_2024_Abril_Hypercare-Day-0_Lending ';
...
/* 
    ...
    CODIGO PARA CUPON 5959XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 5959XX :   %%referral_code%%
...
--------------------
--------------------
<b>Felicidades por dar el primer paso hacia<br>una vida sin humo de cigarro.</b><br>Durante el programa de préstamos IQOS, estarás<br> acompañado por un experto disponible para ti en todo<br> momento.
--------------------
--------------------
Recuerda, para vivir<br> los <b>beneficios del<br> calentamiento de<br> tabaco plenamente,</b><br> deberás usar solo<br> IQOS durante estos<br> <b>14 días.</b>
--------------------
--------------------
...
--------------------
Llamar a un experto
https://www.iqos.com/mx/es/ayuda/contacto.html
