...
$p_id =  '76';
$p_subject =  'IQOS: Qué piensas de nuestro servicio de entrega🤔';
$p_preheader =  'Te escuchamos📢';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '11';
$p_name4folder =  'nps';
$p_name4json =  'laus-delivery-nps';
$p_name4folderDCE =  'NPS';
$p_mailname4DCE =  'LAUS_2024_Feb_Delivery_NPS';
...
/* 
    ...
    CODIGO PARA CUPON 7676XX :   %%referral_code%%
...
--------------------
--------------------
Ayúdanos a mejorar nuestro<br>Servicio de Entrega. 
--------------------

Cuéntanos tu experiencia recibiendo tu orden,  <br>contestando una breve encuesta.  <br>  <br>Tu opinión nos lleva al siguiente nivel.
--------------------
--------------------
--------------------
--------------------
