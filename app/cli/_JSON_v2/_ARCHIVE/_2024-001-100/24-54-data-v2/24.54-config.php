...
$p_id =  '54';
$p_subject =  'Nuevo IQOS ILUMA🤩';
$p_preheader =  'Te regalamos 20% de descuento ¡Obtenlo hoy! 🛒';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '29';
$p_name4folder =  'leads-iluma-launch';
$p_name4json =  'leads-iluma-launch-waitinglist-nacional';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Iluma Launch';
$p_mailname4FSH =  'LEADS_2024_ABRIL_ILUMA_LAUNCH_WAITINGLIST_NACIONAL';
...
/* 
    ...
    CODIGO PARA CUPON 5353XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 5353XX :   %%referral_code%%
...
Bienvenido al 
e27d34
siguiente nivel en tabaco calentado
--------------------
--------------------
--------------------
Código de descuento
...
--------------------
--------------------
NO USAR:: *Promoción del 20% de descuento válida para la compra de IQOS ILUMA en www.iqos.com, vigente del 07 abril al 04 de mayo de 2024.  <br> <br>IQOS ILUMA&trade; cuenta con la tecnología SMARTCORE&trade; la cual funciona con unidades de tabaco calentado exclusivamente diseñadas para su uso. Para evitar dañar el dispositivo, no deben utilizarse estas unidades de tabaco con otros dispositivos IQOS que no pertenezcan a la gama de productos ILUMA. IQOS ILUMA no es libre de riesgo ya que entrega nicotina, que es adictiva. Uso exclusivo para adultos.
--------------------
--------------------
--------------------
--------------------
