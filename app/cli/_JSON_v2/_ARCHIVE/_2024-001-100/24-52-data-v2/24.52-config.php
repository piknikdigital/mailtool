...
$p_id =  '52';
$p_subject =  '¡IQOS ILUMA YA DISPONIBLE!🤩';
$p_preheader =  'Obténlo con un fabuloso 50% de descuento🛍️🛒';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '28';
$p_name4folder =  'laus-iluma-launch';
$p_name4json =  'laus-iluma-launch-waitinglist-nacional';
$p_name4folderDCE =  'LAUS Iluma Launch';
$p_mailname4DCE =  'LAUS_2024_MAR_ILUMA_LAUNCH_WAITINGLIST_NACIONAL';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LAUS Iluma Launch';
$p_mailname4FSH =  'LAUS_2024_MAR_ILUMA_LAUNCH_WAITINGLIST_NACIONAL';
...
/* 
    ...
    CODIGO PARA CUPON 5252XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 5252XX :   %%referral_code%%
...
--------------------
--------------------
PREVIO_NO__USAR___*Promoción del 50% de descuento válida para la compra de IQOS ILUMA en www.iqos.com, vigente del 07 abril al 04 de mayo de 2024. <br><br>IQOS ILUMA&trade; cuenta con la tecnología SMARTCORE&trade; la cual funciona con unidades de tabaco calentado exclusivamente diseñadas para su uso. Para evitar dañar el dispositivo, no deben utilizarse estas unidades de tabaco con otros dispositivos IQOS que no pertenezcan a la gama de productos ILUMA. IQOS ILUMA no es libre de riesgo ya que entrega nicotina, que es adictiva. Uso exclusivo para adultos.
--------------------
--------------------
--------------------
--------------------
...
--------------------
--------------------
*Descuento válido hasta el 30 de junio de 2024, únicamente para usuarios IQOS con dispositivos IQOS ORIGINALS, IQOS 2.4 PLUS y IQOS 3 DUO registrados en iqos.com en la compra de su primer kit IQOS ILUMA. Aplica solo una vez por usuario registrado. Sujeto a disponibilidad de inventario. Consulta Términos y Condiciones del programa Trade in. <br> <br>IQOS ILUMA™ está diseñado para usarse únicamente con unidades de tabaco SMARTCORE STICKS™. No utilice IQOS ILUMA™ y unidades de tabaco SMARTCORE STICKS™ con generaciones anteriores de IQOS™, ya que esto puede causar daños a su dispositivo. Más información en www.iqos.com. <br> <br>IQOS es un dispositivo electrónico que, al calentar unidades de tabaco, entrega nicotina, la cual es adictiva y no está libre de riesgo. Prohibida su venta a menores de edad. <br> <br>Consulta la página de <a href=\"https://www.iqos.com/mx/es/Noticias/informacion-importante.html\" style=\"text-decoration:underline;\" target=\"_blank\">información importante</a> para obtener más detalles.
--------------------
--------------------
--------------------
--------------------
