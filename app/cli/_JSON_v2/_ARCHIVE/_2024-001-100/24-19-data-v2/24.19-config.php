...
$p_id =  '19';
$p_subject =  '¡Felicidades! Hace una semana le dijiste adiós al humo de cigarro. ';
$p_preheader =  '¡El siguiente nivel te espera! 🙌🏻';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '08';
$p_name4folder =  'conversion-starter';
$p_name4json =  'iluma-conversion-starter-day7';
$p_name4folderDCE =  'Conversion High Priority Starter';
$p_mailname4DCE =  'IQOS_ILUMA_2024_JOURNEY_CONVERSION_STARTER_DAY7';
...
/* 
    ...
    CODIGO PARA CUPON 1919XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 1919XX :   %%referral_code%%
