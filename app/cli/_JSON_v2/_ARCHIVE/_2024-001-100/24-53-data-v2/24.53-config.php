...
$p_id =  '53';
$p_subject =  'Llegó el nuevo IQOS ILUMA🤩';
$p_preheader =  'Tienes 20% de descuento👌🏻 ¡Hazlo tuyo!🛍️🛒';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '29';
$p_name4folder =  'leads-iluma-launch';
$p_name4json =  'leads-iluma-launch-waitinglist-cdmx';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Iluma Launch';
$p_mailname4FSH =  'LEADS_2024_ABRIL_ILUMA_LAUNCH_WAITINGLIST_CDMX';
...
/* 
    ...
    CODIGO PARA CUPON 5454XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 5454XX :   %%referral_code%%
...
--------------------
e27d34
siguiente nivel en tabaco<br> calentado
--------------------
--------------------
--------------------
Compra tu nuevo <span style=\"color:#00d1d2;font-weight:700;\">IQOS ILUMA</span> en tu<br><b>Tienda IQOS favorita</b> y déjate consentir con <b>una sorpresa<span style=\"font-size:12px;\"><sup>(1)</sup></span>. </b>
--------------------
--------------------
Te esperamos en:
--------------------
...
--------------------
--------------------
NO USAR:  ---- 1) Descuento del 20% y una sorpresa exclusiva en tiendas físicas participantes ubicadas dentro de la Ciudad de México y Zona Metropolitana, aplicable en la compra de IQOS ILUMA. <br>Vigencia: del 07 de abril al 04 de mayo de 2024. <br> <br>2) Promoción del 20% de descuento válida para la compra de IQOS ILUMA en www.iqos.com o tiendas físicas participantes ubicadas dentro de la Ciudad de México y Zona Metropolitana. Vigencia del 07 abril al 04 de mayo de 2024. <br> <br>IQOS ILUMA&trade; cuenta con la tecnología SMARTCORE&trade; la cual funciona con unidades de tabaco calentado exclusivamente diseñadas para su uso. Para evitar dañar el dispositivo, no deben utilizarse estas unidades de tabaco con otros dispositivos IQOS que no pertenezcan a la gama de productos ILUMA. IQOS ILUMA no es libre de riesgo ya que entrega nicotina, que es adictiva. Uso exclusivo para adultos.
--------------------
--------------------
--------------------
--------------------
...
https://www.iqos.com/mx/es/Noticias/informacion-importante.html
--------------------
--------------------
