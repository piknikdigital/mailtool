...
$p_name4json =  'laus-venta-trade-in-3';
$p_name4folderDCE =  'LAUS October';
$p_mailname4DCE =  'LAUS_DCE_VENTA_TRADEIN_3';
...
/* 
    ...
    CODIGO PARA CUPON 248248XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 248248XX :   %%referral_code%%
...
--------------------
--------------------
Para nosotros eres un usuario muy <br>especial, por eso te invitamos a <span style=\"color:#00d1d2;font-weight:700;\">renovar tu<br>dispositivo con un descuento único.</span>
--------------------
--------------------
Te mereces una nueva <br>experiencia de tabaco,<br><span style=\"color:#00d1d2;font-weight:700;\">¡cambia a IQOS ILUMA!</span>
--------------------
--------------------
--------------------
Tu Equipo IQOS
