...
$p_name4json =  'laus-mgm-tc-29-julio';
$p_name4folderDCE =  'LAUS JULY';
$p_mailname4DCE =  'LAUS_DCE_MGM_TC_29JULIO';
...
$requiredBlocks = array(
    ...
    "iqos24-center-img",    // 4                                5
    'iqos24-columns',       // 5 xx 6  (20%, 60%, 20%)           6 xx 7  (18%, 64% ,18%)
    "iqos24-center-img",    // 7  cta comparte tu codigo                              8
    
    "iqos24-center-img",    // 8 gif cta canjear mis beneficios
    
    'iqos24-columns',       // 9 10 (50%, 50%) MGM
...
--------------------
--------------------
(1) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.    <br><br>    (2) Descuento del 25% vigente del 01 al 31 de julio de 2025. Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en iqos.com y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y en www.iqos.com
