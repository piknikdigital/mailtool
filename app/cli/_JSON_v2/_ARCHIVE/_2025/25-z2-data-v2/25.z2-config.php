...
$p_dd =  '10';
$p_name4folder =  'zyn';
$p_name4json =  'leads-kit-de-prueba-zyn-nuevo-sabor';
$p_name4folderDCE =  'ZYN Kit de Prueba';
$p_mailname4DCE =  'Leads_ZYN_NuevoSabor_Kitdeprueba';
...
/* 
    ...
    CODIGO PARA CUPON z2z2XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON z2z2XX :   %%referral_code%%
