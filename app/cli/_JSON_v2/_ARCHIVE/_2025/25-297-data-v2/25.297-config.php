...
$p_name4json =  'laus-terea-berrine-13';
$p_name4folderDCE =  'LAUS December';
$p_mailname4DCE =  'LAUS_DCE_TEREA_BERRINE_13';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'NA';
$p_mailname4FSH =  'LAUS_DCE_TEREA_BERRINE_13';
...
$requiredBlocks = array(
    ...
    "iqos24-greeting",      // 
    "iqos24-center-img",    // 2
    "iqos24-center-img",    // 3g   QUIERO PROBARLA
    "iqos24-center-img",    // 4
    "iqos24-center-img",    // 5g
    "iqos24-center-img",    // Localiza una tienda	https://conoce-iqos.com/localizador-tiendas/
    "iqos24-center-img",    // 6
...
--------------------
--------------------
(1) El dispositivo que se entregará podrá variar entre IQOS ILUMA ONE X Steve Aoki e IQOS ILUMA X Steve Aoki, sujeto a disponibilidad de inventario.        <br><br>        (2) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.
--------------------
--------------------
--------------------
--------------------
