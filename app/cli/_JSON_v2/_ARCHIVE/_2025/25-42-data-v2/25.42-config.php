...
$p_name4json =  'cz-verificacion-de-usuario';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'CZ_Verificación de usuario';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'NA';
$p_mailname4FSH =  'CZ_Verificación de usuario';
...
// $TwigTemplate_iqos= "iqos-2024-v1.twig";
...
/* 
    ...
    CODIGO PARA CUPON 4242XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 4242XX :   %%referral_code%%
...
--------------------
--------------------
¡La evolución inicia hoy!
--------------------
Tu cuenta fue<br><span style=\"color:#00d1d2;font-weight:700;\">verificada con éxito.</span>
--------------------
--------------------
¡Ingresa el siguiente código, <b>completa tu <br>registro</b> y comienza a disfrutar de todos <br>los beneficios!​
--------------------
--------------------
--------------------
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">Club Zero,</span> recompensas libres de humo.
--------------------
--------------------
--------------------
--------------------
