...
$p_name4json =  'leads-asesor-personal-11';
$p_name4folderDCE =  'LEADS FEBRUARY';
$p_mailname4DCE =  'LEADS_DCE_ASESOR_PERSONAL_11';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS FEBRUARY';
$p_mailname4FSH =  'LEADS_DCE_ASESOR_PERSONAL_11';
...
/* 
    ...
    CODIGO PARA CUPON 1212XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 1212XX :   %%referral_code%%
...
--------------------
--------------------
<b>Dar el paso hacia una vida sin humo​</b><br>nunca había sido tan fácil.​
--------------------
--------------------
--------------------
El Programa de Asesor Personal IQOS está disponible exclusivamente en la Ciudad de México y área metropolitana. Su disponibilidad puede estar sujeta a cambios y restricciones.
--------------------
--------------------
--------------------
--------------------
