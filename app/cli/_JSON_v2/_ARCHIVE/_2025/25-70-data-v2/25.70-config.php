...
$p_name4json =  'leads-lending-asesor-8';
$p_name4folderDCE =  'LEADS April';
$p_mailname4DCE =  'LEADS_LOCAL_LENDING+ASESOR_8';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Abril';
$p_mailname4FSH =  'LEADS_LOCAL_LENDING+ASESOR_8';
...
/* 
    ...
    CODIGO PARA CUPON 7070XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 7070XX :   %%referral_code%%
