...
$p_dd =  '10';
$p_name4folder =  'zyn';
$p_name4json =  'leads-kit-de-prueba-zyn-alternativa-al-cigarro';
$p_name4folderDCE =  'ZYN Kit de Prueba';
$p_mailname4DCE =  'Leads_ZYN_AlternativaAlCigarro_Kitdeprueba';
...
/* 
    ...
    CODIGO PARA CUPON z3z3XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON z3z3XX :   %%referral_code%%
