...
$p_id =  '204';
$p_subject =  'Hola %%FirstName%%, ¿sabías qué puedes probar IQOS antes de comprarlo?';
$p_preheader =  'Conoce las opciones que tenemos disponibles para ti y podrás experimentar los beneficios de IQOS';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '24';
$p_name4folder =  'leads-originals-try';
$p_name4json =  'try-try-4-menos-olor';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Originals Try';
$p_mailname4FSH =  'Try - Try 4 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 204204XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
<b>IQOS</b> es un innovador dispositivo que utiliza <br><span style=\"color:#00d1d2;font-weight:700;\">Tecnología HeatControl&trade;,</span> la cual <b>calienta el tabaco</b> en<br>lugar de quemarlo, disminuyendo las molestias<br>ocasionadas por el cigarro:
--------------------
--------------------
--------------------
--------------------
Prueba IQOS antes de comprarlo y<br><span style=\"color:#00d1d2;font-weight:700;\">descubre una experiencia de sabor nueva.</span>
--------------------
--------------------
--------------------
--------------------
...
--------------------
IQOS <span style=\"color:#00d1d2;\">calienta tabaco real en lugar de<br> quemarlo</span> por lo que entrega una sensación<br> similar al cigarro, <span style=\"color:#00d1d2;\">sin humo.</span>
--------------------
--------------------
--------------------
--------------------
