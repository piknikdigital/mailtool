...
$p_id =  '299';
$p_subject =  'Este Fin aprovecha los descuentos sobre precios reducidos';
$p_preheader =  'Diseño original a un gran precio';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '02';
$p_name4folder =  'leads-noviembre';
$p_name4json =  'buen-fin-leads-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Noviembre';
$p_mailname4FSH =  'Buen Fin LEADS 1';
...
--------------------
--------------------
Adquiere tu primer Kit IQOS 3 DUO con
--------------------
10% de descuento<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
sobre precios reducidos<span style=\"font-size:12px;\"><sup>(2)</sup></span>.
--------------------
--------------------
--------------------
--------------------
