...
$p_name4json =  'scan-pack-try-2-menos-olor';
$p_name4folderDCE =  'Scan Pack';
$p_mailname4DCE =  'Scan Pack - Try 2 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 295295XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 295295XX :   %%referral_code%%
