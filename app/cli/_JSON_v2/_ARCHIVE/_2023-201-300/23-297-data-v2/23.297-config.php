...
$p_id =  '297';
$p_subject =  'Hola %%=ProperCase(first_name)=%%, ¿sabías qué puedes probar IQOS antes de comprarlo?';
$p_preheader =  'Conoce las opciones que tenemos disponibles para ti y podrás experimentar los beneficios de IQOS';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '26';
$p_name4folder =  'scan-pack';
$p_name4json =  'scan-pack-try-4-menos-olor';
$p_name4folderDCE =  'Scan Pack';
$p_mailname4DCE =  'Scan Pack - Try 4 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 297297XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 297297XX :   %%referral_code%%
