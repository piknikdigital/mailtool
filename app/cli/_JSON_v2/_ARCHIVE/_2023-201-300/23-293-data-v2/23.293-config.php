...
$p_id =  '293';
$p_subject =  'Encuentra tu Tienda IQOS más cercana 🔍';
$p_preheader =  'Descubre todos los servicios y beneficios que tenemos para ti';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '24';
$p_name4folder =  'laus-noviembre';
$p_name4json =  'tiendas-noviembre';
$p_name4folderDCE =  'LAUS Noviembre';
$p_mailname4DCE =  'Tiendas Noviembre';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Tiendas Noviembre';
$p_mailname4FSH =  'Tiendas Noviembre';
...
/* 
    ...
    CODIGO PARA CUPON 293293XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 293293XX :   %%referral_code%%
...
--------------------
--------------------
¡Vive la experiencia IQOS <br>en nuestras Tiendas!
--------------------
Visitanos y recibe la atención que<br>tu y tu IQOS se merecen, además podrás <br>encontrar los <span style=\"font-weight:700;font-size:20px;\">siguientes servicios:</span>
--------------------
--------------------
--------------------
--------------------
