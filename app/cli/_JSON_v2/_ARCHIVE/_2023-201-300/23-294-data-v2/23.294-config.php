...
$p_name4json =  'scan-pack-science-1-menos-olor';
$p_name4folderDCE =  'Scan Pack';
$p_mailname4DCE =  'Scan Pack - Science 1 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 294294XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 294294XX :   %%referral_code%%
