...
$p_name4json =  'fenix-vapes-science-3';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Fénix Vapes';
$p_mailname4FSH =  'Fénix Vapes Science 3';
...
/* 
    ...
    CODIGO PARA CUPON 277277XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 277277XX :   %%referral_code%%
...
--------------------
--------------------
IQOS no es un vapeador, ni un cigarro electrónico.<br><span style=\"color:#00d1d2;font-weight:700;font-size:24px;\">IQOS es un dispositivo<br>de calentamiento de tabaco.</span>
--------------------
--------------------
--------------------
--------------------
