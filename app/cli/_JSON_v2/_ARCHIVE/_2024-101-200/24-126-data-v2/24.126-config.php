...
$p_id =  '126';
$p_subject =  '¡Atrévete a probar IQOS! 🤩';
$p_preheader =  '¡Dile adiós al humo!';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '25';
$p_name4folder =  'without-guided-trial';
$p_name4json =  'leads-iluma-without-guided-trial-ugc-trial-options-reasons-to-try';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_2023_Abril_ILUMA_UGC_Trial_Options_Reasons_to_Try_Without_Guided_Trial';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS ILUMA without Guided Trial';
$p_mailname4FSH =  'LEADS_2023_Abril_ILUMA_UGC_Trial_Options_Reasons_to_Try_Without_Guided_Trial';
...
/* 
    ...
    CODIGO PARA CUPON 126126XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 126126XX :   %%referral_code%%
...
--------------------
--------------------
<b>¿Sabías que IQOS</b> es una mejor<br> alternativa que continuar fumando?
--------------------
00d1d2
Únete al cambio.
--------------------
...
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">Prueba IQOS</span> donde<br> quieras y como quieras.
--------------------
--------------------
--------------------
Visita cualquiera de nuestras <b>Tiendas<br> IQOS</b> o tu <b>tienda Sanborns</b> más cercana y
--------------------
00d1d2
