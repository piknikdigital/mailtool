...
$p_id =  '141';
$p_subject =  'Una celebración del siguiente nivel 🤩';
$p_preheader =  '¿Estás listo?';
$p_yy =  '24';
$p_mm =  '04';
$p_dd =  '08';
$p_name4folder =  'launch-evento';
$p_name4json =  'laus-launch-evento-reminder-1dia-iluma-2';
$p_name4folderDCE =  'LAUNCH EVENTO';
$p_mailname4DCE =  'LAUS_2024_MAR_LAUNCH_EVENTO_REMINDER_-1DIA_ILUMA_V2';
...
/* 
    ...
    CODIGO PARA CUPON 141141XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 141141XX :   %%referral_code%%
...
--------------------
--------------------
¡Quedan solo 24 horas para el gran evento!
--------------------
--------------------
Te compartimos<br>los detalles.
--------------------
--------------------
--------------------
--------------------
--------------------
​
Ven y disfruta de música, cócteles y momentos  <br>únicos. <span style=\"color:#00d1d2;font-weight:700;\">​¡Celebremos juntos</span> el lanzamiento del  <br>siguiente nivel en tabaco calentado! ​ <br>​ <br>¡Regístrate ahora para <span style=\"color:#00d1d2;font-weight:700;\">asegurar tu lugar!</span>
--------------------
--------------------
--------------------
--------------------
