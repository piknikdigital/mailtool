...
$p_id =  '137';
$p_subject =  '¡Únete al cambio! Elije reciclar';
$p_preheader =  'Este es solo el primer paso';
$p_yy =  '24';
$p_mm =  '04';
$p_dd =  '09';
$p_name4folder =  'laus-iluma-adopter';
$p_name4json =  'laus-iluma-adopter-day-65';
$p_name4folderDCE =  'Adopter';
$p_mailname4DCE =  'LAUS_2024_Abril_DAY-65_Adopter';
...
/* 
    ...
    CODIGO PARA CUPON 137137XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 137137XX :   %%referral_code%%
...
--------------------
--------------------
Conocer más	https://www.iqos.com/mx/es/sustentabilidad/reciclar.html
--------------------
--------------------
Conocer más https://www.iqos.com/mx/es/descubrir-tabaco-para-calentar/comprar-dispositivos.html
¡Quiero reciclar! https://www.iqos.com/mx/es/sustentabilidad/reciclar.html
Localiza centro de acopio https://www.iqos.com/mx/es/sustentabilidad/reciclar.html
--------------------
--------------------
--------------------
--------------------
Uniendo fuerzas con Ecofilter, <br><span style=\"color:#00d1d2;font-weight:700;\">transformamos los residuos de las unidades de  <br>tabaco</span> para calentar en pulpa de celulosa,  <br>la cual nos ayuda a crear diferentes objetos  <br>como cuadernos o macetas.
--------------------
--------------------
--------------------
