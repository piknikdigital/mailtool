...
$p_id =  '124';
$p_subject =  'Conoce IQOS ILUMA y dile adiós al cigarro 👋🏼';
$p_preheader =  'Convéncete tú mismo';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '25';
$p_name4folder =  'without-guided-trial';
$p_name4json =  'leads-iluma-without-guided-trial-category-awareness-education';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_2023_Abril_ILUMA_Category_Awareness_Education_Without_Guided_Trial';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS ILUMA without Guided Trial';
$p_mailname4FSH =  'LEADS_2023_Abril_ILUMA_Category_Awareness_Education_Without_Guided_Trial';
...
/* 
    ...
    CODIGO PARA CUPON 124124XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 124124XX :   %%referral_code%%
...
--------------------
--------------------
¿Ya sabes qué es <span style=\"color:#00d1d2;font-weight:700;\">IQOS ILUMA?<br>Es un dispositivo que usa tabaco y lo calienta.</span><br><br>A diferencia de los cigarros, <br><b>IQOS ILUMA</b> calienta el tabaco a una <br>temperatura controlada, <b>evitando la <br>combustión y el molesto humo.</b>
