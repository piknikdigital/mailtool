...
$p_preheader =  'Adquiere tu IQOS ILUMA con precio especial ';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '25';
$p_name4folder =  'leads-guided-trial';
$p_name4json =  'leads-iluma-guided-trial-buy-now-lending';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_2024_Jul_ILUMA_Buy_Now_Lending_Guided_Trial';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Guided Trial';
$p_mailname4FSH =  'LEADS_2023_Abril_ILUMA_Buy_Now_Lending_Guided_Trial';
...
/* 
    ...
    CODIGO PARA CUPON 123123XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 123123XX :   %%referral_code%%
...
--------------------
--------------------
Ha llegado el momento de decir adiós<br>al olor a humo de cigarro. <br><b>Evoluciona al siguiente nivel con IQOS ILUMA.</b>
--------------------
Disfruta 10% de descuento.<span style=\"font-size:20px;\"><sup>(1)</sup></span>
--------------------
--------------------
--------------------
--------------------
