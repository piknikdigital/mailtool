...
$p_id =  '136';
$p_subject =  'Compartir el cambio=grandes recompensas 💖';
$p_preheader =  'Descubre las diferentes recompensas que tenemos para ti';
$p_yy =  '24';
$p_mm =  '04';
$p_dd =  '09';
$p_name4folder =  'laus-iluma-adopter';
$p_name4json =  'laus-iluma-adopter-day-60';
$p_name4folderDCE =  'Adopter';
$p_mailname4DCE =  'LAUS_2024_Abril_DAY-60_Adopter';
...
/* 
    ...
    CODIGO PARA CUPON 136136XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 136136XX :   %%referral_code%%
...
Comparte tu código único https://www.iqos.com/mx/es/ayuda/donde-encuentro-mi-codigo-unico.html
--------------------
--------------------
--------------------
¿Sabías que ahora puedes canjear tus <br>beneficios por Recompensas Digitales? 
--------------------
¡Es muy sencillo!
--------------------
--------------------
<b>No olvides compartir tu Código Único</b> con tus  <br>amigos<span style=\"font-size:12px;\"><sup>(2)</sup></span> que quieran unirse al cambio. <br> <br>Sigue compartiendo y
--------------------
regala 20% de descuento<span style=\"font-size:12px;\"><sup>(3)</sup></span>
--------------------
en su primer Kit IQOS al usuario. 
--------------------
--------------------
--------------------
Envíalo desde tu celular.
--------------------
--------------------
--------------------
...
--------------------
--------------------
(1) Cada recompensa equivale a $300 MXN en dinero electrónico, no canjeable por dinero en efectivo, válido solo en <a href=\"https://recompensasiqos.plandereconocimientos.com\" style=\"text-decoration:underline;\" target=\"_blank\">recompensasiqos.plandereconocimientos.com</a>. Por cada amigo que utilice tu código, obtendrás $300 MXN en beneficios, teniendo la oportunidad de recibir hasta $3,000 MXN en beneficios. Limitado a los primeros 10 amigos referidos que compren y registren su dispositivo con tu código único. Consulta Términos y Condiciones del programa.  <br> <br>(2) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. <br> <br>(3) Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;\" target=\"_blank\">iqos.com</a>, y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y iqos.com.mx. Descuento no válido en productos de tabaco.
