...
$p_id =  '122';
$p_subject =  'Únete al cambio 🤝';
$p_preheader =  'Tenemos un descuento para ti 🤗';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '25';
$p_name4folder =  'leads-guided-trial';
$p_name4json =  'leads-iluma-guided-trial-awareness';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_2024_Jul_ILUMA_Awareness_Guided_Trial';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Guided Trial';
$p_mailname4FSH =  'LEADS_2023_Abril_ILUMA_Awareness_Guided_Trial';
...
/* 
    ...
    CODIGO PARA CUPON 122122XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 122122XX :   %%referral_code%%
...
--------------------
--------------------
El siguiente nivel en tabaco calentado. <br> <b>Adquiere tu IQOS ILUMA con un</b>
--------------------
10% de descuento.<span style=\"font-size:20px;\"><sup>(1)</sup></span>
--------------------
Válido en la compra de tu primer kit IQOS.
--------------------
--------------------
--------------------
--------------------
