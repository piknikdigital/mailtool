...
$p_id =  '83';
$p_subject =  'Conoce con IQOS una nueva experiencia de tabaco 👫🏻';
$p_preheader =  'Recibe 25% de descuento al renovar a un IQOS 3 DUO';
$p_yy =  '23';
$p_mm =  '06';
$p_dd =  '30';
$p_name4folder =  'laus-julio';
$p_name4json =  'laus-julio-ti-1';
$p_name4folderDCE =  'LAUS Julio';
$p_mailname4DCE =  'LAUS Julio TI 1';
...
/* 
    ...
    CODIGO PARA CUPON 8383XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Tú ya sabes que IQOS es una <br>mejor alternativa que continuar fumando, <br>ahora <span style=\"font-size:20px;font-weight:700;\">¿qué tal suena cambiar tu dispositivo</span>
--------------------
IQOS 2.4 Plus por un IQOS 3 Duo nuevo?
--------------------
--------------------
--------------------
--------------------
Obtén
--------------------
25% de<br> descuento<span style=\"font-size:18px;\"><sup>(2)</sup></span>
--------------------
en la compra de un <br>IQOS 3 DUO, <br>el <b>dispositivo más <br>nuevo, fácil y rápido,</b><br>usando el siguiente <br>código:
--------------------
--------------------
--------------------
--------------------
Ten siempre a la mano tu Código Único,<br>lleva el control de tus referidos y beneficios <br>con <span style=\"color:#00d1d2;font-weight:700;\">IQOS Wallet.</span><br><br>Disponible para <b>IOS y Android.</b>
--------------------
--------------------
--------------------
(1) Adultos fumadores.<br>(2) Precio válido hasta el 31 de julio de 2023, en la compra de un IQOS 3 DUO, aplicando el 25% de descuento por \"Renueva tu Dispositivo\" sobre el precio de $989, únicamente para usuarios registrados con un dispositivo IQOS 2.4 Plus en iqos.com. Aplicable en compras realizadas en www.iqos.com, Tiendas IQOS y Call Center IQOS. Sujeto a disponibilidad de inventario. Consulta <a href=\"https://www.iqos.com/mx/es/codigos-de-descuento.html\" style=\"text-decoration:underline;\" target=\"_blank\">Términos y Condiciones.</a>
--------------------
--------------------
--------------------
