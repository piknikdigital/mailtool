...
$p_id =  '171';
$p_subject =  'Un IQOS es increíble, ¿qué tal 2? 🤩';
$p_preheader =  'Aquí te decimos cómo cambiar tu dispositivo o adquirir uno nuevo';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '13';
$p_name4folder =  'hesitator-originals';
$p_name4json =  'hesitator-day-80';
$p_name4folderDCE =  'Hesitator Originals';
$p_mailname4DCE =  'HESITATOR DAY 80';
...
/* 
    ...
    CODIGO PARA CUPON 171171XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Cambiar tu dispositivo o comprar uno <br>adicional es posible.
--------------------
--------------------
--------------------
Recibe
--------------------
25% de descuento<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
al renovar tu <b>IQOS 2.4 Plus por <br>un IQOS ORIGINALS DUO nuevo</b><br>usando el siguiente código:
--------------------
--------------------
--------------------
Si un IQOS es increíble, <br>¡imagina dos! Obtén
--------------------
20% de descuento<span style=\"font-size:12px;\"><sup>(2)</sup></span>
--------------------
al comprar tu segundo dispositivo<br>usando el siguiente código:
--------------------
--------------------
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">¿Tienes dudas?</span><br><br> Contáctanos en cualquiera de <br>nuestros canales de comunicación.
--------------------
--------------------
--------------------
--------------------
--------------------
--------------------
(1) Precio válido hasta el 31 de diciembre de 2023, en la compra de un IQOS 3 DUO, aplicando el 25% de descuento por \"Renueva tu Dispositivo\" sobre el precio de $989, únicamente para usuarios registrados con un dispositivo IQOS 2.4 plus en iqos.com. Aplicable en compras realizadas en www.iqos.com, Tiendas IQOS y Call Center IQOS. Sujeto a disponibilidad de inventario. Consulta términos y condiciones.<br>(2) Código \"MINUEVOIQOS\" equivalente a un 20% de descuento, válido hasta el 31 de diciembre de 2023 en la compra de un Kit IQOS 3 DUO en www.iqos.com, Tiendas IQOS, Call Center IQOS y IQOS Corners en Sanborns. Limitado a un Kit IQOS 3 DUO por usuario registrado con un dispositivo IQOS 3 DUO en iqos.com. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Consulta Términos y Condiciones.
--------------------
--------------------
--------------------
--------------------
