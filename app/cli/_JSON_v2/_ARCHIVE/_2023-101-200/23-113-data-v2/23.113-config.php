...
$p_id =  '113';
$p_subject =  '¿Conoces los beneficios de IQOS? 🤔';
$p_preheader =  'Esta información es para ti';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '03';
$p_name4folder =  'leads-agosto';
$p_name4json =  'leads-agosto-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Leads Agosto';
$p_mailname4FSH =  'LEADS Agosto 1';
...
/* 
    ...
    CODIGO PARA CUPON 113113XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
IQOS es un <span style=\"color:#00d1d2;font-weight:700;\">dispositivo<br>de calentamiento de tabaco</span><br>que ofrece los siguiente beneficios:
--------------------
--------------------
--------------------
...
¡Únete al<br>cambio! 
--------------------
Adquiere tu primer <br>Kit IQOS usando el <br>siguiente código<br>y recibe un 
--------------------
...
--------------------
--------------------
(1) Código \"MENOSOLOR\" equivalente a un 10% de descuento sobre precio vigente, válido del 1 de enero al 31 de diciembre de 2023 en la compra de tu primer Kit IQOS 3 DUO en www.iqos.com, Tiendas IQOS y Call Center IQOS. No aplica en IQOS Corners en Sanborns. Redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com). El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago. Solo para fumadores adultos o usuarios de otros productos con nicotina. Consulte Términos y Condiciones.
--------------------
--------------------
--------------------
--------------------
