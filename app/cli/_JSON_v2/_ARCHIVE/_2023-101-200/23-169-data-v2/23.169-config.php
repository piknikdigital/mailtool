...
$p_id =  '169';
$p_subject =  'Dale un toque especial a tu IQOS y personalízalo ✨';
$p_preheader =  'El cambio viene lleno de color';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '13';
$p_name4folder =  'hesitator-originals';
$p_name4json =  'hesitator-day-65';
$p_name4folderDCE =  'Hesitator Originals';
$p_mailname4DCE =  'HESITATOR DAY 65';
...
--------------------
Dale a tu <span style=\"color:#00d1d2;font-weight:700;\">IQOS ORIGINALS DUO</span> su propio estilo <br>con la gama de Tapas, Carcasa Laterales y <br>Fundas de silicón de la más alta calidad que <br>tenemos disponibles para ti.
--------------------
--------------------
¿Ya tienes beneficios?<br>Redímelos aquí.
--------------------
--------------------
Recuerda que puedes obtener hasta 
--------------------
$3,000 MXN en beneficios<span style=\"font-size:12px;\"><sup>(1)</sup></span>
--------------------
para personalizar tu dispositivo<br>compartiendo tu Código Único <br>con tus amigos.
--------------------
--------------------
--------------------
--------------------
Encuentra tu <span style=\"font-size:22px;font-weight:700;\">Tienda IQOS</span> más cercana<br>y obtén el mejor servicio para tu dispositivo.<br><br>La atención que te mereces más cerca de ti.
--------------------
--------------------
