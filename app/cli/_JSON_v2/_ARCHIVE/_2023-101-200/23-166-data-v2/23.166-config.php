...
$p_id =  '166';
$p_subject =  'Aquí te decimos dónde encontrar las unidades de tabaco para calentar 📍';
$p_preheader =  'Estamos muy cerca de ti';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '13';
$p_name4folder =  'hesitator-originals';
$p_name4json =  'hesitator-day-35';
$p_name4folderDCE =  'Hesitator Originals';
$p_mailname4DCE =  'HESITATOR DAY 35';
...
/* 
    ...
    CODIGO PARA CUPON 166166XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Encuentra tus <br>unidades de tabaco para calentar en:
--------------------
--------------------
--------------------
Tiendas de conveniencia
--------------------
Disponibles en toda la República Mexicana
--------------------
--------------------
--------------------
--------------------
--------------------
¿Aún no encuentras cuál <br>es tu variante favorita? 
--------------------
Visita tu tienda IQOS más cercana <br>y llámanos desde tu celular al <span style=\"color:#ffffff;font-size:22px;font-weight:700;\">*993 </span><br>para que las conozcas.
--------------------
--------------------
...
--------------------
--------------------
Si tienes dudas, nuestros Expertos IQOS están<br>listos para ayudarte a resolverlas. ¡Contáctanos!
--------------------
--------------------
--------------------
--------------------
