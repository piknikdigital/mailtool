...
$p_id =  '197';
$p_subject =  'Ya escuchaste que IQOS calienta tabaco pero ¿aún no sabes cómo funciona? ¡Esto es para ti!';
$p_preheader =  'Aquí encontrarás las respuestas a todas tus dudas';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '22';
$p_name4folder =  'leads-originals-learn-more';
$p_name4json =  'learn-more-science-2-menos-olor';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Originals Learn More';
$p_mailname4FSH =  'Learn More - Science 2 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 197197XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Saca el Holder del Cargador.
--------------------
Inserta una unidad de tabaco para calentar.
--------------------
Presiona el botón del Holder hasta que <br>vibre y parpadee.
--------------------
Cuando las luces queden encendidas y vibre<br> nuevamente, el tabaco estará en su punto y <br>listo para usarse.
--------------------
--------------------
--------------------
...
--------------------
--------------------
No deja olor a humo de cigarro en <br>tus manos, cabello o ropa.
--------------------
Al no haber combustión, <br>no hay ceniza.
--------------------
Elimina el humo de cigarro, <br>generando menos molestias a los demás.
--------------------
--------------------
--------------------
--------------------
