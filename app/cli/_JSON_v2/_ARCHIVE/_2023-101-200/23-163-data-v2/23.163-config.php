...
$p_id =  '163';
$p_subject =  '¿Cómo te fue con el Programa de Préstamo IQOS?';
$p_preheader =  'Ayúdanos a seguir mejorando';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '14';
$p_name4folder =  'lending-originals';
$p_name4json =  'lending-churn-survey';
$p_name4folderDCE =  'Lending Originals';
$p_mailname4DCE =  'LENDING Churn Survey';
...
--------------------
--------------------
Cuéntanos tu experiencia<br>con el Programa de Préstamo:<br><span style=\"color:#00d1d2;font-weight:700;\">IQOS El Reto</span>
--------------------
Queremos conocer más acerca de tu<br> experiencia durante los últimos 14 días.

¿Cómo te fue con el dispositivo IQOS?
--------------------
--------------------


No_me_gusto_el_sabor
No me gustó el sabor

El_olor_no_me_agrado
El olor no me agradó

Las_unidades_de_tabaco_para_calentar_tienen_una_duracion_diferente_a_los_cigarros
Las unidades de tabaco para calentar tienen una duración diferente a los cigarros

Tuve_dificultades_con_el_uso_del_dispositivo
Tuve dificultades con el uso del dispositivo

La_experiencia_con_el_servicio_no_fue_satisfactoria
La experiencia con el servicio no fue satisfactoria

La_limpieza_del_dispositivo_fue_complicada
La limpieza del dispositivo fue complicada

El_precio_no_es_accesible
El precio no es accesible

Deberia_haber_más_opciones_de_pago
Debería haber más opciones de pago
