...
$p_id =  '194';
$p_subject =  '¡Ya eres parte del cambio con IQOS!';
$p_preheader =  'Queremos saber cómo vives los beneficios';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '16';
$p_name4folder =  'dormant-originals';
$p_name4json =  'dormant-conversion-check';
$p_name4folderDCE =  'Dormant Originals';
$p_mailname4DCE =  'Dormant Conversion Check';
...
/* 
    ...
    CODIGO PARA CUPON 194194XX :   %%=v(@voucher_code)=%% 
...
Uso_IQOS_tanto_como_cigarros_pero_fumo_mas_cigarros_con_mayor_frecuencia
Uso IQOS tanto como cigarros pero fumo más cigarros con mayor frecuencia.

Solo_fumo_cigarros
Solo fumo cigarros.

Ya_no_fumo_ni_consumo_IQOS
Ya no fumo ni consumo IQOS.
