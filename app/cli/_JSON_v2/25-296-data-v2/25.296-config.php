...
$p_name4json =  'laus-mgm10-8';
$p_name4folderDCE =  'LAUS January';
$p_mailname4DCE =  'LAUS_DCE_MGM10_8';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'NA';
$p_mailname4FSH =  'LAUS_DCE_MGM10_8';
...
$requiredBlocks = array(
    ...
    'iqos24-columns-img-xxxxx-img',         //  6, referralcode, 7 (30%, 40%, 30%)
                            // 6
                            // 7
    'iqos24-img-sharemycode',// 8          //  IMG con MSG WA: "Te regalo 25% de descuento en la compra de tu primer Kit IQOS ILUMA, exclusivo en iqos.com. No olvides utilizar mi código %%referral_code%% al comprar."
    'iqos24-spacer',
...
--------------------
--------------------
(1) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.        <br><br>        (2) El dispositivo que se entregará podrá variar entre IQOS ILUMA ONE X Steve Aoki e IQOS ILUMA X Steve Aoki, sujeto a disponibilidad de inventario.        <br><br>        (3) Amazon Echo Show 5 G3 Asistente de Voz 5.5\" inalámbrico, WiFi, Bluetooth, Blanco, sujeto a disponibilidad de inventario.        <br><br>        (4) iPad 11a generación 128 GB en plata, sujeto a disponibilidad de inventario.
