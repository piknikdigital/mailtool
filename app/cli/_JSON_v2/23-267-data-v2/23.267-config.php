...
$p_id =  '267';
$p_subject =  '¿Ya escuchasta hablar del nuevo IQOS ORIGINAL ONE?';
$p_preheader =  'Estrena el dispositivo más nuevo de IQOS con 10% de descuento';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '06';
$p_name4folder =  'leads-octubre';
$p_name4json =  'leads-originals-hardsale-one-2';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Octubre';
$p_mailname4FSH =  'LEADS Originals Hardsale ONE 2';
...
/* 
    ...
    CODIGO PARA CUPON 267267XX :   %%referral_code%%
...
IQOS ORIGINALS 
--------------------
que ofrece hasta 20 usos con una sola carga.<br><br>Con un diseño compacto y portatil, 
--------------------
IQOS ORIGINALS ONE
--------------------
llegó en 4 diferentes colores para<br>acompañarte en tu camino al cambio.
--------------------
--------------------
--------------------
--------------------
