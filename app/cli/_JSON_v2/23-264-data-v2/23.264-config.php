...
$p_id =  '264';
$p_subject =  'Te regalamos un IQOS ORIGINALS 🎁';
$p_preheader =  'Refiere y Renueva tu dispositivo';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '06';
$p_name4folder =  'laus-octubre';
$p_name4json =  'ti-mgm';
$p_name4folderDCE =  'LAUS Octubre';
$p_mailname4DCE =  'TI + MGM';
...
/* 
    ...
    CODIGO PARA CUPON 264264XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 264264XX :   %%referral_code%%
...
--------------------
--------------------
Renovar tu IQOS nunca<br>fue tan fácil.

Por tiempo limitado:<br>Refiere minímo a <b>2 amigos fumadores <br>adultos</b> para conocer IQOS, si eligen <br>comprar su dispositivo... 
--------------------
--------------------
--------------------
Tus amigos fumadores  adultos obtendrán
--------------------
30% de descuento<span style=\"font-size:18px;\"><sup>(3)</sup></span>
--------------------
...
¿Te gustaría que te llamemos para <br>obtener esta promoción? 
...
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">Cambiar a IQOS</span><br>es mejor entre amigos<span style=\"font-size:12px;\"><sup>(1)</sup></span>.
--------------------
--------------------
--------------------
--------------------
--------------------
(1) Solo para fumadores adultos<br>(2) Promoción únicamente para usuarios registrados con un dispositivo IQOS 2.4 PLUS o IQOS 3 MULTI. Vigencia del 24 de Octubre al 30 de Noviembre de 2023 solo en Ciudad de México y área metropolitana, aplicable solo una vez por usuario, no acumulable con otras promociones y/o cupones. Para que la promoción sea válida, el usuario IQOS deberá de aceptar la promoción y referir por lo menos a dos adultos fumadores, que éstos realicen una compra y registren su dispositivo. El usuario IQOS que acepte la promoción, por esta ocasión recibirá un dispositivo IQOS ORIGINALS sin costo, en lugar del beneficio equivalente a $300 MXN del Programa de Referidos. Los dispositivos de obsequio están sujetos a disponibilidad de inventario. Promoción válida únicamente a través del Call Center IQOS. Limitado a un dispositivo IQOS ORIGINALS por usuario. Promoción no transferible, exclusiva para usuarios que hayan recibido este correo. <br>(3) Descuento únicamente para adultos fumadores sin compras o dispositivos previamente vinculados a una cuenta. Válido en la compra y registro del primer dispositivo de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en iqos.com. Descuento válido únicamente a través del Call Center IQOS y solo si el usuario IQOS acepta la promoción previamente descrita.
