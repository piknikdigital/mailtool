...
$p_id =  '103';
$p_subject =  'Comparte la experiencia IQOS con tus amigos 👫🏻👫🏻';
$p_preheader =  'Regálales un descuento para su IQOS y tú obtén hasta 3,000 MXN en beneficios';
$p_yy =  '23';
$p_mm =  '07';
$p_dd =  '17';
$p_name4folder =  'mgm-benefits';
$p_name4json =  'mgm-benefits-julio';
$p_name4folderDCE =  'MGM Julio';
$p_mailname4DCE =  'MGM Benefits Julio';
...
/* 
    ...
    CODIGO PARA CUPON 103103XX :   %%=v(@voucher_code)=%% 
...
--------------------
a 10 amigos para la compra de su<br>primer Kit IQOS y podrás obtener hasta 
--------------------
$3,000 <span style=\"font-size:18px;\"><sup>MXN</sup></span> en beneficios<span style=\"font-size:18px;\"><sup>(3)</sup></span>.
--------------------
--------------------
--------------------
...
--------------------
--------------------
Además con tus beneficios podrías llevarte:
--------------------
diferentes combinaciones<br> de accesorios para tu IQOS.
--------------------
--------------------
--------------------
--------------------
--------------------
Ten siempre a la mano tu Código Único,<br>lleva el control de tus referidos y beneficios<br>con <span style=\"color:#ffffff;font-weight:700;\">IQOS Wallet.</span><br><br>Disponible para IOS y Android.
--------------------
--------------------
--------------------
--------------------
