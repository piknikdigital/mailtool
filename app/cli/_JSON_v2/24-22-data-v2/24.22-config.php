...
$p_id =  '22';
$p_subject =  'Una experiencia de tabaco mejorada te espera';
$p_preheader =  'Conoce los increíbles beneficios de IQOS';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '08';
$p_name4folder =  'conversion-starter';
$p_name4json =  'iluma-conversion-starter-day16';
$p_name4folderDCE =  'Conversion High Priority Starter';
$p_mailname4DCE =  'IQOS_ILUMA_2024_JOURNEY_CONVERSION_STARTER_DAY16';
...
/* 
    ...
    CODIGO PARA CUPON 2222XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 2222XX :   %%referral_code%%
...
--------------------
--------------------
¡Estás evolucionando al siguiente nivel!<br><br><span style=\"color:#00d1d2;font-weight:700;\">¿Sabías que si cambias completamente a IQOS podrías no regresar a fumar cigarros*?</span>

--------------------
Estamos aquí para apoyarte, recuerda que nuestros canales de comunicación están disponibles para ti.
