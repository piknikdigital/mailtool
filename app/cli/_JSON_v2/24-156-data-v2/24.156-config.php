...
$p_name4json =  'laus-always-on-invitacion-mitikah';
$p_name4folderDCE =  'MGM Trade In';
$p_mailname4DCE =  'LAUS_DCE_ALWAYSON_INVITACIÓNMITIKAH';
...
/* 
    ...
    CODIGO PARA CUPON 156156XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 156156XX :   %%referral_code%%
...
--------------------
--------------------
¡Festejemos<br>a Mamá!​
--------------------
Vivan una experiencia que<br><b>los llevará al siguiente nivel</b> con IQOS y 
--------------------
--------------------
--------------------
ec6d02
