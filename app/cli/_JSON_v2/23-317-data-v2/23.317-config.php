...
$p_id =  '317';
$p_subject =  'Disfruta esta temporada libre de olor a humo de cigarro';
$p_preheader =  'Regálate el cambio con IQOS 🎁';
$p_yy =  '23';
$p_mm =  '12';
$p_dd =  '01';
$p_name4folder =  'leads-eoy-2023';
$p_name4json =  'leads-eoy-3';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'EOY2023';
$p_mailname4FSH =  'LEADS EOY 3';
...
/* 
    ...
    CODIGO PARA CUPON 317317XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 317317XX :   %%referral_code%%
...
--------------------
--------------------
Disfruta de estas fechas junto a tus seres queridos sin las molestias provocadas por el humo de cigarro.
--------------------
--------------------
--------------------
Con el 
...
--------------------
recibe un IQOS en préstamo <br>para experimentar los beneficios <br>del calentamiento de tabaco <br><b>durante 14 días.</b>
--------------------
--------------------
--------------------
Cambiate a IQOS y obtén
--------------------
