...
$p_id =  '316';
$p_subject =  'El regalo del cambio llegó con precios reducidos';
$p_preheader =  'Cambia a IQOS este fin de año';
$p_yy =  '23';
$p_mm =  '12';
$p_dd =  '01';
$p_name4folder =  'leads-eoy-2023';
$p_name4json =  'leads-eoy-2';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'EOY2023';
$p_mailname4FSH =  'LEADS EOY 2';
...
/* 
    ...
    CODIGO PARA CUPON 316316XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 316316XX :   %%referral_code%%
...
e2bf85
--------------------
En estas fechas tan especiales, que el humo de cigarro no sea uno de tus invitados.
--------------------
--------------------
--------------------
¿Sabía que puedes probar <br>IQOS antes de comprarlo? 
--------------------
Solicita un IQOS en préstamo durante <br>14 días con el <span style=\"color:#e2bf85;font-weight:700;\">Programa de Préstamo IQOS<span style=\"font-size:12px;\"><sup>(1)</sup></span>.</span>
--------------------
--------------------
--------------------
Aprovecha el
...
--------------------
sobre precios reducidos*<br>En la compra de tu <br>primer Kit IQOS usando <br>el siguiente código.
--------------------
--------------------
--------------------
