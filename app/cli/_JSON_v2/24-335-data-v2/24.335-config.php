...
$p_name4json =  'leads-venta-qcommerce-30';
$p_name4folderDCE =  'LEADS JANUARY';
$p_mailname4DCE =  'LEADS_DCE/LOCAL_VENTA_QCOMMERCE_#30';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Enero';
$p_mailname4FSH =  'LEADS_DCE/LOCAL_VENTA_QCOMMERCE_#30';
...
/* 
    ...
    CODIGO PARA CUPON 335335XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 335335XX :   %%referral_code%%
...
--------------------
--------------------
<b>Este</b> año descubre todos
--------------------
los beneficios de una vida libre de humo.
--------------------
--------------------
--------------------
--------------------
