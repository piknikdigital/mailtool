...
$p_id =  '2';
$p_subject =  'Evoluciona al siguiente nivel 🙌🏻​';
$p_preheader =  'Experiencia de tabaco mejorada';
$p_yy =  '24';
$p_mm =  '01';
$p_dd =  '15';
$p_name4folder =  'iluma-conversion';
$p_name4json =  'registration-confirmation';
$p_name4folderDCE =  'Iluma Conversion';
$p_mailname4DCE =  'Registration Confirmation';
...
/* 
    ...
    CODIGO PARA CUPON 22XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 22XX :   %%referral_code%%
...
--------------------
--------------------
¡Muchas gracias por contactarnos<br>y por tu interés en IQOS!<br><br>Estás a punto de vivir una experiencia de<br> tabaco mejorada y sin complicaciones.
--------------------
--------------------
--------------------
Soporte
--------------------
Ayuda personalizada en todo <br>momento.
--------------------
--------------------
Beneficios Exclusivos
--------------------
Obtén grandes beneficios refiriendo a <br>tus amigos<span style=\"font-size:12px;\"><sup>(1)</sup></span>.
--------------------
--------------------
Prueba IQOS a tu manera
--------------------
Comparte la experiencia, tus amigos <br>pueden probar IQOS antes de <br>comprarlo.
--------------------
--------------------
--------------------
--------------------
...
--------------------
--------------------
(1) Consulta Términos y Condiciones del programa en iqos.com<br>IQOS ILUMA&trade; cuenta con la tecnología SMARTCORE&trade; la cual funciona con unidades de tabaco calentado exclusivamente diseñadas para su uso. Para evitar dañar el dispositivo, nodeben utilizarse estas unidades de tabaco con otros dispositivos IQOS que no pertenezcan a la gama de productos ILUMA. IQOS ILUMA no es libre de riesgo ya que entrega nicotina, que es adictiva. Uso exclusivo para adultos.
--------------------
--------------------
--------------------
--------------------
