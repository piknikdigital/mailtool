...
$p_mm =  '10';
$p_dd =  '14';
$p_name4folder =  'fenix-precio';
$p_name4json =  'fenix-welcome';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Fénix Precio';
$p_mailname4FSH =  'Fénix Welcome';
...
/* 
    ...
    CODIGO PARA CUPON 269269XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 269269XX :   %%referral_code%%
...
--------------------
--------------------
Gracias por atreverte a probar IQOS.
--------------------
Si ya estás listo, recuerda que puedes <br>adquirir tu primer Kit IQOS con el <br>siguiente código y recibir un 
--------------------
¡10% de descuento!<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
--------------------
¿Cuéntas con algún código de referidos?<br>¡Utilízalo y recibe <span style=\"font-weight:700;font-size:20px;\">30% de descuento<span style=\"font-size:12px;\"><sup>(2)</sup></span>!</span>
--------------------
--------------------
¡Estamos aquí <br>para ayudarte!
--------------------
Contáctanos al <span style=\"font-size:22px;font-weight:700;\">*993</span> desde<br>tu celular o visítanos en<br>Tiendas IQOS y responderemos <br>todas tus dudas.
--------------------
--------------------
Solo con IQOS
--------------------
(1) Promoción vigente del 1 de enero de 2023 al 31 de marzo de 2024. Código de 10% de descuento redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com). Válido únicamente en la compra de tu primer Kit IQOS en la República Mexicana. No es válido en la compra de unidades de tabaco para calentar ni en accesorios IQOS. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Vigencia del código hasta el 31 de marzo de 2024. Aplicable en compras realizadas en www.iqos.com, Tiendas IQOS y asesores IQOS. Sujeto a disponibilidad de inventario. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago.<br>(2) Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en iqos.com, y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y compraiqos.com.mx. Descuento no válido en productos de tabaco. Vigencia hasta el 31 de marzo del 2024.
--------------------
--------------------
--------------------
--------------------
