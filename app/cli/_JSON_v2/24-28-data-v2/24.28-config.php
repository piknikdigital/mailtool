...
$p_name4json =  'iluma-conversion-password';
$p_name4folderDCE =  'Conversion High Priority Starter';
$p_mailname4DCE =  'IQOS_ILUMA_2024_JOURNEY_CONVERSION_PASSWORD';
...
/* 
    ...
    CODIGO PARA CUPON 2828XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 2828XX :   %%referral_code%%
