...
$p_id =  '287';
$p_subject =  'Obtén hasta $3,000 MXN en beneficios refiriendo a tus amigos 💵';
$p_preheader =  '¿La mejor parte? Ellos reciben ¡30% de descuento en su primer Kit IQOS!';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '24';
$p_name4folder =  'laus-noviembre';
$p_name4json =  'mgm-booster-noviembre';
$p_name4folderDCE =  'LAUS Noviembre';
$p_mailname4DCE =  'MGM Booster Noviembre';
...
/* 
    ...
    CODIGO PARA CUPON 287287XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 287287XX :   %%referral_code%%
...
--------------------
--------------------
¡Invítalos a decirle adiós al olor a humo de cigarro!<br>Compárteles tu Código Único y regálales
--------------------
30% de descuento<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
en lugar del <b>20% habitual,</b> en la compra<br>de su primer Kit IQOS.
--------------------
--------------------
Te recomendamos hacerlo desde tu celular.
--------------------
--------------------
Con tu Código Único tus amigos podrán adquirir 
--------------------
IQOS ORIGINALS ONE, 
--------------------
el dispositivo todo en uno, ahora más <br>compacto y portátil.
--------------------
--------------------
--------------------
Te recomendamos hacerlo desde tu celular.
...
--------------------
--------------------
Comparte tu Código Único y/o guárdalo en <br>tu <span style=\"color:#ffffff;font-weight:700;\">IQOS Wallet</span> para tenerlo siempre a la mano<br>Disponible para <b>IOS y Android.</b>
--------------------
--------------------
--------------------
