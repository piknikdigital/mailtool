...
$p_id =  '153';
$p_subject =  '¡Felicidades! Hoy cumples 30 días sin humo en tu vida 🥳';
$p_preheader =  'Sigamos avanzando en el camino del cambio';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '10';
$p_name4folder =  'high-priority';
$p_name4json =  'high-conversion-day-30';
$p_name4folderDCE =  'High Priority';
$p_mailname4DCE =  'High Conversion Day 30';
...
/* 
    ...
    CODIGO PARA CUPON 153153XX :   %%=v(@voucher_code)=%% 
...
--------------------
Hoy cumples <span style=\"color:#00d1d2;font-weight:700;\">30 días</span> usando IQOS y esto es solo el principio de una vida sin las molestias del olor a humo de cigarro.<br><br>Ayúdanos a conocer tu experiencia contestando la siguiente encuesta.
--------------------
--------------------
--------------------
--------------------
--------------------
<b>¡Gracias!</b><br>Tus respuestas nos ayudarán para apoyarte de una mejor manera en tu camino al cambio.<br><br><span style=\"color:#00d1d2;font-weight:700;\">¡Sigamos avanzando juntos!</span>
--------------------
