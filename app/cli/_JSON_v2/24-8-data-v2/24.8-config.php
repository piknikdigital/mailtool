...
$p_id =  '8';
$p_subject =  '¡Sorpresa! 🎁 IQOS te regala hasta $3000MXN en beneficios';
$p_preheader =  'Comparte tu código y regala 20% de descuento 🙌🏻';
$p_yy =  '24';
$p_mm =  '01';
$p_dd =  '26';
$p_name4folder =  'valentines';
$p_name4json =  'valentines-mgm-beneficios-2';
$p_name4folderDCE =  'Valentines';
$p_mailname4DCE =  'Valentines - MGM Beneficios 2';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Valentines';
$p_mailname4FSH =  'Valentines - MGM Beneficios 2';
...
/* 
    ...
    CODIGO PARA CUPON 88XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 88XX :   %%referral_code%%
...
--------------------
--------------------
¡Te presentamos el nuevo<br> <b>programa de lealtad!​</b>
--------------------
--------------------
--------------------
Recuerda enviarlo desde tu celular.
--------------------
--------------------
#ElijoIQOS
--------------------
...
--------------------
--------------------
¿Control total de tus referidos y beneficios?​<br><span style=\"color:#00d1d2;font-weight:700;\">¡Descarga!</span>
