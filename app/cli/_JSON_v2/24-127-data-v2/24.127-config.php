...
$p_id =  '127';
$p_subject =  '¡Descubre un poco más de IQOS ILUMA!🤩';
$p_preheader =  'Dile adiós al humo del cigarro';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '25';
$p_name4folder =  'without-guided-trial';
$p_name4json =  'leads-iluma-without-guided-trial-awareness-of-iqos-ecosystem';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'LEADS_2023_Abril_ILUMA_Awareness_of_IQOS_Ecosystem_Without_Guided_Trial';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS ILUMA without Guided Trial';
$p_mailname4FSH =  'LEADS_2023_Abril_ILUMA_Awareness_of_IQOS_Ecosystem_Without_Guided_Trial';
...
/* 
    ...
    CODIGO PARA CUPON 127127XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 127127XX :   %%referral_code%%
...
--------------------
--------------------
Un favor, me ayudas con un ajuste en el correo: LEADS_2023_Abril_ILUMA_Awareness_of_IQOS_Ecosystem_Without_Guided_Trial

correo: 
https://paginum.com/email/pmi2403/pmi-240325-without-guided-trial/pmi-240325-ID24.127-leads-iluma-wi...

Cambiar CTA del botón. "Pruébalo" por este link 
