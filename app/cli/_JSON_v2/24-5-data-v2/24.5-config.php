...
$p_id =  '5';
$p_subject =  '¿Sin olor a cigarro? Se puede con IQOS 😉​';
$p_preheader =  'IQOS ORIGINALS DUO llegó para salvarte 👌🏻​';
$p_yy =  '24';
$p_mm =  '01';
$p_dd =  '23';
$p_name4folder =  'valentines';
$p_name4json =  'valentines-venta-iqos-originals-duo-1';
$p_name4folderDCE =  'Valentines';
$p_mailname4DCE =  'Valentine\'s - Venta IQOS Originals 1';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Valentines';
$p_mailname4FSH =  'Valentine\'s - Venta IQOS Originals 1';
...
/* 
    ...
    CODIGO PARA CUPON 55XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 55XX :   %%referral_code%%
...
--------------------
--------------------
<b>Obtén 2 usos consecutivos*<br>sin recargar</b> con nuestro <br>dispositivo más elegante.​
--------------------
*2 usos consecutivos no significa más usos <br>sino menos tiempo de espera entre usos.​
--------------------
--------------------
--------------------
--------------------
