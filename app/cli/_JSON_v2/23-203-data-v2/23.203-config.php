...
$p_id =  '203';
$p_subject =  'Experimenta los beneficios de IQOS antes de comprarlo, ¿quieres saber cómo?';
$p_preheader =  'Conoce las opciones que tenemos para ti dando clic aquí';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '24';
$p_name4folder =  'leads-originals-try';
$p_name4json =  'try-try-3-menos-olor';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Originals Try';
$p_mailname4FSH =  'Try - Try 3 MENOSOLOR';
...
/* 
    ...
    CODIGO PARA CUPON 203203XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
IQOS, a diferencia de un vapeador,<br><b>es un dispositivo de calentamiento de tabaco,</b><br>conoce aquí las diferencias:
--------------------
--------------------
¿Estás en <br>Ciudad de México? 
--------------------
Haz la prueba y vive 14 días* <br>sin humo, sin cenizas y con <br>menos molestias para<br>la gente a tu alrededor.
--------------------
--------------------
Vive la experiencia IQOS <br>durante 14 días*, pruébalo<br> y decide si quieres<br> comprarlo.
--------------------
--------------------
--------------------
¿Vives en el interior de la <br>República Mexicana? 
--------------------
Llámanos y solicita una <br><b>Demostración Virtual</b> de producto.
--------------------
--------------------
--------------------
--------------------
