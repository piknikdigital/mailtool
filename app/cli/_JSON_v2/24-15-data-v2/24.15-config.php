...
$p_name4json =  'iluma-conversion-starter-day0-one';
$p_name4folderDCE =  'Conversion High Priority Starter';
$p_mailname4DCE =  'IQOS_ILUMA_2024_JOURNEY_CONVERSION_STARTER_DAY0_ONE';
...
/* 
    ...
    CODIGO PARA CUPON 1515XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 1515XX :   %%referral_code%%
