...
$p_id =  '315';
$p_subject =  'El regalo del cambio te está esperando';
$p_preheader =  'No dejes pasar la oportunidad de cambiar y aprovecha los precios reducidos';
$p_yy =  '23';
$p_mm =  '12';
$p_dd =  '01';
$p_name4folder =  'leads-eoy-2023';
$p_name4json =  'leads-eoy-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'EOY2023';
$p_mailname4FSH =  'LEADS EOY 1';
...
/* 
    ...
    CODIGO PARA CUPON 315315XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 315315XX :   %%referral_code%%
