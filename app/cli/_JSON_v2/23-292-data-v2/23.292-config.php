...
$p_id =  '292';
$p_subject =  'Regala 30% de descuento sobre precios reducidos a tus referidos este Fin';
$p_preheader =  'Comparte el cambio y disfruta de grandes beneficios';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '24';
$p_name4folder =  'laus-noviembre';
$p_name4json =  'buen-fin-laus-4';
$p_name4folderDCE =  'LAUS Noviembre';
$p_mailname4DCE =  'Buen Fin LAUS 4';
...
/* 
    ...
    CODIGO PARA CUPON 292292XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 292292XX :   %%referral_code%%
...
--------------------
--------------------
Este Fin, aprovecha los
--------------------
precios reducidos<span style=\"font-size:18px;\"><sup>(1)</sup></span> 
--------------------
y adquiere un nuevo Kit IQOS ORIGINALS DUO.
--------------------
--------------------
--------------------
No olvides que puede regalar a tus amigos<span style=\"font-size:12px;\"><sup>(2)</sup></span>
--------------------
30% de descuento<span style=\"font-size:18px;\"><sup>(3)</sup></span>
--------------------
sobre precios reducidos<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
...
--------------------
--------------------
(1) Precio reducido aplicable solo para IQOS 3 Duo y IQOS ORIGINALS Duo, válido del 09 al 21 de noviembre de 2023 en www.iqos.com, Tiendas IQOS, Call Center IQOS y Sanborns seleccionados. Sujeto a disponibilidad de inventario. Consulta Términos y Condiciones.<br>(2) Adultos fumadores.<br>(3) Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en iqos.com, y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y compraiqos.com.mx. Descuento no válido en productos de tabaco. Vigencia hasta el 31 de diciembre del 2023.
--------------------
--------------------
--------------------
--------------------
