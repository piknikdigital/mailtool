...
$p_name4json =  'laus-buenfin-mgm-18';
$p_name4folderDCE =  'LAUS November';
$p_mailname4DCE =  'LAUS_DCE_BUENFIN_MGM_18';
...
$requiredBlocks = array(
    ...
    "iqos24-center-img",    // 2
    "iqos24-columns-img-greeting-img", // 3 (5%), saludo, 4(5%)
    "iqos24-center-img",    // 5
    "iqos24-center-img",    // 6g
    "iqos24-center-img",    // 7
    "iqos24-center-img",    // 8
    "iqos24-columns-img-referralcode-img", // 9, XXXX, 10    
    "iqos24-center-img",    // 11
    "iqos24-center-img",    // 12   Compartir mi código	este codigo da 30% de descuento

// Compartir mi código	este codigo da 30% de descuento
...
$requiredBlocks__IQOS = array(
    ...
    'iqos24-columns-img-xxxxx-img',      //  Columna 1: IMG1 margen izq, Columna 2:  CODIGO-MGM-249X, columna 3: margen derecho  
...
--------------------
--------------------
(1) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.    <br><br>    (2) Descuento válido del 14 de noviembre al 01 de diciembre de 2025. Obtén 30% de descuento en la compra de dispositivos IQOS ILUMA y 25% de descuento en IQOS ILUMA ONE.​ Promoción válida en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido.​ Para hacer válido el descuento, el amigo referido deberá registrarse y registrar su dispositivo en iqos.com, y aplicar la promoción en <a href=\"https://www.iqos.com/mx/es/home.html\" style=\"text-decoration:underline;color:white;\" target=\"_blank\">www.iqos.com</a>. 
