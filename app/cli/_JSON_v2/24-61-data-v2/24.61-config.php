...
$p_id =  '61';
$p_subject =  'Únete al camino del cambio 🤝';
$p_preheader =  '¿Estás listo para decirle adiós al humo?';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '08';
$p_name4folder =  'leads-new-device-lending';
$p_name4json =  'leads-hypercare-day-10-lending';
$p_name4folderDCE =  'New Device Lending';
$p_mailname4DCE =  'LEADS_2024_Abril_Hypercare-Day-10_Lending';
...
/* 
    ...
    CODIGO PARA CUPON 6161XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 6161XX :   %%referral_code%%
...
--------------------
--------------------
El momento de tomar una decisión se acerca. <br>Si ya estás convencido con los beneficios...  

--------------------
¡Compra hoy mismo tu IQOS<br> con el 15% de descuento!
--------------------
--------------------
--------------------
Aprovecha al máximo los últimos días de Programa de <br>Préstamo , y recuerda por qué <b>IQOS en una mejor <br>opción que continuar fumando cigarro.</b>
--------------------
--------------------
--------------------
--------------------
