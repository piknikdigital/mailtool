...
$p_id =  '183';
$p_subject =  'Tu IQOS, tu estilo. 💖';
$p_preheader =  'Personalízalo y dale ese toque especial';
$p_yy =  '23';
$p_mm =  '08';
$p_dd =  '14';
$p_name4folder =  'adopter-originals';
$p_name4json =  'adopter-day-60';
$p_name4folderDCE =  'Adopter Originals';
$p_mailname4DCE =  'Adopter Day 60';
...
/* 
    ...
    CODIGO PARA CUPON 183183XX :   %%=v(@voucher_code)=%% 
...
===================================================================
--------------------
¿Sabías que tienes muchas opciones <br>para canjear tus beneficios? 
--------------------
Recuerda que puedes invitar a tus amigos<span style=\"font-size:12px;\"><sup>(1)</sup></span><br>a dejar el olor a humo de cigarro atrás regalándoles<br><span style=\"color:#00d1d2;font-weight:700;\">20% de descuento<span style=\"font-size:12px;\"><sup>(2)</sup></span></span><br>en la compra de su primer Kit IQOS. 
--------------------
--------------------
Por cada amigo<span style=\"font-size:12px;\"><sup>(1)</sup></span> que utilice tu Código Único<br> y vincule su  dispositivo, obtendrás
--------------------
$300 <span style=\"font-size:12px;\"><sup>MXN</sup></span> en beneficios<span style=\"font-size:12px;\"><sup>(3)</sup></span>.
--------------------
Encuentra tu <span style=\"font-size:24px;font-weight:700;\">Tienda IQOS</span> más<br>cercana y visítanos, podrás canjear tus<br>beneficios por increíbles accesorios<br> para personalizar tu dispositivo.
--------------------
--------------------
--------------------
--------------------
