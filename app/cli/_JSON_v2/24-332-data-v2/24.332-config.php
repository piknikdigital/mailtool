...
$p_name4json =  'leads-tienda-guided-21';
$p_name4folderDCE =  'LEADS JANUARY';
$p_mailname4DCE =  'LEADS_LOCAL_TIENDA_GUIDED_#21';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS Enero';
$p_mailname4FSH =  'LEADS_LOCAL_TIENDA_GUIDED_#21';
...
/* 
    ...
    CODIGO PARA CUPON 332332XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 332332XX :   %%referral_code%%
...
--------------------
--------------------
Este 2025, da el primer paso hacia un cambio.<br><b>¿Por qué esperar?​</b>
--------------------
Vive, prueba y experimenta<br> <span style=\"color:#00d1d2;font-weight:700;\">IQOS</span> en tienda.​
--------------------
--------------------
--------------------
--------------------
Visítanos y <b>descubre cómo IQOS</b> puede<br>transformar tu forma de disfrutar el tabaco.
--------------------
Sin humo, sin ceniza y sin olor a cigarro.
--------------------
--------------------
--------------------
¿Por qué elegir IQOS ILUMA?​
--------------------
--------------------
--------------------
--------------------
