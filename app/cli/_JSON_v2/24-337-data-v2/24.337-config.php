...
$p_mm =  '12';
$p_dd =  '23';
$p_name4folder =  'zyn-multicategoria';
$p_name4json =  'beneficios-zyn';
$p_name4folderDCE =  'ZYN Multicategoria';
$p_mailname4DCE =  'LAUS_IQOS_BeneficiosZYN_Consideration';
...
/* 
    ...
    CODIGO PARA CUPON 337337XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 337337XX :   %%referral_code%%
