...
$p_name4json =  'cz-redencion';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'CZ_Redención';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'NA';
$p_mailname4FSH =  'CZ_Redención';
...
/* 
    ...
    CODIGO PARA CUPON 4747XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 4747XX :   %%referral_code%%
...
--------------------
--------------------
El canje de tus puntos 
fue exitoso
--------------------
--------------------
¿Todo listo para disfrutar de<br> <span style=\"color:#00d1d2;font-weight:700;\">recompensas exclusivas?​</span>
--------------------
--------------------
--------------------
--------------------
...
[NÚMERO DE PUNTOS]
--------------------
Continúa acumulando puntos para poder ganar 
--------------------
[NOMBRE DEL PREMIO]
--------------------
--------------------
...
--------------------
--------------------
Además, solo por este mes, al ser miembro<br>de <span style=\"color:#00d1d2;font-weight:700;font-style: italic;\">Club Zero,</span> podrás acumular hasta
--------------------
%%CANTIDAD DE PUNTOS%%
--------------------
