...
$p_id =  '323';
$p_subject =  '2024 será tu mejor año con IQOS';
$p_preheader =  'Dile adiós al olor a humo de cigarro y aprovecha los precios reducidos';
$p_yy =  '23';
$p_mm =  '12';
$p_dd =  '05';
$p_name4folder =  'leads-nyr-2024';
$p_name4json =  'nyr-2024-leads-3';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS NYR 2024';
$p_mailname4FSH =  'NYR 2024 LEADS 3';
...
/* 
    ...
    CODIGO PARA CUPON 323323XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 323323XX :   %%referral_code%%
...
--------------------
--------------------
<b>Este año ¡cumple tus propósitos!</b><br><br>Dile adiós al olor a humo de cigarro con <b>IQOS,</b> <br>una mejor alternativa al consumo de tabaco ,<br>libre de combustión.
--------------------
--------------------
--------------------
¡Vive la experiencia IQOS <br>antes de comprarlo! 
--------------------
Solicita un IQOS en préstamo durante <br>14 días y disfruta los beneficios del <br>calentamiento del tabaco con el 
--------------------
...
--------------------
--------------------
Únete al camino del cambio aprovechando el
--------------------
10% de descuento<span style=\"font-size:18px;\"><sup>(2)</sup></span><br>sobre precios reducidos<span style=\"font-size:18px;\"><sup>(3)</sup></span>
--------------------
