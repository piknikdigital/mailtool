...
$p_id =  '310';
$p_subject =  '¡Últimos días para regalar el cambio!';
$p_preheader =  'Regala a tus amigos 30% de descuento sobre precios reducidos, ¡no dejes pasar esta oportunidad!';
$p_yy =  '23';
$p_mm =  '11';
$p_dd =  '29';
$p_name4folder =  'eoy-2023';
$p_name4json =  'laus-eoy-3';
$p_name4folderDCE =  'EoY 2023';
$p_mailname4DCE =  'LAUS EOY 3';
...
/* 
    ...
    CODIGO PARA CUPON 310310XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 310310XX :   %%referral_code%%
...
--------------------
--------------------
No dejes pasar la oportunidad de regalar el
--------------------
30% de descuento<span style=\"font-size:18px;\"><sup>(1)</sup></span>
--------------------
a tus amigos<span style=\"font-size:12px;\"><sup>(2)</sup></span> esta temporada para que<br> disfruten libres de humo de cigarro.
--------------------
--------------------
...
--------------------
--------------------
* Precio reducido aplicable solo para IQOS 3 DUO y IQOS ORIGINALS DUO, válido del 08 al 23 de diciembre de 2023 en www.iqos.com, Tiendas IQOS, Call Center IQOS y Sanborns seleccionados. Sujeto a disponibilidad de inventario. Consulta Términos y Condiciones.<br>(1) Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en iqos.com, y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y www.iqos.com. Descuento no válido en productos de tabaco. Vigencia hasta el 31 de diciembre del 2023.<br>(2) Adultos fumadores.
--------------------
--------------------
--------------------
--------------------
