...
$p_id =  '64';
$p_subject =  '¡Gracias por participar en el Programa de Préstamo IQOS!';
$p_preheader =  'Te pedimos realizar tu pago a la brevedad 😉';
$p_yy =  '24';
$p_mm =  '03';
$p_dd =  '06';
$p_name4folder =  'leads-new-device-lending';
$p_name4json =  'leads-pre-dunning-2-lending';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'New Device Lending';
$p_mailname4FSH =  'LEADS_2024_Abril_Pre-Dunning-2_Lending';
...
/* 
    ...
    CODIGO PARA CUPON 6464XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 6464XX :   %%referral_code%%
