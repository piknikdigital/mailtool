...
$p_name4json =  'leads-6-julio';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'LEADS julio';
$p_mailname4FSH =  'LEADS 6 Julio';
...
/* 
    ...
    CODIGO PARA CUPON 8080XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
IQOS es una mejor alternativa <br>que continuar fumando pero <br><span style=\"color:#00d1d2;font-weight:700;\">¿conoces las diferencias entre <br>calentar tabaco y usar un vapeador?</span>
--------------------
--------------------
--------------------
Compra tu primer <b>Kit IQOS</b> usando el código
--------------------
--------------------
--------------------
<span style=\"color:#34303d;font-weight:300;font-size:18px;\">y recibe </span>¡10% de descuento<span style=\"font-size:12px;\"><sup>(2)</sup></span>!
--------------------
--------------------
--------------------
--------------------
