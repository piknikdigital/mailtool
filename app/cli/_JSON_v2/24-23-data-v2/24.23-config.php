...
$p_id =  '23';
$p_subject =  'Con IQOS, los cambios se notan';
$p_preheader =  'Compártelo con tus amigos y obtengan grandes beneficios​';
$p_yy =  '24';
$p_mm =  '02';
$p_dd =  '08';
$p_name4folder =  'conversion-starter';
$p_name4json =  'iluma-conversion-starter-day21';
$p_name4folderDCE =  'Conversion High Priority Starter';
$p_mailname4DCE =  'IQOS_ILUMA_2024_JOURNEY_CONVERSION_STARTER_DAY21';
...
/* 
    ...
    CODIGO PARA CUPON 2323XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 2323XX :   %%referral_code%%
...
--------------------
--------------------
¿Ya notaste que desde que cambiaste a IQOS tu casa dejo de olor a humo de cigarro? ¿Qué ya no hay quemaduras en tus sillones y cortinas?
--------------------
Regala 20% de descuento<br>y  elige entre más de 
--------------------
40 recompensas digitales.​
--------------------
¿Ya compartiste y usaron tu código?​
--------------------
--------------------
...
--------------------
--------------------
Te recordamos que nuestros canales de comunicación están disponibles y listos para atenderte.
--------------------
--------------------
Tu equipo IQOS
--------------------
...
--------------------
--------------------
(1) Consulta Términos y Condiciones. Válido en la compra y registro del primer dispositivo (IQOS Holder + Cargador IQOS) de cada amigo referido. Para obtener su descuento, el amigo referido debe registrarse y registrar su dispositivo en iqos.com, y hacerlo válido en Tiendas IQOS, IQOS Corners en Sanborns seleccionados y compraiqos.com.mx. Descuento no válido en productos de tabaco.​<br>(2) Solo para fumadores adultos o usuarios adultos de otros productos con nicotina.​<br>(3) Cada recompensa equivale a $300 MXN en dinero electrónico, no canjeable por dinero en efectivo, válido solo en recompensasiqos.plandereconocimientos.com. Por cada amigo que utilice tu código, obtendrás $300 MXN en beneficios, teniendo la oportunidad de recibir hasta $3,000 MXN en beneficios. Limitado a los primeros 10 amigos referidos que compren y registren su dispositivo con tu código único. Consulta Términos y Condiciones del programa.<br>IQOS ILUMA&trade; cuenta con la tecnología SMARTCORE&trade; la cual funciona con unidades de tabaco calentado exclusivamente diseñadas para su uso. Para evitar dañar el dispositivo, no deben utilizarse estas unidades de tabaco con otros dispositivos IQOS que no pertenezcan a la gama de productos ILUMA. IQOS ILUMA no es libre de riesgo ya que entrega nicotina, que es adictiva. Uso exclusivo para adultos.
--------------------
--------------------
--------------------
--------------------
