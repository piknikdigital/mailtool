...
$p_id =  '98';
$p_subject =  '¡Se acabo El Reto! Por favor realiza tu pago a la brevedad';
$p_preheader =  '¿Necesitas ayuda? Contáctanos';
$p_yy =  '23';
$p_mm =  '07';
$p_dd =  '14';
$p_name4folder =  'lending-3-duo';
$p_name4json =  'lending-pre-dunning-mail-2';
$p_name4folderDCE =  'Lending 3 DUO';
$p_mailname4DCE =  'LENDING Pre-Dunning Mail 2';
...
--------------------
--------------------
¡Gracias por formar parte de IQOS El Reto!
--------------------
--------------------
--------------------
Te invitamos a realizar el pago de tu<br> dispositivo IQOS a la brevedad. Ponemos a tu <br>disposición nuestros canales de<br> comunicación para apoyarte en el proceso.<br><br><br>Estaremos felices de atenderte.<br>Nos encontramos disponibles para ti<br><b>todos los días de 8 a 22 hrs.</b>
--------------------
--------------------
#IQOSElReto
--------------------
