...
$p_id =  '4';
$p_subject =  'Tu camino al siguiente nivel, está muy cerca 😎';
$p_preheader =  'Prueba IQOS antes de comprarlo 👆🏻';
$p_yy =  '24';
$p_mm =  '01';
$p_dd =  '23';
$p_name4folder =  'valentines';
$p_name4json =  'valentines-education-3';
$p_name4folderDCE =  'Valentines';
$p_mailname4DCE =  'Valentine\'s - Education 3';
...
/* 
    ...
    CODIGO PARA CUPON 44XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 44XX :   %%referral_code%%
...
--------------------
--------------------
¿Por qué cambiarse a IQOS?
--------------------
IQOS calienta tabaco, no lo quema.​

IQOS elimina la combustión y no deja <br>olor a cigarro.​

IQOS produce 95% menos sustancias tóxicas* <br>en comparación con los cigarros.​

IQOS entrega el sabor del tabaco sin humo.​

--------------------
--------------------
--------------------
<b>Información importante:</b> esto no necesariamente equivale a una reducción del riesgo del 95%. IQOS no es libre de riesgo. 
--------------------
* \"95% menos\" representa las reducciones promedio en los niveles de una variedad de sustancias químicas nocivas (excluyendo la nicotina) en comparación con el humo de un cigarro de referencia (3R4F). Ver información importante en IQOS.com​
--------------------
--------------------
--------------------
¡Prueba IQOS <br>antes de comprarlo!​
--------------------
--------------------
--------------------
Vive la experiencia 
--------------------
por 14 días ​por solo 
--------------------
$205 MXN
--------------------
--------------------
