...
$p_id =  '285';
$p_subject =  'Comenzamos noviembre con el pie derecho 🎉';
$p_preheader =  'Vive una gran experiencia con tu IQOS, esto te interesa';
$p_yy =  '23';
$p_mm =  '10';
$p_dd =  '24';
$p_name4folder =  'laus-noviembre';
$p_name4json =  'newsletter-2023-noviembre';
$p_name4folderDCE =  'LAUS Noviembre';
$p_mailname4DCE =  'Newsletter 2023 Noviembre ';
...
/* 
    ...
    CODIGO PARA CUPON 285285XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 285285XX :   %%referral_code%%
...
--------------------
Así vivimos el <br>4to aniversario de IQOS
--------------------
--------------------
IQOS cumplió <span style=\"color:#34303d;font-weight:700;\">4 años en México</span> y lo celebramos <br>en grande. Aquí te presentamos un poquito <br>de lo que se vivió en nuestra celebración <br>en <span style=\"color:#34303d;font-weight:700;\">Jardín Paraíso.</span>
--------------------
--------------------
¡Ya abrimos <br>IQOS Store Mitikah!<br>Visita tu Tienda IQOS más cercana. 
--------------------
--------------------
--------------------
El fin es:<br>SER ORIGINAL.
--------------------
--------------------
Mantente atento a nuestros <br>canales de comunicación <br>muy pronto podrás<br>recibir un <span style=\"color:#00d1d2;font-weight:700;\">gran precio.</span>
--------------------
--------------------
--------------------
--------------------
