...
$p_name4json =  'cz-recuperacion-contrasenia';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'CZ_Recuperación_contraseña';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'NA';
$p_mailname4FSH =  'CZ_Recuperación_contraseña';
...
/* 
    ...
    CODIGO PARA CUPON 4545XX :   %%=v(@voucher_code)=%% 
    CODIGO PARA CUPON 4545XX :   %%referral_code%%
...
--------------------
--------------------
<span style=\"color:#00d1d2;font-weight:700;\">¿Olvidaste</span><br>tu contraseña?
--------------------
--------------------
...
--------------------
No eres la primera ni la última persona que olvida su contraseña.<br><br>Crea una nueva con cero complicaciones.<br><b>Haz clic en el botón y sigue<br>las instrucciones.​</b>
--------------------
--------------------
--------------------
--------------------
