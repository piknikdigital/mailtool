...
$p_id =  '28';
$p_subject =  'Compartir el cambio viene con grandes beneficios';
$p_preheader =  'Regala a tus amigos 20% de descuento en la compra de su primer Kit IQOS DUO';
$p_yy =  '23';
$p_mm =  '02';
$p_dd =  '24';
$p_name4folder =  'laus-marzo';
$p_name4json =  'mgm-marzo';
$p_name4folderDCE =  'LAUS March';
$p_mailname4DCE =  'MGM Marzo';
