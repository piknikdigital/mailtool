...
$requiredBlocks = array(
    ...
    "spacer",
    "columns",            // 2
    "cta1_v2",            // CTA1 conoce mas
    "img",                // 3
    "columns",            // CTA2 compartir iniciativa
    "img",                // 4
    "spacer",
    "img",                // 5
    "columns",            // 6,7, fb,tw,wa, 8
    "img",                // 9
    "spacer",
    "img",                // 10
    "spacer",
...
--------------------
--------------------
Hoy en día <b>existen diferentes <br>productos sin humo</b> para que los <br>fumadores  cambien a opciones menos dañinas, <br>con beneficios como:
--------------------
--------------------
--------------------
--------------------
Hoy en día en México los productos sin humo no <br>están permitidos o se encuentran restringidos, <br>por lo tanto, los fumadores no tienen acceso <br>a productos de menor riesgo.  
--------------------
¡Hay que cambiar esto ya!
--------------------
Comparte esta iniciativa con personas que están <br>buscando cambiar a opciones libres de humo.
--------------------
--------------------
--------------------
--------------------
