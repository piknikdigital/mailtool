...
$requiredBlocks = array(
    ...
    "greeting_v2",
    "spacer",
    "p300_BW",          /* ¡Tus artículos te están esperando! */
    
    "columns",          /* columnas con thumbnail, info de producto y precio*/
    ...
    "cta1_v2",          /* finalizar compra */

    "p300_BW",          /* Si tienes dificultades para completar */ 
     
    "p300_BW",          /* Saludos */ 
    "ElijoIQOS",

    "p300_BW",          /*  Solicita tu factura máximo 72 horas posterior */ 
...
<span style=\"color:#00d1d2;\">¡Pst-pst!</span><br>Parece que dejaste<br>algo en el carrito.

--------------------
<span style=\"color:#00d1d2;font-weight:700;\">¡Tus artículos te están esperando!</span><br>Regresa, inicia sesión en iqos.com <br>y completa tu compra.

--------------------
--------------------
Si tienes dificultades para completar tu compra, comunícate al <br><b>800 1 476769 o *993 desde tu celular.</b>
--------------------
--------------------
Saludos
Tu Equipo IQOS
--------------------
--------------------
Solicita tu factura máximo 72 horas posterior<br> a tu compra al correo:<br><b>FacturacionElectronica.IQOS@pmi.com</b><br>Conserva tu ticket para devoluciones, reemplazos y<br> para hacer válida la garantía.
--------------------
--------------------
--------------------
--------------------
--------------------
Kit IQOS 2.4 Plus Navy<br>Código: G00000218<br>Cantidad:1


--------------------
--------------------
Costo de Envío:<br>Total:<br>Pago:

$0.00<br>$799.00<br>$799.00
