...
$p_id =  '27c';
$p_subject =  'Despídete de las molestias provocadas por el humo de cigarro';
$p_preheader =  'El cambio empieza con IQOS';
$p_yy =  '22';
$p_mm =  '05';
$p_dd =  '27';
$p_name4folder =  'leads';
$p_name4json =  'leads-benefits';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Journey Leads post OOS CTA Compra';
$p_mailname4FSH =  'LEADS Benefits Version C';
