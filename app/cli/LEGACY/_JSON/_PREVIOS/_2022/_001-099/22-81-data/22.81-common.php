...
$p_id =  '81';
$p_subject =  'Un mejor futuro para el medio ambiente es posible con IQOS🌱';
$p_preheader =  'Tu puedes ser parte del cambio. Recolecta. Reduce. Recicla.';
$p_yy =  '22';
$p_mm =  '05';
$p_dd =  '20';
$p_name4folder =  'ecj-lending';
$p_name4json =  'ecj-lending-day-23-sustainability';
$p_name4folderDCE =  'Early Conversion Journey Lending';
$p_mailname4DCE =  'Early Conversion Lending Day 23 - Sustainability';
$p_customerkey_DCE =  '';
$p_name4folderFSH =  '';
$p_mailname4FSH =  '';
$p_customerkey_FSH =  '';
