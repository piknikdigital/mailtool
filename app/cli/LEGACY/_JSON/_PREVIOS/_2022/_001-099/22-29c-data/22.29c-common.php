...
$p_id =  '29c';
$p_subject =  'Psst, psst… Tenemos un secreto que contarte sobre IQOS';
$p_preheader =  'Da click y prepárate para decirle adiós a las molestias';
$p_yy =  '22';
$p_mm =  '05';
$p_dd =  '27';
$p_name4folder =  'leads';
$p_name4json =  'leads-science';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Journey Leads post OOS CTA Compra';
$p_mailname4FSH =  'LEADS Ciencia Version C';
