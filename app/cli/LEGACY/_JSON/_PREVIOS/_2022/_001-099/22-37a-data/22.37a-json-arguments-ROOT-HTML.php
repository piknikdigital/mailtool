...
require_once("22.37a-common.php");
...
--------------------
--------------------
A diferencia de los vapeadores, IQOS calienta tabaco real (no líquido con nicotina), entregando el sabor del tabaco.<br><br><b>¿Conoces las diferencias entre calentar tabaco y usar un vapeador?</b> <br><br>Aquí te explicamos todo.
--------------------
--------------------
--------------------
ESTO NOOOOO
    IQOS calienta tabaco real sin quemarlo, 
    reduciendo en un 
    95%* la generación de componentes tóxicos 
    en comparación con el cigarro, haciéndolo una mejor alternativa al presentar menor riesgo para los fumadores que seguir fumando.
--------------------




<span style=\"color:#00d1d2;font-size:22px;font-weight:700;\">IQOS</span> calienta tabaco real sin quemarlo. Al reducir en un <span style=\"color:#00d1d2;font-size:22px;font-weight:700;\">95%* la generación de sustancias tóxicas</span> en comparación con los cigarros, IQOS es una mejor alternativa para los fumadores adultos que quieren seguir consumiendo tabaco.
