...
$p_id =  '76';
$p_subject =  'Te presentamos myIQOS';
$p_preheader =  'Toda la atención que buscas en un solo lugar';
$p_yy =  '22';
$p_mm =  '05';
$p_dd =  '20';
$p_name4folder =  'ecj-lending';
$p_name4json =  'ecj-lending-day-1-post-purchase-services';
$p_name4folderDCE =  'Early Conversion Journey Lending';
$p_mailname4DCE =  'Early Conversion Lending Day 1 - Post Purchase Services';
$p_customerkey_DCE =  '';
$p_name4folderFSH =  '';
$p_mailname4FSH =  '';
$p_customerkey_FSH =  '';
