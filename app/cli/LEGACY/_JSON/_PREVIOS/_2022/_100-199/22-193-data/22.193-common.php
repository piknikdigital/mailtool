...
$p_id =  '193';
$p_subject =  'No dejes pasar más tiempo y ¡Adopta Nuevos Hábitos!';
$p_preheader =  'Aprovecha 10% de descuento en la compra de tu primer Kit IQOS';
$p_yy =  '22';
$p_mm =  '12';
$p_dd =  '28';
$p_name4folder =  'nuevos-habitos';
$p_name4json =  'anh-educational-leads';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta Nuevos Hábitos';
$p_mailname4FSH =  'ANH Educational LEADS';
