...
$p_id =  '102';
$p_subject =  'No es fumar, no es vapear, es IQOS';
$p_preheader =  'Conoce las diferencias entre un vapeador y el calentamiento de tabaco';
$p_yy =  '22';
$p_mm =  '06';
$p_dd =  '13';
$p_name4folder =  'iqos-vs-vape';
$p_name4json =  'iqos-vs-vape-leads';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'IQOS vs Vape';
$p_mailname4FSH =  'IQOS vs Vape LEADS';
