...
$p_id =  '160';
$p_subject =  '¿Qué tal suena 30% de descuento en tu primer Kit IQOS?';
$p_preheader =  'Alguien quiere adoptarte para que te despidas del cigarro';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '15';
$p_name4folder =  'adopta-cambio';
$p_name4json =  'adopta-cambio-cupon-leads';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta el Cambio';
$p_mailname4FSH =  'Adopta el cambio  - cupon';
