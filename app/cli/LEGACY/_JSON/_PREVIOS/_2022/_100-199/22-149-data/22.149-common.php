...
$p_id =  '149';
$p_subject =  '¡El tiempo se acaba! Adopta a tus amigos y ayúdalos a dejar el humo atrás';
$p_preheader =  'Hasta $3,000 MXN en beneficios para ti y 30% de descuento sobre precios reducidos para ellos';
$p_yy =  '22';
$p_mm =  '08';
$p_dd =  '24';
$p_name4folder =  'adopta-fumador';
$p_name4json =  'adopta-fumador-5';
$p_name4folderDCE =  'Adopta a un fumador';
$p_mailname4DCE =  'Adopta a un fumador 5';
