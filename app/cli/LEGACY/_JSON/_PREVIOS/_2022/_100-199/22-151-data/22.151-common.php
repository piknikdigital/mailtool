...
$p_id =  '151';
$p_subject =  'No nos gustan las despedidas, pero decirle adiós al cigarro suena muy bien';
$p_preheader =  'Obtén 20% de descuento en la compra de tu primer Kit IQOS';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '01';
$p_name4folder =  'adopta-cambio';
$p_name4json =  'adopta-cambio-1';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta el Cambio';
$p_mailname4FSH =  'Adopta el Cambio - Correo 1';
