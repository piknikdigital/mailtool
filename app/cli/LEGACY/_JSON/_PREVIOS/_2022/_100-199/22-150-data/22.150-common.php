...
$p_id =  '150';
$p_subject =  '¿Estás listo para donar tu colección de encendedores?';
$p_preheader =  'Tú puedes decirle adiós al cigarro, muy pronto te diremos cómo';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '01';
$p_name4folder =  'adopta-cambio';
$p_name4json =  'aec-teaser';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta el Cambio';
$p_mailname4FSH =  'Adopta el Cambio - Teaser';
