...
$p_id =  '156';
$p_subject =  'Si el tren ya se te fue, que no se te vaya la oportunidad de Adoptar el Cambio';
$p_preheader =  'Últimos días con 20% de descuento sobre precios';
$p_yy =  '22';
$p_mm =  '09';
$p_dd =  '01';
$p_name4folder =  'adopta-cambio';
$p_name4json =  'adopta-cambio-6';
$p_name4folderDCE =  'NA';
$p_mailname4DCE =  'NA';
$p_customerkey_DCE =  'NA';
$p_name4folderFSH =  'Adopta el Cambio';
$p_mailname4FSH =  'Adopta el Cambio - Correo 6';
