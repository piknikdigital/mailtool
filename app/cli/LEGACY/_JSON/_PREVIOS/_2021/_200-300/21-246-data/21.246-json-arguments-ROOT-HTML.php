...
require_once("21.246-common.php");
...
--------------------
--------------------
El momento del cambio es ahora.<br><br>Comienza un nuevo año sin humo de cigarro.<br>Aprovecha esta época para únirte a los más de<br><span style=\"color:#db3624;font-weight:700;\">14 millones * de adultos</span><br> que ya hicieron el cambio a <span style=\"color:#db3624;font-weight:700;\">IQOS.</span>
--------------------
* Fuente: Datos financieros de PMI y estimaciones internas, paneles de usuarios IQOS y Estudios de Mercado de PMI. Información actualizada a julio de 2021. Usuarios de IQOS que han dejado completamente los cigarros y para quienees las unidades de tabaco para calentar representan al menos, un 70% de su consumo de tabaco calentado en los últimos 7 días.
--------------------
Si en tu lista de propósitos está<br> cambiar el cigarro, <span style=\"color:#db3624;font-weight:700;\">IQOS</span> es una mejor<br>alternativa para el consumo de tabaco.<br><br>Comienza un nuevo año sin humo de<br>cigarro y adquiere tu <span style=\"color:#db3624;font-weight:700;\">primer Kit IQOS</span><br>a un precio especial.<br><br>Aprovecha el siguiente código u obtén<br>
--------------------
10% de descuento<span style=\"font-size:14px;\"><sup>(1)</sup></span> 
--------------------
en tu compra.
--------------------
¡El año nuevo está por llegar y es hora de <span style=\"color:#db3624;\">cambiar</span>!
--------------------
(1) Código de 10% de descuento redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com). Válido únicamente en la compra de tu primer Kit IQOS en la República Mexicana. No es válido en la compra de unidades de tabaco para calentar ni en accesorios IQOS. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Vigencia del código hasta el 22 de abril de 2022. Aplicable en compras realizadas en www.iqos.com, Tiendas IQOS y asesores IQOS. Sujeto a disponibilidad de inventario. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago. 
--------------------
--------------------
...
<span style=\"color:#db3624;\">cambiar</span>
--------------------
--------------------
--------------------
--------------------
