...
$p_id =  '220';
$p_subject =  '¿Sabías que IQOS evita la combustión?';
$p_preheader =  'Conoce las diferencias de calentar el tabaco';
$p_yy =  '21';
$p_mm =  '10';
$p_dd =  '27';
$p_name4folder =  'warm-lending-vpd';
$p_name4json =  'warm-learn-evaluate-vpd';
$p_name4folderDCE =  'WARM Lending VPD';
$p_mailname4DCE =  'WARM Learn Evaluate VPD';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'WARM Lending VPD';
$p_mailname4FSH =  'WARM Learn Evaluate VPD';
