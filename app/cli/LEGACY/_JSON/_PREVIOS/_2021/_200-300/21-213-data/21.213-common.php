...
$p_id =  '213';
$p_subject =  '¿Cómo fue tu experiencia con el servicio IQOS?';
$p_preheader =  'Queremos apoyarte';
$p_yy =  '21';
$p_mm =  '10';
$p_dd =  '22';
$p_name4folder =  'dormant';
$p_name4json =  'dormant-painpoint-service';
$p_name4folderDCE =  'Dormant';
$p_mailname4DCE =  'Dormant PainPoint Service';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Dormant';
$p_mailname4FSH =  'Dormant PainPoint Service';
