...
$p_id =  '78';
$p_subject =  'Sin humo, sin ceniza y sin incomodidades';
$p_preheader =  '¿Con qué cambio te identificas más?';
$p_yy =  '21';
$p_mm =  '06';
$p_dd =  '10';
$p_name4folder =  'hesitator';
$p_name4json =  'hesitator-you-are-here-no-way-back';
$p_name4folderDCE =  'Hesitator';
$p_mailname4DCE =  'Hesitator You Are Here No Way Back';
