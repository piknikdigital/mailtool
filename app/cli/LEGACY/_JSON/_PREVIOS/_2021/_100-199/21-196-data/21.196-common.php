...
$p_id =  '196';
$p_subject =  'Tu registro está listo';
$p_preheader =  '¿El siguiente paso? Empezar El Reto';
$p_yy =  '21';
$p_mm =  '09';
$p_dd =  '27';
$p_name4folder =  'lending';
$p_name4json =  'lending-transactional-registry-v2';
$p_name4folderDCE =  'Lending';
$p_mailname4DCE =  'Lending Transactional Registry v2';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Lending';
$p_mailname4FSH =  'Lending Transactional Registry v2';
$p_customerkey_FSH =  '40486288-ba08-42b1-ae91-b8c58afdf5e1';
$id_FSH_folder =  '127';
