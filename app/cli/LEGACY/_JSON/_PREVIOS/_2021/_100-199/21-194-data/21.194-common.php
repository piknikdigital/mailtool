...
$p_id =  '194';
$p_subject =  '¡Se acabó El Reto! Por favor realiza tu pago a la brevedad';
$p_preheader =  '¿Necesitas ayuda? Contáctanos';
$p_yy =  '21';
$p_mm =  '09';
$p_dd =  '27';
$p_name4folder =  'lending';
$p_name4json =  'lending-pre-dunning-mail2';
$p_name4folderDCE =  'Lending';
$p_mailname4DCE =  'Lending Pre Dunning Mail2';
$p_customerkey_DCE =  'tbd';
$p_name4folderFSH =  'Lending';
$p_mailname4FSH =  'Lending Pre Dunning Mail2';
