...
$p_id              = '232';
$p_subject         = 'IQOS está en AMAZON y tiene algo especial para ti.';
$p_preheader       = '¡No dejes pasar esta oportunidad!';

$p_yy              = '20';
$p_mm              = '10';
$p_dd              = '09';
$p_name4folder     = 'amazon-prime-day';
$p_name4json       = 'amazon-prime-day';

$p_name4folderDCE  = 'NA';
$p_mailname4DCE    = 'NA';
$p_customerkey_DCE = 'NA';

$p_name4folderFSH  = 'Amazon Prime Day';
$p_mailname4FSH    = 'Amazon Prime Day';
$p_customerkey_FSH = 'c3358f9c-5073-464e-985b-39c332208dcb';
$id_FSH_folder     = '83';
