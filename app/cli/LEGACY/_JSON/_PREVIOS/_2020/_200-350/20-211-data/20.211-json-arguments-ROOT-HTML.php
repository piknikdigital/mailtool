...
require_once("20.211-common.php");
...
$requiredBlocks = array(
    ...
    "spacer",
    "img_Cover_HTML",
    "p300",             // Una nueva forma de consumir tabaco te espera en nuestras <b>Tiendas IQOS</b>.<br><br> Conoce nuestros dispositivos, una amplia variedad de accesorios, las unidades de tabaco para calentar y exclusivos servicios pensados para ti.
    "img",              // 2 
    "p700",     // #1d8fcd   // TE ESPERAMOS EN NUESTRAS NUEVAS UBICACIONES:
    "img",              // 3
    "p700",     // #1d8fcd   // ¡VISÍTANOS!
    "p300",             // También puedes encontrarnos en:
