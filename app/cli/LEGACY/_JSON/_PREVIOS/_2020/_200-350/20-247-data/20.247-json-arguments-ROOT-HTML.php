...
require_once("20.247-common.php");
...
$requiredBlocks = array(
    ...
    "spacer",
    "greeting_negro",
    "p300", // Tus amigos han hecho un cambio en sus vidas gracias a ti. Con tu ayuda han dejado el humo de cigarro atrás y ahora son parte del cambio<br><br>Queremos agradecerte esto con algo especial para ti.
    "img",//2
    "p300", // Si lo quieres, ¡es tuyo!<br>Esta edición es exclusiva y no la podrás encontrar en ningún lado.<br>Llámanos para agendar la entrega de tu nuevo<br><b>IQOS 3 DUO MOTORSPORT LIMITED EDITION</b><br>en el lugar que nos indiques. 
    "cta1",// llamar / 8001476769
    "p700",// ¡Gracias por compartir el cambio!
    "p700",// COMPARTE CON NOSOTROS USANDO EL 
    "img",//3
    "spacer",
    "disclaimer_iqos"    
);
...
/* 
    ...
    CODIGO PARA CUPON 247247XX :   %%=v(@voucher_code)=%% 
