...
$p_id              = "209";
$p_subject         = "Estás muy cerca de conocer una nueva forma de consumir tabaco.";
$p_preheader       = "¡Prueba IQOS gratis durante 15 días!";

$p_yy              = "20";
$p_mm              = "08";
$p_dd              = "31";
$p_name4folder     = "callback-el-reto";
$p_name4json       = "callback-transaccional-iqos-elreto";

$p_name4folderDCE  = "folderdce";
$p_mailname4DCE    = "NAME4CRM";
$p_customerkey_DCE = "custkeyDCE";

$p_name4folderFSH  = "Callback_EL_RETO";
$p_mailname4FSH    = "Callback Transaccional IQOS ELRETO";
$p_customerkey_FSH = "670673b2-f69b-4dfe-b815-c316fd3f9284";
$id_FSH_folder     = "77";
...
// echo "@@" . $subject_base    . "@@" .PHP_EOL;
// echo "@@" . $preheader_base  . "@@" .PHP_EOL;
// echo $path_DCE        . PHP_EOL;
// echo $path_FSH        . PHP_EOL;
