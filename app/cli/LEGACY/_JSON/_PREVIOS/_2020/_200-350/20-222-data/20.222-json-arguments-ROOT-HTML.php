...
require_once("20.222-common.php");
...
/* 
    ...
    CODIGO PARA CUPON 222222XX :   %%=v(@voucher_code)=%% 
...
--------------------
--------------------
Encuentra tu código de descuento* aquí y recibe <b>$200 MXN</b> redimibles en <b>accesorios IQOS.</b>
--------------------
BIENVENIDOSEPT20
--------------------
Te dejamos algunas recomendaciones en las que podrías redimir tu código de descuento.
--------------------
*Código de descuento redimible solo una vez por usuario registrado (con cuenta creada en www.iqos.com). Válido únicamente en la compra de accesorios IQOS en la República Mexicana. No es válido en la compra de unidades de tabaco para calentar ni en dispositivos IQOS. Solo para fumadores adultos o usuarios adultos de otros productos con nicotina. Vigencia del código del 9 al 30 de septiembre de 2020. Aplicable únicamente en compras realizadas con Asesores Comerciales IQOS, Tiendas IQOS participantes (IQOS Store, IQOS Shop) y compras realizadas en www.iqos.com. Sujeto a disponibilidad de inventario. El código deberá ser canjeado en su totalidad en una sola exhibición. No es acumulable con otros códigos de descuento y no será canjeable por dinero en efectivo ni cualquier otra forma de pago. <a href=\"https://www.iqos.com/mx/es/care-plus/terminos-condiciones-care-plus.html\" style=\"text-decoration:underline;\" target=\"_blank\">Consulta Términos y Condiciones.</a>
