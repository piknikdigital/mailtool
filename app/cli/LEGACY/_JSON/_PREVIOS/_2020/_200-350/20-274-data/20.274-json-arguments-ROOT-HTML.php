...
require_once("20.274-common.php");
...
--------------------
Gracias a tu fidelidad,<br>¡tenemos grandes noticias para ti!<br><br>Adquiere un <span style=\"font-size:24px; font-weight: 700;\">IQOS 2.4 PLUS</span> con<br><span style=\"font-size:24px; font-weight: 700;\">35% de descuento</span> con el siguiente código<sup>(1)</sup> para que nada interrumpa tu día.
--------------------
SINHUMO21
0d2e69
--------------------
