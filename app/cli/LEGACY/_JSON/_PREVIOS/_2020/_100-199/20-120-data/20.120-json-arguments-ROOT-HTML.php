...
require_once("20.120-common.php");
...
$requiredBlocks = array(
    ...
    "spacer",
    "greeting_negro",
    "p300",             // Invitar a un amigo<sup>(1)</sup> a ser parte del cambio ¡es fácil y te recompensa!<br><br>Tendrás un código único que podrás compartir con tus amigos fumadores adultos.
    "p700",             // ¿Cómo funciona?
